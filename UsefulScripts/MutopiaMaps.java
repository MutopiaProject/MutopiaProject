...
public class MutopiaMaps
{
   ...
   private static void initialiseLicenceMap()
   {
      ...
      licenceMapNew.put("Public Domain",
                     "tagline = \\markup { \\override #'(box-padding . 1.0) \\override #'(baseline-skip . 2.7) \\box \\center-column { \\small \\line { " +
                     "Sheet music from \\with-url #\"http://www.MutopiaProject.org\" \\line { \\concat { \\teeny www. \\normalsize MutopiaProject " +
                     "\\teeny .org } \\hspace #0.5 } \u2022 \\hspace #0.5 \\italic Free to download, with the \\italic freedom to distribute, modify and perform. " +
                     "} \\line { \\small \\line { Typeset using \\with-url #\"http://www.LilyPond.org\" \\line { \\concat { \\teeny www. \\normalsize LilyPond " +
                     "\\teeny .org }} by \\concat { \\maintainer . } \\hspace #0.5 Reference: \\footer } } \\line { \\teeny \\line { This sheet " +
                     "music has been placed in the public domain by the typesetter, for details " +
      ...
      licenceMapNew.put("Creative Commons Attribution 3.0",
                     ...
                     "\\teeny .org } \\hspace #0.5 } \u2022 \\hspace #0.5 \\italic Free to download, with the \\italic freedom to distribute, modify and perform. " +
                     "} \\line { \\small \\line { Typeset using \\with-url #\"http://www.LilyPond.org\" \\line { \\concat { \\teeny www. \\normalsize LilyPond " +
                     "\\teeny .org }} by \\concat { \\maintainer . } \\hspace #0.5 Copyright \u00A9 " + now.get(Calendar.YEAR) + ". \\hspace " +
                     "#0.5 Reference: \\footer } } \\line { \\teeny \\line { Licensed under the Creative Commons Attribution 3.0 (Unported) License, for details " +
