...
\header {
	title = "que je ne comprends pas"
	composer = "Ramana Kumar"
	dedication = "for Delia Wang"
	piece = \markup {crotchets placed with care.}
	mutopiatitle = "que je ne comprends pas"
	...
	lastupdated = "2006/January/27"

	footer = "Mutopia-2006/01/27-657"
...
\score {
	\context PianoStaff <<
		...
		\context Staff = right <<
			...
			<d' ges' bes'>4\p <d' ges' bes'>4 <d' ges' bes'>4 <d' ges' bes'>2. |
			...
			<g b dis'>4\> <g b dis'>4 <g b dis'>4 <g b dis'>2.\! \breathe |
			...
			<a cis'>2 <b e'>4 <g cis'>2 <g dis'>4 \breathe |
			...
			<<{<b ees'>4 <bes bes'>4\mf <c' c''>4 <des' des''>2 <ees' ees''>4}\\{g2. ges'2.}>> |
			...
			<g ees'>4 <g bes>4 <g c'>4 <aes des'>2 <aes ees'>4 | \setTextCresc
			...
			<c'' e'' gis''>4\p <c'' e'' gis''>4 <c'' e'' gis''>4 <c'' e'' gis''>2. |
