violaFirstMov = \notes\relative g' {
    ...
    \repeat volta 2 {
        ...
        | a,4-\f [e8( )c'] b4( [a8 )g]
        | a2-\p c4( )b8 r
        | a'4 \grace { \cue d16 \noCue } [c8 b16 a] fis4( )g8 r
        | r2 \tieDown <d4 a'(> ~ <d8 )b'> \tieBoth r8
        | r2 a2-\p
        | \stemUp \lowerText b4(-#'(italic "cresc.") c )b \restoreText
          \stemBoth r
        | r2 bes2-\p
% 10
        | b!4^#'(italic "cresc.") fis( )g r
        | b4-\f d c4.( )b8
        | a4( )b r d ~
        | [d8(-\p a' b )gis] e4 a, ~
        | a d2 b4-\f ~
        ...
        | e4 r r2
% 20
        | r8 \lowerText [b(-#'(italic "cresc.") \restoreText a )g] a4
          r8 e8-\f
        | e'2 r4 r8 e,8-\f
        | e'2 ~ e8 cis4(-\fp )d8
        | e cis4(-\fp )d8 e2 ~
        ...
        | r8 \RaiseSlur a4(-. a-. a-. )a8-. ~ \restoreSlur
% 30
        ...
        |
        \context Staff <
            \context Voice {\voiceOne a2 ~ a4 r}
    	\context Voice=x {\voiceTwo a4 g fis s}
        >
        | \oneVoice fis,2(-\p )g4 d'-\f ~
        | d(-\p [)e8 g,-.] fis r r4
...
% 40
        ...
        \context Staff <
    	    ...
    	    | a'2 b
    	    | s4 s8 g8 fis2 }
    	\context Voice=x {\voiceTwo
    	    [a,8 a] a s [a a] a s
    	    | s g s g fis2
    	    | d'1-#'(italic "cresc.")
    	    | [a'8-\p a a a,] a2}
        >
        | \oneVoice d2-#'(italic "cresc.") ~ [d16( e fis g] [a b c! )d]
...
% 50
	...
	| e-\p ~ e4 r
	| R1
	| r4 \RaiseSlur a,(-. a-. )a-. \restoreSlur
% 60
	| a2 r2
	| g'4-\f g g2 ~
	| g(-\p )fis ~
...
% 70
	...
	| <e8-\f g> <e4-\p g> <e g> <e g> <e8 g> ~
	| <e8 g> <e4 g> <e g> <e g> <e8 g> ~
	| <e8-\f g> <e4-\p g> <e g> <e g> <e8 g> ~
	| <e8 g> <e4 g> <e g> <e g> <e8 g>
	| fis8-\f <d4-\p c'> <d c'> <d c'> <d8 c'> ~
	| <d c'> <d4 c'> <d c'> <d c'> <d8 c'>
	| b'-\f <fis4-\p a> <fis a> <fis a> <fis8 a> ~
	| <fis a> <fis4 a> <fis a> <fis a> <fis8 a>
% 80
...
% 110
	...
	| a4-\p c2 ~ c8 r
	| a'!4 \grace { \cue d16 \noCue } [c8 b16 a] fis4( )g8 r
	| r2 \tieDown <d4 a'(> ~ <d8 )g> \tieBoth r8
	| r2 a2
	| b4(-#'(italic "cresc.") c )b r
	| gis'2(-\pp )a8 r r4
	| r2 bes,2(
	| )b4^#'(italic "cresc.") fis g r
	| b4(-\f )d c4.( )b8
% 120
	| a4( )b r d ~
	| [d8(-\p a' b )gis] e4 a, ~
	...
	| [g gis] )a4 [g8( d' c b]
	| )a4 r r2
	| r8 [e8(-#'(italic "cresc.") d )b] d4 r8 a-\f
	| a'2 r4 r8 a,8-\f
% 130
	| a'2 ~ a8 fis4(-\fp )g8
	| a fis4(-\fp )g8 a2 ~
	...
	| d4 d d2
	| r8 [a e'( )c] r [a a'( )fis]
	| r8 \RaiseSlur d4(-. d-. d-. )d8-. \restoreSlur
...
% 150
	...
	| [d8-\p d d d] 
	\context Staff <
	    \context Voice { \voiceOne d2 }
	    \context Voice=x { \voiceTwo b2 }
	>
	| \oneVoice r2 [g,16( a b c] [d e fis )g]
	| [f( e d c] [b a g )f] [e( f g a] [b c d )e]
