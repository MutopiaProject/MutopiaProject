violinIIFirstMov = \notes\relative g' {
    \repeat volta 2 {
        r8
	| b4-\f g c4.( )b8
	| \stemUp a4(-\p b ~ b )a8 r \stemBoth
	| e2-\f d4.( )cis8
	| d2-\p ~ [d8( fis )g] r
	| R1
	| a4 \grace { \cue d16 \noCue } [c8 b16 a] fis'4( )g8 r
	| r2 g,2(-\p ~
	| g4^#'(italic "cresc.") fis )g r
	| r2 g2(-\p
% 10
	| )d4^#'(italic "cresc.") c( )b r8 g8-\f
	| d'4( )g g( [fis8 )e]
	| [d8( dis e )b] d4( [c8 )b]
	...
	| )g4 r r8 [b( a g]
% 20
	| \lowerText [fis8-#'(italic "cresc") g a )b] \restoreText
          fis4( [)e8 g,-\f]
	| g'2 r4 r8 g,8-\f
	| g'2 ~ g8 e4(-\fp )f8
	| g e4(-\fp )f8 g2 ~
...
% 30
	...
	| r8 a,8( )a'4. a,8( )a'4 ~
	| a4-\p c!( b )d
	| d4 \grace { \cue fis16 \noCue } [e8 d16 cis] d4 r
	| \lowerDynamics d,4(-\p dis-\f e-\p )f-\f \restoreDynamics
	| fis!-\p \grace { \cue a16 \noCue } [g8 fis16 e] d8 r r4
	| [a'8-\p a] a r [a a] a r
% 40
...
% 100
	...
	| c'!8 r [b8.(-\trill a32 )b] \lowerText a4(-#'(italic
          "cresc.") \restoreText )fis
	| c'2-\f ~ [c16( b c b] [c b c )b]
	| c2 ~ [c16( b c b] [c b c )b]
	| c4(-#'(italic "calando") b a )g
	| fis( e d )c
	| b4-\f d' c4.( )b8
	| a4(-\p )b [gis8( a] )e r
% 110
...
% 120
	...
	| [)b e( d c] [b f' e d]
	| )c4 r r8 [e8( d )c]
	| [b(-#'(italic "cresc.") c d )e] b4( [)a8 c,-\f]
	| c'2 r4 r8 c,8-\f
% 130
	| c'2 ~ c8 a4(-\fp )bes8
	| c a4(-\fp )bes8 c2 ~
	...
	| \property Voice.Slur \override #'attachment = #'(stem
          . head) g4( gis a ais \property Voice.Slur \revert
          #'attachment
...
% 140
	...
	| r8 d,8( )d'4. d,8( )d'4 ~
	| d(-\p f e g ~
	| )g \grace { \cue b16 \noCue } [a8 g16 fis] g4 r
	| \property Voice.Slur \override #'attachment = #'(stem
          . head) \property Voice.Slur \override #'attachment-offset =
          #'((0 . 0) 0 . 2) g,4(-\p gis-\f a-\p )bes-\f \property
          Voice.Slur \revert #'attachment-offset \property Voice.Slur
          \revert #'attachment
	| b! \grace { \cue d16 \noCue } [c8 b16 a] g8 r r4
	| [a8-\p a] a r [g g] g r
...
% 150
	...
	| \context Staff<
	    \context Voice {\voiceOne g'1}
	    \context Voice=x {\voiceTwo d2_#'(italic "cresc.") e}
	> 
	| \oneVoice [g8. b16] \grace { \cue b16 \noCue } [a8 g16 fis] g2
	| <g,, d'(^#'(italic "cresc.")> )e'
	| \context Staff<
	    \context Voice {\voiceOne b'2( )c }
	    \context Voice=x {\voiceTwo g1 }
	> 
	| \oneVoice [d16( c b a] [g f e )d] c8 r r4
% 160
