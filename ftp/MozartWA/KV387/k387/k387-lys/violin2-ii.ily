...
% 60
	| bes2. ~
	|  bes8[- \markup{\italic "cresc."} b( c b c b]
	|  c2.)\f
	| r4 r b\p
	| r r g
	| b(\p c\f cis\p
...
% 130
	...
	| d4 e2- \markup{\dynamic "sfp"} ~
	| e4 f2- \markup{\dynamic "sfp"} ~
% 140
	| f4 fis2- \markup{\dynamic "sfp"}
	| g4(\f fis  g)
	| es d c
	| bes r r
	| cis'2.(
