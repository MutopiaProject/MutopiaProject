violinIISecondMov = \notes \relative f' {
	...
	g8-\p r g g4( )b,8
% 10
	| \lowerDynamics [c(-\f )g g'] g-. r r
	| a4.(-\p )g8 r r
	| g4.(-\pp )fis8 r r
	| r4 r8 r [fis(-.-\mf \restoreDynamics )fis-.]
	| fis r r g-\p r r
	| f! r f d4.
	| c4( )e8 f r r
	| r r16 [a,16(-\mf c f] [)a8 a(-. )a-.]
...
% 30
    ...
    | <
        { \stemUp \tieUp es2. ~ | es4. }
        \context Voice=x { \stemDown c4. des | c }
      >
      \stemBoth \tieBoth \lowerText [g,16(_\cresc \restoreText bes
      )des des(-. des-. )des-.]
    | <c4.-\p es> <bes g'>
    | < { \stemUp \slurUp as'4.( )ges_\cresc }
    \context Voice=x { \stemDown as,2. }
    > \stemBoth \slurBoth

% 40
    | f4.(-\p )es
    | < { des4. } \context Voice=x { s8 s4_\cresc } > [c8.( es16 des )c]
    | \lowerDynamics [c(-\mf \restoreDynamics bes a! bes des )bes]
      [bes( as g as bes )g]
...
% 50
    ...
    | \LowerText f4.(_\cresc )g \restoreText
    | f8-\p r f d4.
    | c4( )e8 f r r
    | r r16 [a,16(_\mf c f] [)a8_\cresc a(-. )a-.]
    | a8-\p r a [bes( c )d]
    | a4( [g16^\trill f32 g] )f8 r r
...
% 80
    ...
    | f8 r r r [f(-.-\p )f-.]
    | \LowerText f4._\cresc ~ \restoreText [f8( )g] r16 bes,16(-\f
    | )a8 r r g'4.(-\p
    | )f8 r r c4( [bes16. )g32]
    | a8 r r r r16 \LowerText [a(_\cresc c f] \restoreText
