...
% 10
	...
	| )e8 r r4 <c!4.-\f c'> \lowerDynamics g'8(-\p \restoreDynamics
	| [)f8 f-.] r f f4 r8 c'
	| [bes( b bes a] )g4 r8 c
	| < { f2 ~ [f8 f( e )es] }
	    \context Voice=x { s8 s8_\cresc }
	  >
	| d4 r8 [g,16(-\p )d'] c4 r
	| r2 r4 [c,8.(-\fp )des16]
...
% 60
	| \tupletNum \times 2/3 { r16 \lowerDynamics [d,(_\p
          \restoreDynamics g] } \times 2/3 { [)bes bes-. bes-.] } bes8
          r r2
...
% 80
	...
	| [a8( g \lowerText )f_\cresc \restoreText cis] d4.( )e8
...
% 90
	...
	| r16 [f-\mf f f] [f f f f] r \lowerDynamics [d(-\p )a' a-.]
          \restoreDynamics [a a a a]
