...
% 10
	...
	| [a a(] \RaiseScript [e' )d^\trill] \restoreScript cis4 r
	| a,4.-\f a''8-\p [g8.^\trill a16] [bes8 cis,]
	| [d-. e-.] [e( \RaiseScript )d^\trill] \restoreScript cis4 r8
          [f16( )d]
	| [cis gis(-\fp a gis] [a gis a f] )e8 r r4
	| r2 <e4.-\f c'! g'> bes8-\p
	| [bes( )a] r bes-. [b( )c] r es
	| d4( [e!8 )f] c4 r8 g'
	| f8( \LowerText g4-\cresc gis a )a8 ~ \restoreText
...
% 20
	...
	| r [bes,( )e e-.] [e e e e] [f-. a( g \LowerText f-\cresc]
          \restoreText [e f e )d]
	| [c8-.-\p c-. f( )c] r [d-. d'( )g,]
...
% 30
	| r [c,-. bes'( )g] r [d-. d'( )a]
	| r [c,-.-\f c'( )a] r [f-. d'( )bes]
	| a f4( )e8 \lowerDynamics f4(-\p \restoreDynamics )fis-\sf
...
% 40
    ...
    \alternative {
	{
	    | r8 \lowerText [gis'8(-.-\cresc \restoreText )gis-.] r r
              [g(-. )g-.] r
	}
	{
	    | r8 as' \LowerText as4.(-\cresc \restoreText [)f8 f( )d]
	}
    }
...
% 50
	...
	| r2 \lowerDynamics cis,(-\fp
	| [)d8 f(-\f )e d-\p] [c!-. b-. a-. gis-.] \restoreDynamics
	| R1
	| bes'!2-\p bes,4. bes8
...
% 60
	...
	| e4 ~ \times 2/3 { [e16 a,( cis] [)e e-. e-.] } <cis2 e>
	| <d4-\fp f> ~ \times 2/3 { [f16 bes,( d] [)f f-. f-.] } <d2 f>

% 70
	| <g,4-\fp e'> ~ \times 2/3 { [<g16 e'> cis( e] [)g g-. g-.] }
          \tupletNum <a,4 g'> ~ <a8 g'> r
	| r8 [a(-. a-. )a-.] r [a(-. a-. )a-.]
	| r [bes8(-. bes-. )bes-.] r [f'-. f( )d]
...
% 80
	| [a-. a(] [e' \raiseScript )d^\trill] \restoreScript cis4 r
	| a,4.-\f a''8-\p [g8.^\trill a16] [bes8 cis,]
	| [d-. e-.] [e( \raiseScript )d^\trill] \restoreScript cis4 r8
          [f16( )d]
	| [cis gis(-\fp a gis] [a gis a f] )e8 r r4
	| r2 g'4.-\f \lowerDynamics bes,,8-\p ~
	| [bes a-.] r a r bes r es
	| [es(-\sf )d] r b( c4 )d
	| [f8(-\sf )e!] r4 a2-\p ~
	| a8 a4-\cresc a( [g8 d' )bes]
	| f4(-\p )e8 r8 r4 [d'8(-. )d-.] \restoreDynamics
...
% 90
	...
	| [b8 e( )e' d-.] d4( [)cis8 a-.]
	| a-\p r e r d4( )a
	| r16 \lowerDynamics [a(-\mf )d d-.] [d d d d] r [a(-\p )d
          d-.] [d d d d] \restoreDynamics
...
% 100
	...
	| \lowerDynamics d4(-\p )es-\sf [d8-. fis-. g-. a-.]
          \restoreDynamics
...
% 110
	| \lowerDynamics [f(-\sf )fis] r4 [g8(-\sf )gis] r4
    ...
    \alternative {
	{
	    | r8 [b-. \lowerText b(-\cresc )d] r [as' as( )d,]
	}
	{
	    | r8 \lowerText [a8(-.-\cresc )a-.] r r [g(-. )g-.] r
	}
    }
