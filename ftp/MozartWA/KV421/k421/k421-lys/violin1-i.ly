violinIFirstMov = \notes \relative d' {
    ...
    \repeat volta 2 {
	d'2(_#'(italic "sotto voce") )d,4. d8
	| [d8.^\trill cis16] [d8 d] \once \property Voice.Slur
          \override #'attachment = #'(stem . head) d4.( )f'8
...
% 10
	| [d-. e-.] [g( \RaiseScript )f^\trill] \restoreScript e4 r
	| a,,4.-\f d''8-\p d4( [)cis8 bes]
	| [a-. g-.] [g( \RaiseScript )f^\trill] \restoreScript [e16
...
% 20
	...
	r16 [fis,32( )g!] r16
	| \context Staff <
	    \context Voice { \raiseSlur [c8.( )d16] \restoreSlur }
	    \context Voice=x { s8 s32 \grace { [d32 c b c] } s16. }
	> [f,8( )e] f4 r
	| f4( [e16 f bes )a] [a8( )g] r4
	| [fis16( g a g] [bes a d )c] [bes8( )a] r4
	| f'4( [e16 f bes )a] [a8( )g] ~ [g16( f e )d]
	| [d8( )c] ~ [c16( bes a )g] f4 r
	| \slurDown \stemUp \lowerDynamics [f8(-\p \restoreDynamics ~
          \times 2/3 { f16 e f }] \times 2/3 { [a g f] } \times 2/3 {
          [c' bes )a] } \slurBoth \stemBoth [fis8( )g] r4
...
% 30
	...
	| \lowerDynamics c2(-\pp \restoreDynamics )b ~
	| b4( )a d2 ~
	| d4( c f )e
...
% 50
	...
	<
	    { bes!1( }
	    \context Voice=x { s4 \< s2 \! s4 }
	>
	| [)a8-\p \lowerDynamics gis(-\f \restoreDynamics )a f-.-\p]
          [e-. d-. c-. b-.]
	| R1*2
	| cis'2-\p cis,4. cis8
	| d4 r r2
...
% 70
	...
	| f4 ~ [f16( e d )cis] bes4( [a8 )g]
	| [f( bes a )gis] a4 r
	| \grace { \property Voice.Stem \override #'beamed-lengths =
          #'(5) [d,32( )d'] \property Voice.Stem \revert
          #'beamed-lengths } d'2-\f d,4. d8
	| [d8.^\trill cis16] [d8 d] d4.( )f'8
...
% 80
	...
	| [a-. g-.] [g( \raiseScript )f^\trill] \restoreScript [e16
          gis(-\fp a gis] [a gis a f]
	| )e8 r r4 r2
	| r2 <g,,4.-\f e' cis' bes'> \lowerDynamics cis8(-\p
          \restoreDynamics
	| [)d d-.] r d r es r fis
...
% 90
	...
	<
	    { [a8.( )bes16-.] }
	    \context Voice=x { s8 \grace { [bes32 a g a] } s8 }
	>
	[d,( )cis]
	| d4 r d'( [cis16 d f )e]
...
% 110
	...
	{
	    | \times 2/3 { r16 [a,( c] \lowerText [)fis_\cresc
              \restoreText fis-. fis-.] } fis8 r \times 2/3 { r16 [g,(
              d'] [)g g-. g-.] } g8 r
	}
    }
    ...
    <
	{ \stemDown [a-. a,-\f] }
	\context Voice=x { \stemUp s8 <e' cis'> }
    > \stemUp
    | <d,4 d' d'> r r2
}
