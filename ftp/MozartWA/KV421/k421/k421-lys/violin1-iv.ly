...
% 60
	...
	|  c[( bes!  a)] \grace a32 g8[( f  e)]
	|  f[-. a-. c-.] f r a,8\f ~
	|  a[\p c-.] f4\fp  a8[-. c\f] ~
	|  c16[(\p b c b c  a)] g8 r a,\f ~
	|  a[\p cis-.] d4\fp  f8[-. a\f] ~
	|  a16[(\p gis a gis a  f)] e8 r r
	| \appoggiatura bes16( bes'4)\p  g16.[^\trill a32]
           bes8[( g  e)]
	| \appoggiatura f16 f'4  d16.[^\trill e32]  f8[( d  gis,)]
	|  a[( g!  f)] \grace f16 e8[( d  cis)]
	|  d[-. f-. a-.] d r
    }
...
% 120
    ...
    |  d8.[( cis16 b8]  cis) r r
    | R2.
    | r4 r8 r r \times 2/3 {  f'16[_\roundP f f] }
    | f8 r \times 2/3 {  f16[ f f] } f8 r  \times 2/3 {  f16[ f f] }
    | f4.(  gis,8) r gis
    | \grace bes16 a8.[ g!16 f8] \grace f16 e8.[ d16 cis8]
    | cis2._\roundF ~
    |  cis8[( e g]  bes) r r
    | gis2. ~
    |  gis8[( b d]  f) r r
    | f,,_\roundP r r e r r
