...
% 30
    ...
    | [g8 g, g] g r r
    | as4.( )g
    | \lowerText as4. [des,16(_\cresc g )bes bes(-. g-. )g-.]
    | < { \stemUp \tieUp es'2. ~ | \stemDown <c4. es> }
        \context Voice=x { \stemDown as4.-\p des | s }
      > \stemBoth \tieBoth [des,16(_\cresc as' )c c(-. c-. )c-.]
...
% 60
    ...
    | es4-\f [d16.( )b32] c8-. r r
    | c4.( )bes!8 r r
    | \once \property Voice.Slur \set #'attachment = #'(stem . head)
      bes4(-\pp g8 )d' r r
