violinIThirdMov = \notes \relative g' {
    ...
    \once \property Voice.TextScript \override #'extra-offset =
      #'(-1.0 . 0.0) g4(-\parentP [)as8-\sf \rbcOne r16. g32] \grace
      { \cue g16 } [f8-. es-.] r g,(
    | [bes \LowerText es_\cresc \restoreText g )bes] es4-\f bes
    | [g16.^\trill as32 bes8] r4 c4.( )ces8
    | \slurDown bes4( ~ [bes16 a as )g] \slurBoth f8( as4 )d,8

% 5
    | [es8 \rbcOne r16 bes(] \LowerText [es_\cresc \restoreText g
      bes )es] g4( [)as8-\sf \rbcOne r16. g32-\p]
    | \grace { \cue g16 } [f8-. es-.] r es,( [g_\cresc b c )es]
...
% 10
    ...
    | [ges8.(-\f f32 )es] [es( des c bes] [a bes a )bes] [c8
      \rbcOne r16 des(-\p] [)c8 \rbcOne r16 des'(]
    | [)c8 \rbcOne r16 d!(] )es8 r r2
...
% 25
    | g4(-\p [)as8-\sf \rbcOne r16. g32] \grace
      { \cue g16 } [f8-. es-.] r g,(
    | [bes \LowerText es_\cresc \restoreText g )bes] es4-\f bes
    | [g16.^\trill as32 bes8] r8 \slurStemToHead es,8( [g_\cresc bes
      es )g]
...
% 30
    ...
    | \times 2/3 { r16 [es,(-. f-.] } \times 2/3 { [g-. as-. )bes-.] }
      ...
      [f16.( )es32 es8.(] [)es'16_\cresc \raiseSlur es(-. )es-.]
      \restoreSlur
    | [es8( ~ es32 des ces bes] [)a16-\f \raiseSlur a(-. a-. )a-.]
      \restoreSlur bes2-\p ~
    | [bes8.( a32 )bes] [ces( bes as ges] [f es ges )es] bes2

% 35
    | [ces8.(-\f bes32 )as] [as( ges f es] [d es d )es] [f8 \rbcOne
      r16 ges(-\p] [)f8 \rbcOne r16 ges'!(]
    | [)f8 \rbcOne r16 g!(] )as8 r r2
    | c4. [bes32( a g )f] [f8( )bes] r4
    | bes4. [as!32( g f )es] [es8( )as16] r [as16.( g32 )f16] r32 f
    | [bes16.( as32 )g16] r32 g c16 r d, r es8 r \raiseSlur
      [bes16(-. bes-. bes-. )bes-.]
...
% 40
    ...
    | [f16(-\p )as c8] ~ [c16( bes32 as] [g f es )d] es8
      < { es,4( )e8 } \context Voice=x { s8 \LowerText s8_\cresc } >

% 45
    | \lowerDynamics [\times 2/3 { f16(-\p as )c } c8]
      \restoreDynamics ~ [c16( bes32 as g f es! )d]
      es16 r [f32( as g )f] es16 r [f'32( as g )f]
    | es16 r [es32( d f es] )g16 r [g32( f as g] )bes16 r [bes32( as c
      bes] )des8 r
    | c,4.( )ces8 bes4 ~ [bes16( a as )g]
    | f8( as4 )d,8 [es \rbcOne r16 g'(] [as a bes )b]
    | c4( ~ [c16 g as! )a] bes!4( ~ [bes16 a as )g]

% 50
    | f8( as4 )d,8 es r16 es( [g bes as )f]
    | es8 r16 es,( [g bes as )f] es8 r16 \lowerDynamics g,(-\f
      \restoreDynamics [bes es g )bes]
    | es4 bes [g16.-\p^\trill as32 bes8] r4
    | \grace { \cue g16( } \lowerText [)f8_#'(columns (dynamic "pp")
      (italic " staccato")) \grace { \cue g16( } )f8 \grace { \cue
      g16( } )f8 bes(] )es,8 r r4
}
