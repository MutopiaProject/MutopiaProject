violinIFirstMov = \notes \relative es' {
	...
	| f2.( [bes16 as g )as]
	| \once \property Voice.Slur \override #'attachment-offset = #'((0
          . 0) -0.25 . -0.50) \slurStemToStem f4( c' bes )as
          \slurDefToDef
	| g( )bes r2
	| f2.( [bes16 as g )as]
...
% 10
	| f2.( [bes16 as g )as]
	| \lowerText f4_\cresc \restoreText c'( )bes <as, d>
	| <g2-\f es'> es''
	| a,2.( )bes4
	| \once \property Voice.Slur \override #'attachment-offset = #'((0
          . 0) -0.25 . -0.50) \slurHeadToStem b( c e, )f \slurDefToDef
	| as!2( )g4 r
	| g4 g'4. [as16 g] \grace { \cue bes16 } [as8 g16 f]
	| [f8( )es] es4. [es8(-. es-. )es-.]
	| [es8.(-\p )f16] f2( )es4
...
% 20
	...
	| \slurDown \stemUp [g16( f as g] [bes as c )bes] [des( c bes
          as] [g f as )f] \stemBoth \slurBoth
	| es4( )d!8 r r2
	| R1
	| r4 r8 c''8(-.-\f [bes-. a-. g-. )f-.]
	| [e16( f g )f] [e( f g )f] f2 ~
	| f1 ~
	| f4( )es!8 r r \once \property Voice.TextScript \set
          #'extra-offset = #'(-1.0 . 0) [d(-._\parentP d-. )d-.]
...
% 30
	...
	| bes ~
	| bes_\cresc ~
	| \once \property Voice.Slur \override #'attachment-offset =
          #'((0 . 0.5) 0 . 2.5) bes4. a8(-. [bes-. c-. des-. )e,-.]
	| f4-\f f'2 \grace { \cue es16 } [d8 c16 bes]
	| < { c1^\trill | s4 } \context Voice=x { s2 s4.. \grace { [bes32(
          c] } s16 | )bes4 } >

% 40
	r4 [bes,8(-\p \times 2/3 { c16 bes a }] [)bes8 c-.]
	| \raiseSlur d4(-. d-. d-. )d-. \restoreSlur
...
% 70
	...
	| r8 f,4 f f f8
	| \raiseBeam [es8-\p \grace { \cue f16 } es16( d] \restoreBeam
          [)es8 f-.] g4-. r
	| [es'8 \grace { \cue f16 } es16( d] [)es8 f-.] g4 r
	| \times 2/3 { r8 \once \property Voice.TextScript \set
          #'extra-offset = #'(-1.0 . 0) [as,,-\parentF b] } \times 2/3
	...
	| \once \property Voice.TextScript \set #'extra-offset =
          #'(-1.0 . 0) [es8-\parentP \grace { \cue f16 } es16( d]
          [)es8 f-.] g4 r

% 80
        | [es'8 \grace { \cue f16 } es16( d] [)es8 f-.] g4 r
	| \times 2/3 { r8 \once \property Voice.TextScript \set
          #'extra-offset = #'(-1.0 . 0) [g,,-\parentF bes!] [e g bes]
          [e g bes] [des( )bes g-.] }
	| \times 2/3 { [bes g e] [des bes g] [bes( )g e-.]
          [des( )c bes'-.] }
	| \once \property Voice.TextScript \set #'extra-offset =
          #'(-1.0 . 0) [as8-\parentP \grace { \cue bes16 } as16( g]
          [)as8 bes-.] c4 r
	| [as'8 \grace { \cue bes16 } as16( g] [)as8 bes-.] c4 r
	| [a,8 \grace { \cue bes16 } a16( g] [)a8 bes-.] c4 r
	| [a'8 \grace { \cue bes16 } a16( g] [)a8 bes-.] c4 r
	| \times 2/3 { r8 \once \property Voice.TextScript \set
          #'extra-offset = #'(-1.0 . 0) [a,,-\parentF c] [fis a c]
          [fis a fis] [c'( )a fis-.] }
	| \times 2/3 { [a( )fis c-.] [fis( )c a-.] [c( )a fis-.] [es!(
          )d c'-.] } \tupletNum
	| \once \property Voice.TextScript \set #'extra-offset =
          #'(-1.0 . 0) [bes8 \grace { \cue c16 } bes16( a] [)bes8 c-.]
          d4 r

% 90
	| [bes'8 \grace { \cue c16 } bes16( a] [)bes8 c-.] d4 r
...
% 100
	| )bes r r2
	| \slurStemToHead es,2(-\p )es' \slurDefToDef
	| a,2.( )bes4
	| \once \property Voice.Slur \override #'attachment-offset = #'((0
          . 0) -0.25 . -0.50) \slurHeadToStem b( c e, )f \slurDefToDef
	| as!2( )g4 r
...
% 130
	...
	| es ~
	| es4. d8(-. [es-. f-. ges-. )a,-.]
	| bes4-\f bes'2 \grace { \cue as16 } [g8( f16 )es]
        | < { f1^\trill | s4 } \context Voice=x { s2 s4..
	  \grace { [es32( f] } s16 | )es4 } >
	r4 [es,8( \times 2/3 { f16 es d }] [)es8 f-.]
	| g4(-. g-. g-. )g-.
	| [g16( b c as] )g4 < { es4(-\f [f8 )g] } \context Voice=x { s8
          s8^\turn } >
...
% 153
	...
	| ces'2(-\p )bes
	| es(-\f )ges
	| bes4 r \lowerDynamics d,,2(-\p \restoreDynamics
