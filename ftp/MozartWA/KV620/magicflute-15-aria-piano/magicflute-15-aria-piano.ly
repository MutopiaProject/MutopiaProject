...
\header {
 ...
 footer = "Mutopia-2018/10/16-2234"
...
rh =  \relative c' {
  ...
  << { e'8( dis)} \\ { fis,16.( gis32 a8)} >> r16 b,-. <b cis>-. <b dis>-. |
  <b e>-. <b fis'>-. <b gis'>-. <b a'>-. <b b'>-. <gis' cis>-. <gis dis'>-. <gis e'>-.|
  << { e'8( dis)} \\ { fis,16.( gis32 a8)} >> r16 fis,16( <e gis> <dis a'>)|
  r8 <e b'>r <e gis b>|
  r <cis e a>r <b dis a'>|
  <b e gis>([ <cis fis a> <b e gis> <b dis fis>])|
  << { <dis fis>( <e gis>) } \\{ b4} >> r16 <e e'>^"Fl."_"Viol."( <gis gis'> <a a'>)|
  <b b'>8.( <gis gis'>16) <e e'>8.( <fis fis'>32 <gis gis'>)|
  <b b'>8( <a a'>) r16 <fis fis'> <fis fis'> <fis fis'>
  <gis gis'>8-. <fis cis' fis>32( <gis gis'> <a a'> <fis fis'>) <e gis b e>8( <dis fis a dis>)|
  <e e'> <gis, e'>r <gis cis e>|
  r8 <a cis fis>r <cis fis a>|
  r <gis' e' gis>16-.^"Fl."_"Hörn." <gis e' gis>-. <a fis' a>-. <a fis' a>-. <fis dis' fis>-. <fis dis' fis>-.|
  <e gis e'>8 r16 e' dis( a' fis dis|
  e8) r16 <gis, b e gis> <fis cis' fis>( <cis' cis'> <b dis b'> <dis, dis'>)|
...
lh = \relative c {
  ...
  <e e'>4 r
  << {r8 <e' gis> r <e gis>|
     r <e fis> r <dis a'>} \\ { <gis,, gis'>8r <cis cis'>r|
  <fis, fis'>r <b b'>r } >>
  <e e'>[ <a, a'> <b b'> <b b'>]
...
Dan wan -- delt er an Freun -- des Hand
