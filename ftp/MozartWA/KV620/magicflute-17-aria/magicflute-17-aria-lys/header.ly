...
\header {
  ...
  mutopiatitle = "Die Zauberflöte (The Magic Flute) - No. 17 Arie"
  mutopiacomposer = "MozartWA"
  mutopiapoet = "E. Schikaneder and C. L. Giesecke"
  opus = "KV 620"
  mutopiainstrument = "Orchestra: Flute, Oboe, Bassoon, Violins, Viola, Cello, Double Bass, Voice (Soprano)"
