...
\header{
  ...
  mutopiatitle = "Die Zauberflöte (The Magic Flute) - No. 7 Duett"
  mutopiacomposer = "MozartWA"
  mutopiapoet = "E. Schikaneder and C. L. Giesecke"
  opus = "KV 620"
  mutopiainstrument = "Orchestra: Clarinet, Bassoon, French Horn, Violins, Viola, Cello, Double Bass, Voice duet (Soprano and Bass)"
  date = "1791"
  style = "Classical"
  meter = "Andantino."
...
%	me and I would be very happy to correct them.  Karmically, Deborah		   %
%											   %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
