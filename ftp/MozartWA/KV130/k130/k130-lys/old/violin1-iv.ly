...
% 30
	...
	| c4 c, a' a,
	| g c8. d16 < { d2-\trill } { s4.. \grace { c16-[ d-] } } >

% 40
	| \times 2/3 { c'8 g g g g g \noTupletNum a f f f f f }
	| \times 2/3 { e c c c c c g' b, b b b b } \tupletNum
	| c4 e-\p dis8-( e-) f-( e-)
	| e4 e e \grace g16 f4
	| e-( d!-) cis8-( d-) e-( d-)
	| d4 d d \grace f16 e4
...
% 50
	| a'4-(-\f c,-) r2
	| \grace c16 b4-\p a8 g c4 c
	| fis,4. d8 g4 g
	| \grace f!16 e4 d8 c a'4 a
	| b,4. g8 d'4 d
	| c8 d e f g a b c
	| b c d e f4 r8 f,
	| f-( e-) f-( d-) c4-( b-)
...
% 70
	...
	| a r b, r
	| a' f8-( d-) c4-( b-)
	| \grace gis'16 a4 g16-( f e d-) c4-(b-)
...
% 90
    ...
    | <<a f'>>2: <<a f'>>4 r
    | <<a e'>>2: <<a e'>>4 r
    | \grace bes'16 a4-\p g8 f bes4 bes
    | gis4. e8 a4 a
...
% 150
    ...
    | f4 c d d'
    | c, f8. g16 < { g2-\trill } { s4.. \grace { f16-[ g-] } } >
    | \times 2/3 { f8 c c c c c \noTupletNum d bes bes bes bes bes}
    | \times 2/3 { a f f f f f c' e, e e e e }
    | f4 a-\p gis8-( a-) bes-( a-)
    | a4 a a \grace c16 bes4
    | a-( g!-) fis8-( g-) a-( g-)
    | g4 g g \grace bes16 a4
    | g-( f!-) e!8-( f-) g-( f-)
...
% 190
    | d r e, r
    | d' bes8-( g-) f4-( e-)
    | \grace cis16 d4 c16-( bes a g-) f4-( e-)
    | f8-\f c a' e f c a c
    | f c a' e f c a c
    | <<a f'>>4 r <<c f a>> <<a f' c'>>
    | <<a' f'>> <<a, f'>>: <<a f'>> r
