...
% 31
	...
	| r4 
	  < { bes'4 a b c bes a b c1 ~ c2 b c2. a4 g c b d c } \\
	    ...
	    { s4 s4. \grace { e16-[ f-] } s8 s2 s4. \grace { e16-[ f-] } } > 
	  r4 r2
	| R1*8

% 51
	| \grace c16 b4-\p^\aDue a8 g c4 c 
	| fis,4. d8 g4 g
...
% 60
    ...
    \grace a16 \raiseText g4-\p^\aDue f8 e a4 a
    | fis4. d8 g4 g
...
% 90
    ...
    | < { d2-( cis4-) } \\ { e,2. } > r4
    | \grace bes16 \raiseText a4-\p^\aDue g8 f bes4 bes
    | gis4. e8 a4 a
...
% 151
	...
	{ f1 ~ f2. e4 f1 ~ f4 } \\
	{ s1 s2 s4. \grace { f16-[ g-] } } >
      < { c4 bes g } { a4 g e } >
    | < { f4 } \\ { f4 } > r r2
    | R1*8

% 164
    | \grace f16 \raiseText e4-\p^\aDue d8 c f4 f
    | b,4. g8 c4 c'
