...
% 10
	...
	| d4 r r f'8-( d-)
	| \grace c8 bes4 a8 bes g4 c
	| \LowerText a4:16-\cresc bes8: c: d: e: f: g:
	| a2: a:
...
% 30
	...
	| g4. a16-( b \times 2/3 { c8-)-. b-. a-. g-. f-. e-. }
	| \raiseScript d8.-(-\trill c32 d-) r4 
	  \raiseScript e8.-(-\trill d32 e-) r4
	| f4. b16-( c \times 2/3 { d8-)-. c-. b-. a-. g-. f-. }
	| \raiseScript e8.-(\trill d32 e-) r4 
...
% 80
    ...
    | g2: g:
    | g4 r r2
    | \grace bes,32 a8.-(-\p-\trill g32 a-) r4 
      \grace c32 bes8.-(-\trill a32 bes-) r4
    | c4. d16-( e \times 2/3 { f8-)-. e-. d-. c-. bes-. a-. }

% 90
    | g8.-(-\trill f32 g-) r4 a8.-(-\trill g32 a-) r4
    | bes4. e16-( f \times 2/3 { g8-)-. f-. e-. d-. c-. bes-. }
