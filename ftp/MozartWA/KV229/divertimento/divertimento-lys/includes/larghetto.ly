...
oboeLarghetto = \notes \relative c'' {
   ...
   bes4\p (  f8) bes \< ( c  d\!) \property Voice.Stem \revert #'direction
   d16 \> ( f es  d)  c4\! r
   c4 (  f,8) c' \< ( d  es\!)
   e16 \> ( g f  es)  d4\! r
   f8. \< ( g32  a\!) bes8 \> ( a g  f\!)
   ...
   f8. \> ( d16  c4\!) r \property Voice.Stem \override #'direction = #-1
   bes4\p (  f8) bes \< ( c  d\!) \property Voice.Stem \revert #'direction
   d16 \> ( f es  d)  c4\! r
   c4 (  f,8) c' \< ( d  es\!)
   e16 \> ( g f  es)  d4\! r
   ...
   \endcresc a16\f ( f a c f a c a bes f es  d)
...
clarinetLarghetto = \notes \relative c' {
   ...
   a,8. \< ( b32  c\!) d8 \> ( c b  d\!)
   c2 b8 (  c)
   e8. ( c16  b4) r \property Voice.Stem \override #'direction = #-1
   r8   b[ \< b b ]   c[ (  cis\!) ] \property Voice.Stem \revert #'direction
   ...
   g \> ( b16  a)  a2\! \normalDynamics \property Voice.Stem \override #'direction = #-1
   b4\f \> ~  b8\! b\p \< b (  cis\!) \property Voice.Stem \revert #'direction
   cis \> ( e16  d)  d2\!
   ...
   dis8 \> ( e16  d)  c4\! r
   R2.
   a8. ( b32  c) \cresc d8 ( c b  c)
   c4 (   b2)
   g8. ( a32  bes) c8 ( d c  bes)
   a2. \noBreak
   \endcresc g8\f g4 g'8 ~ g16 e ( d  c)
...
bassoonLarghetto = \notes \relative c' {
   ...
   c8 c' r16 c, e g \cresc c8 c, \noBreak
   f8 f' r16 f, a c f8 f,
   bes,8 bes' r16 bes, d f bes8 bes,
   es8 es' r16 es, g bes es8 es,
   \endcresc es'4\f es, d8 (  g)
   es \> es f f f  f\!
   bes,\p bes' bes,4 r
   }
}
