...
celloSecondMov =  \relative f {
    ...
    | f,!4 r8  f'[(- \markup{ {\dynamic "p"} {\italic " cresc."}} c'  bes)]
    |  a[  a(-. g-. f-. e-.  d)-.]
...
% 20
    | g4 r8  g,16[( fis]  a8[  g)]
    | r8   g16[(-\cresc fis]  a8[  g)] r8  g16[( fis]
    |  a8[  g)] r  g[(\f b  c)]
    | g'4 r r
    |  g8[\p g] g r r4
    |  b8[ b] b r r4
...
% 60
    ...
    | r8  d16[( cis]  e8[  d)] r4
    | r8   bes!16[(-\cresc a]  c!8[  bes)] r8 bes
    | r  b16[( a]  c8[  b)] r b
    | r8  c16[( b]  d8[  c)] r c
...
% 90
    ...
    | bes4\p   bes8[(-. bes-. bes-.  bes)-.]
    | bes4\sf   bes8[(-.\p  bes)-.] b4\sf
    |   b8[(-.\p  b)-.] c4 cis\fp
    |  d(\f c!  f,)
    | bes r bes\p
    | a4(-\cresc g  f)
