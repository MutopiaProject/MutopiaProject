...
% 20
    | \lowerDynamics [b(-\sf )cis] \LowerDynamics d4.-\p d8
    | \lowerDynamics [d8(-\sf )e] \LowerDynamics f4.-\p d'8
...
% 50
	...
	| [d8 \grace { \cue fis16 } e8 d \grace { \cue fis16 } e8] d4 r
	| < { \stemUp g4. \stemBoth } \context Voice=x { \stemUp
          <g,,4-\f d' b'> s8 } > [b16 a] [g fis e d] [c b a g]
...
% 60
	...
	| [f8( )e] e4. \raiseSlur [e8(-. e-. )e-.]
	| e4( )a4. [a8( b )c]
	| [c( )d,] d4. \raiseSlur [d8(-. d-. )d-.]
	| [d( )g] g4. [g8( a )b]
	| [b( )c,] r c [c( )a'] r a
	| [a( )b,] r b [b( )g'] r g
...
% 70
	| [d( c b c] [d e fis )g] < { a,2-\trill } \context Voice=x {
          s4 s8 \tiny [g16 a] } >
	| g4 r d'-\p d
...
% 170
	...
	| [g8 \grace { \cue b16 } a8 g \grace { \cue b16 } a8] g4 r
	| <e,-\f c' g'> ~ [g'16 f! e d] [c b a g] [f e d c]
	| \lowerDynamics [b(-\p d c e] [d f e g] )f4 r
	| [f'16-\f g a g] [f e d c] [b c d c] [b a g f]
	| \stemUp [e(-\p g f a] [g bes a c] )bes4 r \stemBoth
...
% 190
	| [gis a b a] \grace { \cue g16 } [f8 e16 d] < { d2-\trill }
          \context Voice=x { s4 s8 \tiny [c16 d] } >
	| c4 r g'-\p g
