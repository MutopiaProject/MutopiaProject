violinIIFirstMov = \notes \relative es' {
    ...
    R2.
    | \lowerDynamics es2(-\p d4
    | \LowerText cis-\cresc )d4. a'8(
    | [b-\f c] )d r r4
    | R2.
    | \lowerDynamics des,2(-\p c4
    | \lowerText b-\cresc )c4. g'8(
    | [a-\f bes] )c r r4
    | r4 f,2-\p ~
...
% 50
	...
	| )g8 r \lowerDynamics [g16(-\f fis g fis] )g2
	| \lowerDynamics [fis8(-\p  )d fis-. fis-.] r [g e( )g]
	| [fis( )d fis-. fis-.] r g [e16( g e )g]
	| [fis( a g a] [fis a g )a] fis4 r
	| \lowerDynamics [d8(-\f )b d-. d-.] d4 r
...
% 70
	...
	| [b8.( )g16] b4 [dis8( \LowerText e-\cresc cis )d]
...
% 90
	| [b,-. b'( a b] [c b a )b] [d,( a' g a] [b a g )a] \slurBoth
          \stemBoth
	| g2-\p ~ [g8 g( a )b]
	| d4( )c r2
	...
	| c1
	| [b8( d b g] [fis d c )a]
	| \stemDown [b( )d d'( g] [fis e d )c]  \stemBoth
	| [ais( b d )g,] [fis( d c )a!]
	| \stemDown [b( )d d'( g] [fis e d )c] \stemBoth
	| [ais( )b b-. b-.] b4 r

% 100
	| r8 [a,!( \LowerText )a'!-\cresc a-.] a4 r
	| r8 [b,( )b' b-.] b4 r
	| r8 [c,( )c' c-.] c4 r
	| cis2-\f ~ [cis8( d e )f]
	| d,2 ~ d4 r
...
% 160
	...
	| b2 ~ [b8 b( c )d]
	| d2( [)c8 c( d )e]
	| \lowerDynamics [f(-\p a g f] \LowerDynamics [e-\sf c d )e]
	| [f-\p a'( g f] [e-\sf c d )e]
...
% 170
	...
	| \lowerDynamics [g8(-\f )e g-. g-.] g4 r
	| r2 \lowerDynamics [b,16(-\p d c e] [d f e )g]
	| \LowerDynamics [f8(-\f )d f-. f-.] [f( )d d-. d-.]
...
% 190
	...
	| [e8.( )c16] e4 \LowerText [gis8(-\cresc a fis g]
...
% 210
	...
	| \lowerDynamics c2-\p ~ [c8 c( d )e]
	| g4( )f r2
	| r8 [b( c b] [c cis d )e]
	| f1
	| [e8( g e c!] [b g f )d]
	| \slurStemToHead e( g4 )c8 [b( a g )f]
	| [dis( )e g( c] [b g f )d]
	| [e( )g g'( c] [b a g )f]
	| [dis( )e e-. e-.] e4 r

% 220
	| r8 [d,!( \lowerText )d'-\cresc d-.] d4 r
	| r8 [e,( )e' e-.] e4 r
	| r8 [f,( )f' f-.] f4 r
	| fis2-\f ~ [fis8( g a )bes]
	| g,2-\p ~ g4 r
...
% 230
    | r8 \LowerText [f(-\cresc a g] [e f a )g]
    | [e( f a g] [e f a )g]
