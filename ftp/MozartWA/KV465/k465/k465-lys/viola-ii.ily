...
% 50
    ...
    | bes( a  c)
    | c r r
    | c(   bes'8)[  a(-.-\cresc g-.  f)-.] % The slur start from a
    | e4\f r8  e[( g  f)]
    | f4 ~  f8[(  c)] r c\p
    |  c[( bes16  a)]  a[  f'-.\p e-. d-.] 
       c[-. bes-. a-. g-.]
...
% 90
    ...
    | <des e>4\sf  <des e>8[(-. <des e>)-.] <d f>4\sf
    |  <d f>8[(-. <d f>)-.] <c f>4(  bes)\fp
    |  a8[-.  f(\f fis g as  a)]
...
% 110
    ...
    | e,4:16 e4:16 e4:16   f16[\pp c c c] c4:16 c4:16
    | c2 r4 \bar "|."
}
