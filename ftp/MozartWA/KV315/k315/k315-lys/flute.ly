...
% 30
    ...
    | < { a2 }
	\context Voice=x { 
	    \setTrillWave \blankNotes a4 
	    \beginTrillWave a8 s16 a16 \endTrillWave 
	}
	\context Voice=y { s4 s8 s16. \grace { [g32-( a-)] } } >
    | g4 r
    | R2*3
...
% 40
    | es4-( fis,-)
    | g8 a^\markup { \tiny \musicglyph #"accidentals-2" 
		     \hspace #0.3 \musicglyph #"scripts-trill" }
      bes r
    | bes32-( a c a-) g4-( fis8-)
    | a16-( g-) g8-. r g
...
% 80
    ...
    | < { d2 }
	\context Voice=x { 
	    \setTrillWave \blankNotes d4 
	    \beginTrillWave d8 s16 d16 \endTrillWave 
	}
	\context Voice=y { s4 s8 s16. \grace { [c32-( d-)] } } >
    | c4 r
    | R2*4
