...
\header {
  ...
  morefinfo = "<p>This edition is based on the Breitkopf &amp; Härtel print of the score
(1880s), the so-called &ldquo;Alte Mozart Ausgabe&rdquo;. The B&amp;H score lacks any
...
text.</p>
<p>The autograph does not state the date nor the place of
...
was written as a replacement for the <em>Adagio ma non troppo</em> in the
...
KV. 314 and some flute quartets as well.</p>
<p>Supposing this theory is true, De Jean's dislike for the original
...
french horns) and the structure (sonata form without repeats).</p>
<p>This would not be the first case in Mozart's career he was forced
...
Brunetti, he was asked to remove the splendid original <em>Adagio</em>
because Brunetti defined it &ldquo;too much affected&rdquo;, and replaced it with
the simpler Adagio KV. 261.</p>
<p>Maurizio Tomasi, August 2003.</p>
"
}
