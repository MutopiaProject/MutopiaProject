...
% 20
	| R1*6
	| r8 \grace { \cue fis32 } [e16(-\p dis] [e8 fis] [gis a ais )b]
...
% 131
	| r2 r8 [a,8-.-\f b-. cis-.]
	| [d-. \grace { \cue e32 } d16( cis] [d8 e] [fis g gis )a]
...
% 190
	...
	| a,4 r a'2(-\p
	| e )fis
	| \stemUp \slurDown d4( cis b )d \stemBoth \slurBoth
	| e2 e,-\f
	| a4 a' a, r
    }
}
