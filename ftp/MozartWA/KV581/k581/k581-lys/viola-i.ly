...
% 50
	...
	| < { \voiceTwo g g4 g g g8( | )f f4 f f f8( | \oneVoice )d }
	    \context Voice=x { \voiceOne a'8 a4 a a a8 ~ | a a4 a a a8( 
...
% 90
	...
	| d4 d''2 d4(
	| )b b,2 b4 ~
	| b g'2 < { \voiceTwo g4( | )gis! }
                  \context Voice=x { \voiceOne s4 | b } >
          \oneVoice gis,2 gis4
...
% 120
	...
	| a4 r r2
	| < { \voiceOne e1 ~ | e4 } 
            \context Voice=x { \voiceTwo d1(-\f | )cis4 } > r r2
	| \oneVoice R1*3
...
% 190
	...
	| < { d1-\f }
		...
		\visibleNotes \tiny \stemUp [cis16 d] } >
	| cis4 r cis2(-\p
	| b )a
	| fis4( e d )fis
	| d2 \lowerDynamics gis4.(-\trill-\f [fis16 )gis]
	| a4 a' a, r
    }
}
