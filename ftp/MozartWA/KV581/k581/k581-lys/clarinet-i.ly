clarinetFirstMov = \notes \relative g {
	...
	| c4 r r2
	| R1
	| r8 \grace { \cue d'32 } [c16( b] [c8 d] [e \< f fis \! )g]
...
% 35
	| r8 \grace { \cue e32 } [d16( cis] [d8 e] [fis g a )b]
	| c1
	| r8 \grace { \cue e,32 } [d16( cis] [d8 e] [fis g a )b]
	| c1 ~
...
% 60
	...
	| < { a1 }
            \context Voice=x { 
	        \setTrillWave \blankNotes a2. 
		\startTextSpan a8 \stopTextSpan
		\visibleNotes \tiny \stemUp [g16 a] } >
	| g4 r r2
	| R1
	| r2 [d8( e fis )g]
	| [e( fis g a] [fis g a )b]
...
% 120
	...
	| e4 r r2
	| R1
	| r8 \grace { \cue d32 } [c16(-\p b] [c8 d] [e f fis )g]
	| [a( g fis g] [fis g a )b]
	| [c( a e f!] [b g dis )e]
	| [a( f cis d!] [g e b )c]
...
% 140
	| r8 \grace { \cue a'32 } [g16( fis] [g8 a] [b c d )e]
	| < f! \context Voice=x { s4 \> s2 \! s4 } >
	| R1
	| r8 \grace { [g32( f )e] } [f8( \> as g] [f es d \! )c]
...
% 180
	...
	| [a c es fis] [a b c 
	  \once \property Voice.Beam \set #'direction = #-1 fis,,,]
	| g4 r r2
...
% 190
	...
	| < { d1-\f }
            \context Voice=x { 
	        \setTrillWave \blankNotes d2. 
		\startTextSpan a8 \stopTextSpan
		\visibleNotes \tiny \stemUp [c16 d] } >
	| c4 r r2
	| R1
	| a'2.(-\cresc [f8. )d16]
