...
% 10
    ...
    | f as,, \> [g8 \! f]
    | e4 bes'''4.( )a8
    | [fis16( g bes )d] f,4( \grace { \cue a32 } [g8. )f16]

% 20
    | f4 r r
    | < {
            r8 c4 ~ \RAISESLUR [c16.( )d32]
            \RaiseSlur [e16.( )f32 \RAISESLUR g16.( )a32] 
        }
        \context Voice=x 
        { 
            s4. s16 
	    ...
	    s16^\markup { \center
                          <<
                            ...
                            { \teeny { "(" \hspace #-1.2
				       \musicglyph #"accidentals-0" 
				       \hspace #-1.2 ")" }}
                          >> }
            s16 \raiseScript s16-\turn s16
...
% 41
    | d4 ~ [d8. \grace { [e32 d cis d] } e16] [f8. \grace { [g32 f e f] } g16 ]
    | [a8( c b a g )f]
...
% 60
    ...
    | f as,, \> [g8 \! f]
    | e4 bes'''4.( )a8
    | [fis16( g a )bes] f4( \grace { \cue a32 } [g8. )f16]
