...
% 20
	...
	| [g,, f''( d )b] \stemBoth c4 r
    }

    \repeat volta 2 {
        | [f8-. g,,] b''4.( [c8 e, )a]
	| \raiseSlur g4( [f8-\trill e16 f] )e4 r
        | [f8-. g,,] b''4.( [c8 e, )f]
	| [fis( g a g] [d e f )fis]
	| [g-. c,,] c''4. [c,8( d )e]
...
% 90
	...
	| c,4( \grace { \cue e32 } [d8. )c16] c4 r
    }

    \repeat volta 2 {
        | [f,,32( g b d g b d )g] b4.( c8 [)e, a-.]
	| \raiseSlur g4(-. [fis8-. f-.] )e4-. r
    ...
    | R1
    | r2 r8 [g-\p a b]
    | \RaiseSlur [c( b a-\trill )g] \RaiseSlur [g( f e-\trill )d]
    | [c( d e )f] [d( b a )g]
    | g'4-\f g e e
    | [f8.( g16 a8. )f16] d4 d
    | c c d d
