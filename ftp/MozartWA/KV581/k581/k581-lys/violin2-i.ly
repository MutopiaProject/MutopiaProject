...
% 40
	...
	| <b e>
	| <cis fis>
	| < { b ~ b } \context Voice=x { \voiceOne fis'( )e } > \oneVoice
	| <fis' a>
	| < { \voiceOne a4( gis2 )fis4 } \context Voice=x { b,1 } > \oneVoice
	| e8 b4-\pp b b b8 ~
	| b b4 b b b8(
...
% 60
	...
	| < { a1-\f }
		...
		\visibleNotes \tiny \stemUp [gis16 a] } >
	| gis4 r e-\p e
	| e1
	| dis4( )e r e
	| r a r [a8( )b]
...
% 120
	...
	| b,2( )cis
	| a1
	| r8 [a' a a] r \stemUp [gis( b )e,] \stemBoth
	| e4 r r2
	| <b1(-\f gis'>
	| <)a4 a'> r r2
	| a'2(-\p gis
...
% 150
	...
	| cis
	| fis
	| < { \voiceOne d'4( cis2 )b4 } \context Voice=x { e,1 } > \oneVoice
	| a8 e4-\pp e e e8 ~
	| e e4 e e e8 ~
	| e d4 d d d8 ~
	| d d4 d d d8(
...
% 190
	...
	| < { gis1-\f }
            \context Voice=x { 
	        \setTrillWave \blankNotes gis2. 
		\startTextSpan a8 \stopTextSpan
		\visibleNotes \tiny \stemUp [fis16 gis] } >
	| a4 r a2(-\p
	| e )cis
	| d4( e fis )d
