...
% 20
	| \slurHeadToStem cis2(-\p b
	| a )gis
	| fis2( )e
	| d4 \slurStemToStem [gis16( fis gis a] b4 )a
...
% 30
	...
	| [b8( )ais] \raiseSlur ais4(-. ais-. )ais-.
	| b4 r r2
	| r8 \grace { [b32( a )gis] } \stemUp [a8( c b] [a g fis )e]
	| dis4 r r2
	| r8 \grace { [b'32( a )gis] } [a8( c b] [a g fis )e]
	| dis4 \stemBoth r a' r
...
% 60
	...
	| [b8( )gis e'-. e-.] [e( )b gis-. e-.] \stemBoth
	| < { dis1-\f }
            \context Voice=x { 
	        \setTrillWave \blankNotes dis2. 
		\startTextSpan a8 \stopTextSpan
		\visibleNotes \tiny \stemUp [cis16 dis] } >
...
% 70
	...
	| fis )e
	| fis4( gis a )fis
	| e2 \grace { gis8 } \raiseScript [fis8.(-\f-\trill e16 fis8. )gis16]
	| e4 <b gis'> <b e> r
    }
...
% 90
	...
	| g 
          < { \voiceOne a,2 a4 | a } 
            \context Voice=x { \voiceTwo g2( )e4 | f } >
	\oneVoice a'2 a4 ~
	| a < { \voiceOne b,2 ~ b4 } 
              \context Voice=x { \voiceTwo a2( )fis!4 } >
	| \oneVoice <g8 b> [g,( b )e] [g( b e )g]
...
% 140
	| e4 r r2
	| r8 \grace { [e'32( d )cis] } [d8( \> f \! e] [d c b )a]
	| [gis8 \grace { \cue fis'!32 } e16( dis] [e8 fis] [gis a b )cis]
	| d1 ~
	| d4 r a,2(-\fp
	| )gis4 r d2-\fp ~
