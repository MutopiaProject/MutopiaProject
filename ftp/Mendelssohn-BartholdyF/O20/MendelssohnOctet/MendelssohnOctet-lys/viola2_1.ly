...
SecondViolaFirstMovement =
{
 \relative c {  
  ...
  \repeat volta 2 {
   ...
   \repeat "tremolo" 4 {g!( bes)} \cresc \repeat "tremolo" 4 {aes( ces)} |
   \repeat "tremolo" 4 {bes( des)} \cresc \repeat "tremolo" 4 {c!( ees)} |
   ...
   des\!\> c8)\! r r2 |
   r c2:16\mf |
   c4:16 des2:16\sf \cresc ees4:16_\markup{\dynamic "sf"} |
   ...
   a c, c a bes d d a' |
   d, bes' d, a' d, bes' r4 |
   \cresc \repeat "tremolo" 4 {g,16\(^\markup{\bold\italic "arco"} bes} \repeat "tremolo" 4 {g bes} |
   ...
   ees4( f) ees( f) |
   \cresc ees8( f) ees( f) ees-. f-. ees-. g-. |
  ...
  f( ees! d ees f g \cresc aes bes aes g f ees d c d ees) |
  ...
  \cresc \repeat "tremolo" 4 {bes( g)} \repeat "tremolo" 4 {c( aes)} |
  ...
  bes2:16 bes2:16 |
  \cresc bes2:16^\markup{\dynamic "sf"} b2:16^\markup{\dynamic "sf"} |
  c2:16^\markup{\dynamic "sf"} c2:16^\markup{\dynamic "sf"} |
  bes!2:16\ff bes2:16 |
  bes2:16 aes2:16 |
  g8 ees4\p ees ees ees8~ |
  \cresc ees ees4 ees ees ees8( |
  << {d)\f d4 d d d8( } {s2 s2\<} >>|
