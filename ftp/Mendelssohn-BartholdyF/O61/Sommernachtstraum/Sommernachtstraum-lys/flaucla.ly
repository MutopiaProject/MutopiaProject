...
r4 r8 r\p \grace{a,32} g8(\< \!fis | h\> g fis \!)e r r |
r4 r8 r \grace{a32} g8(-"cresc."\< \!fis | h\> g fis \!)e r r |
%%22
r4 r8 r \grace{c'32} h8(\f a| g'4.\sf )fis~ | fis r4 r8 |
r4 r8 r\p \grace{d32} c8(\< \!h | e\> c \!a )fis r r |
r4 r8 r \grace{d'32} c8-"cresc."(\< \!h | e\> c \!a )fis r r |
r4 r8 r \grace{d'32} c8-"cresc."( h | e c a )fis r r |
%%31
...
\skip 2.*132;
R2.*4 |
< \notes \relative c'' { a'8 a( h )c c( e | )a a( e )c c( h | )a }
  \notes \relative c'' { c8\pp c e a a h | c c h a a e | c }
>
r8 r r4 r8 | R2.*2 |
}
...
clarinettiStaff = \context Staff = clarinetti <
	...
	\property Staff.instrument = #"Clarinetti in A"
	\property Staff.instr = #"Cl."
	\property Staff.transposing = #-3
	\notes \context Staff=clarinetti <
		\time 6/8;
		\key c \minor;
		\context Voice=clarinetti
			\transpose es' { \flaucla }
			\clarinettiEnd
	>
>
