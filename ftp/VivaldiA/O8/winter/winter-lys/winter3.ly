...
% 25
\mark "G"
bes8_"Tutti"^"Caminar piano, e con tinore" ( aes ) g |
aes ( g ) f |
bes8 ( aes ) g |
aes ( g ) f |
bes8 ( aes ) g |
...
< g8_"Tutti" des' b'? > s4  % vivaldi ommitted nat on b; viola has b nat
  }
  \context Voice = VA { \voiceOne
f''16 ( ees d c b! ) a 
  }
>
g'16 ( a b? c d ) ees | % vivaldi forgot to mark the b natural in this measure
f ( ees d c b ) a |
g ( a b c d ) ees |
\mark "L"
f8 r8 r32 b, c d |
...
\mark "M"
% "the wind Sirocco"
g''8_"Lento Tutti"^"Il Vento Sirocco" ( f ) ees |
d ( ees ) f |
g ( f ) ees |
d ( ees ) f |
% 105
...
ees32_"Solo"^"Il Vento Borea e tutti li Venti" bes c d?	ees f g aes	bes aes g f |  % vivaldi had des; changed to d based on key (bes harmonic minor) and d in following measures
