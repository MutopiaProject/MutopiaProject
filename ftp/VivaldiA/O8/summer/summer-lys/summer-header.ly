...
\header {
	title = "Estate  /  Summer"
	subtitle = "Il Cimento dell' Armonia e dell' Inventione -- Concerto II"
	composer = "Antonio Vivaldi"
	%opus = "Op. 8, No. 2"

 mutopiatitle = "Estate  /  Summer"
 mutopiacomposer = "A. Vivaldi (1678-1741)"
 mutopiaopus = "Op. 8, No. 2"
 mutopiainstrument = "Violin, String"
 date = "1725"
 source = "Performers' Facsimiles"
 style = "Baroque"
 copyright = "MutopiaBSD"
 maintainer = "Anonymous" % John Williams (no, not that one...)
