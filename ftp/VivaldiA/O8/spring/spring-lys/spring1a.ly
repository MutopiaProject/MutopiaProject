...
% 60
R1 |
r8  cis-._"Solo"^\markup{"" \translate #(cons -0.5 0.5) "Canto d' Vcelli"} ( cis -. ) cis -.	cis-. ( cis-. cis-. ) dis-. |
...
[ gis8_"Tutti" gis ] [ gis fis16 gis ] 	a4. a16 gis |
...
b' a16 gis a8 b 	cis b4 e,8 |
cis' b4 a8 	gis fis16 e fis4-\trill |
e4 r8 e_"Piano" 	b' a16 gis < a8 s8 > b8  |  % lilypond is freaking out about the last a in this measure
% 80
