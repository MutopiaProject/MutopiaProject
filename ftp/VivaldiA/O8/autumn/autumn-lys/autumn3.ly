...
a8 a16 a a a |
a8 f f |
a8. \property Voice.stemLeftBeamCount = #1 \property Voice.stemRightBeamCount = #2 bes16 \property Voice.stemLeftBeamCount = #2 a bes |
a8. \property Voice.stemLeftBeamCount = #1 \property Voice.stemRightBeamCount = #2 bes16 \property Voice.stemLeftBeamCount = #2 a bes |
% 40
a bes a bes a bes |
a4.  |
...
f8 f16 f f f |
f8 c c |
f8. \property Voice.stemLeftBeamCount = #1 \property Voice.stemRightBeamCount = #2 g16 \property Voice.stemLeftBeamCount = #2 f g |
f8. \property Voice.stemLeftBeamCount = #1 \property Voice.stemRightBeamCount = #2 g16 \property Voice.stemLeftBeamCount = #2 f g |
% 40
f g f g f g |
f4.
...
\property Voice.autoBeamSettings \override #'(begin 1 24 * *) = #(ly:make-moment 1 8)
\property Voice.autoBeamSettings \override #'(end 1 24 * *) = #(ly:make-moment 1 8)
\property Voice.autoBeamSettings \override #'(begin 1 48 * *) = #(ly:make-moment 1 8)
\property Voice.autoBeamSettings \override #'(end 1 48 * *) = #(ly:make-moment 1 8)
...
% 86
\times 2/3 {
c16 \property Voice.stemLeftBeamCount = #2 \property Voice.stemRightBeamCount = #3 b32 ( \property Voice.stemLeftBeamCount = #3 \property Voice.stemRightBeamCount = #3 a \property Voice.stemLeftBeamCount = #3 \property Voice.stemRightBeamCount = #3 g f 	e16 d ) c 	e ( g ) b |
a f c  	a f c } 	f16 r |
\times 2/3 {
d''16 \property Voice.stemLeftBeamCount = #2 \property Voice.stemRightBeamCount = #3 c32 ( \property Voice.stemLeftBeamCount = #3 \property Voice.stemRightBeamCount = #3 bes \property Voice.stemLeftBeamCount = #3 \property Voice.stemRightBeamCount = #3 a g	fis16 e ) d 	fis! ( a ) c |
b g d 	b g d } 	g16 r |
% 90
\times 2/3 {
e''16 \property Voice.stemLeftBeamCount = #2 \property Voice.stemRightBeamCount = #3 d32 ( \property Voice.stemLeftBeamCount = #3 \property Voice.stemRightBeamCount = #3 c \property Voice.stemLeftBeamCount = #3 \property Voice.stemRightBeamCount = #3 b a	gis16 fis ) e 	gis! ( b! ) d |
c a e 	c a e } 	a16 r |
\times 2/3 {
...
R4. |
\mark "H"
r32^"La Tiera fuggendo Muore" f ( a g f e d c bes a g ) f |
% 130
c4. ~ |
