...
\header {
	...
	poet = \markup \box { \pad-around #1 {"Hautbois 2"}}	%% placé en haut à gauche
	instrumentHeader = \markup {"Hautbois 2"}
}	%% fin header
