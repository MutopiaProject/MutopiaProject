...
\header {
	...
	poet = \markup \box { \pad-around #1 {"Hautbois 1"}}	%% placé en haut à gauche
	instrumentHeader = \markup {"Hautbois 1"}
}	%% fin header
