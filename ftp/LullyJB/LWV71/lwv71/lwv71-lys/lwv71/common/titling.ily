...
balletScoreTitleMarkup = \markup \override #'(baseline-skip . 3) \column {
  ...
  %% Acte
  \fill-line { 
    \when-property #'header:acte \column {
      \act \fromproperty #'header:acte 
      \vspace #1
    }
  }
  %% Scène
  \fill-line { 
    \when-property #'header:scene \column {
      \scene \fromproperty #'header:scene 
    }
  }
  %% Description
  \fill-line { 
    \when-property #'header:sceneDescription \column {
      \override #'(linewidth . 70)
      \fontsize #2 \fromproperty #'header:sceneDescription
      \vspace #1
    }
  }
  %% Simple titre
