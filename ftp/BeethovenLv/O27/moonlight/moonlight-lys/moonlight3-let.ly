...
topmain =  \relative c'
{
	...
	\repeat volta 2 {
		...
		r16 \once \override Slur #'control-points = #'((0.5 . 1) (1.5 . 9) (36 . 7.5) (46.4 . 4.3))
		...
		\once \override Slur #'control-points = #'((1 . 1.8) (15 . 9) (39 . 7.5) (48.1 . 0.5))
		dis-( ais cis \moveFingering #'(0 . -3.5) dis-3 ais' cis, dis \moveFingering #'(0 . -3) ais'-4 cis ais dis, cis ais' dis, cis ais-) |
		b4-.-\p
		\once \override Slur #'control-points = #'((1.75 . 1.6) (11 . 5) (22 . 6) (35 . 3.6))
	...
	<cis a fis cis>4-.
	\once \override Slur #'control-points = #'((1.55 . 1.3) (11 . 5) (22 . 6) (33.8 . 2.65))
	...
	<e e,>4-( <dis dis,>-4-) ~ <dis dis,>8 <dis dis,>-4-( <gis gis,>8.-5 <dis dis,>16-4-) |
	...
	\times 2/3 { \once \override Slur #'control-points = #'((1.5 . 3.75) (7 . 5) (14 . 5) (19.4 . 1.5))  a8-5-(-\f fis cis } \clearTuplet \times 2/3 { a \moveFingering #'(0 . 0) fis_4 cis-) \slurUp 
		
	\once \override Slur #'control-points = #'((1.5 . 3) (7 . 4.5) (15.5 . 3) (20 . -8))
		a'-( fis cis
		\stemUp
		\change Staff = "down"                                                                                                                               
	a \moveFingering #'(0 . 2) fis_4 cis-) } | %3/5
	\once \override Slur #'control-points = #'((1.5 . 5.5) (15 . 22) (40 . 20) (50.2 . 12.5))   a'16-( fis-4 cis a cis fis-4 a-1 cis
	\stemNeutral
	\change Staff = "up"
	\moveFingering #'(0 . -3) fis-4 \moveFingering #'(0 . -2) a-1 cis fis a fis cis a-) |
	\times 2/3 { \once \override Slur #'control-points = #'((1.5 . 3.75) (7 . 5) (14 . 5) (20.6 . 1.5)) a'8-(-\f fis d a fis d-4-) 
		
		\once \override Slur #'control-points = #'((1.5 . 3) (7 . 4.5) (15.5 . 3) (20.5 . -8)) a'-( fis d
		\stemUp
		\change Staff = "down"
	a fis-4 d-) } |
	\once \override Slur #'control-points = #'((1.5 . 5.5) (15 . 22) (43 . 20) (49.8 . 12.3)) a'16-( fis-4 d a d fis-4 a-1 d
	\stemNeutral
	\change Staff = "up"
	\moveFingering #'(0 . -3) fis-4 \moveFingering #'(0 . -2) a-1 d fis a fis d a-) |							%181
	\times 2/3 { \once \override Slur #'control-points = #'((1.5 . 4.75) (6 . 5.5) (14 . 4) (19.2 . 2)) \moveFingering #'(0 . 0.5) cis'8-4-(-\f ais fisis e \moveFingering #'(0 . -1) cis-3 \moveFingering #'(0 . -2) ais-2-) \moveFingering #'(0 . 0.5) e'-5-( cis ais } fisis16 e_1 cis_3 ais_2-) |
	...
	\once \override Slur #'control-points = #'((1.5 . -1.25) (20 . 10) (49 . 10) (54.2 . 2.5))
	
	\moveFingering #'(0 . -3.5) e'-5-( cis
	\stemUp
	\change Staff = "down"
	ais fisis \moveFingering #'(0 . 2) e_1 \moveFingering #'(0 . 1) cis_2 \moveFingering #'(0 . 2) e_1 fisis \once \override TupletNumber #'extra-offset = #'(0 . 11) \times 4/6 { ais-[
		\stemDown
		\change Staff = "up"
	cis \moveFingering #'(0 . -3.5) e-1 fisis ais cis-] e-1-[ fisis ais cis ais e-]-) } |
	\clearTuplet \times 2/3 { \once \override Slur #'control-points = #'((2 . 5.5) (30 . 11) (80 . 4) (97.5 . -7.5)) e'8-( \moveFingering #'(0 . 1.5) cis-4 gis } \times 2/3 { e \moveFingering #'(0 . -1) cis-4 gis e' cis gis } \stemUp e16 \moveFingering #'(0 . 2) cis'_4 gis e | \revertTuplet
	cis_2 gis'_5 e cis
	\stemUp
	\change Staff = "down"
	...
	\once \override PhrasingSlur #'control-points = #'((1.5 . 2.5) (28 . 12) (64 . 21) (98.6 . 18.75)) gis_2-\( a_1 ais b bis cis cisis dis e eis fis fisis gis a! ais b |

	%187
	\change Staff = "up"
	bis16 cis cisis dis
	\times 4/5 { e16-( eis fis fisis gis-) }
	\times 4/5 { a16-[-( ais b! bis cis-]-) }
	\times 2/3 { d16-[-( dis e-]-) }
	eis32 (fis fisis gis-)\) |
   ...
   \once \override Slur #'control-points = #'((1.5 . 5.5) (12 . 7) (36 . 7.5) (43.35 . 2.75)) e-5-(-\sf cis gis e \moveFingering #'(0 . -0.2) cis'-5 gis e cis gis'-5 e cis gis \moveFingering #'(-0.5 . -2) e'-5 cis gis e-) |
   \slurUp \once \override Slur #'control-points = #'((1.5 . 3.25)(12.5 . 4)(35 . 2)(45.6 . -6.75)) cis'-5-( gis e cis \moveFingering #'(-1 . -3) gis'-5 e cis gis
   \stemUp
   \change Staff = "down"
