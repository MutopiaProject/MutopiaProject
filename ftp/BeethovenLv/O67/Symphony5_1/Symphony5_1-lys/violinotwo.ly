\version "2.10.3"
 ...
 \setTextCresc f'2\<~ f'8[ aes' aes' f'] g'2~ g'8[ g' g' ees'] aes'8\!\sf[ aes' aes' f']
 ...
 R2 R2 R2 R2 g'2\p( aes') aes'( g') g'( aes') aes'( g') g'( aes') aes'( g') g'~ g' g'( f') aes'( bes') bes'( aes')
 ees'4( f' \setTextCresc ges'\< f' ees' f') ges'( f' ees' f') ges'( f' ees' f') ges'( f' ees' f' ges' f' ges' a'\!)
 ...
 r8 <bes' f''>8[ <bes' f''> <bes' f''>] <ees' bes' g''>4 r R2 R2 }

 R2 r8 des'8\ff[ des' des'] c'2~ c'2^\fermata
 r8 c''8\p[ c'' c''] aes'2~ aes'2~ aes'2~ aes'8 c''[ c'' c''] g'2~ g'2~ g'2~ g'2
 aes'8[ aes' aes' bes'] c''2~ c''8[ aes' aes' bes'] c''2~ c''4 r4 R2 R2 R2 r8 ees'8\p[ ees' f']
 g'2~ g'8[ ees' ees' f'] g'2~ \setTextCresc g'2\<( a'4 bes' c'' cis'') d''2\!\p~ d''8[ g' g' a'] fis'4 r
 ...
 r8 <bes' g''>\<[ <bes' g''> <bes' g''>] <bes' g''>4 r r4 cis''8 cis'' cis''4 d''8 d'' d''8\! d''8\ff[ d'' d'']
 g'2\sf a'\sf d'2\sf~ d'2~ d'2~ d'4 fis'8 fis' a'4 d''8 d'' b'8 g'8[ g' g'] c'2\sf d'2\sf
 g2\sf~ g2~ g2~ g4 b8 b d'4 g'8 g' e'4 r4 R2 R2 bes2 c' R2 R2 bes2 c' R2 R2 des'2 a2 R2 R2
 f'2_\markup { \italic "dimin." } R2 ces'2 R2 aes!2 R2 a2\p R2 a2_\markup { \italic "sempre piu p" } R2
 ...
 c''8\ff ees'''[ ees''' ees'''] c''' a''[ a'' a''] fis'' ees''[ ees'' ees''] c'' a'[ a' a'] a4 r R2 <g g'>4 r R2 R2 R2
 R2 e'2\p( f'2) f'2( e'2) R2 R2 R2 R2 e'2( f') f'( e') R2 R2 R2 R2 bes'2( g') g'( f') a'~ a' a'( g')
 f'4( g' \setTextCresc aes'!\< g' f' g') aes'( g' f' g') aes'4( g' f' g')
 ...
 <c'' aes''!>2\sf~ <c'' aes''>2:8 des''2\ff des'' des'' des'' des''4 r4 R2
 R2 R2 r8 <ees'' c'''>8\ff[ <ees'' c'''> <ees'' c'''>] <ees'' c'''>2:8 <ees'' c'''>2:8 <ees'' c'''>2:8 <ees'' c'''>2:8
 <ees'' c'''>4 r4 R2 R2 R2 R2 b'8([ c'' d'' ees''] f''[ g'' aes'' g''] aes''[ g'' aes'' g'']) R2
 ...
 b4\staccato c'\staccato d'( b) R2 R2 b4\staccato c'\staccato d'( b) R2 R2 R2 R2
 f'4\sf( ees') R2 f'4( ees') <g ees' c'' g''>4 r <g d' b' g''> r ees'4( bes' c' g' aes ees') R2
