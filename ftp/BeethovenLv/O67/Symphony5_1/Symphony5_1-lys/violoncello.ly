\version "2.10.3"
 ...
 R2 R2 r8 c8[ c c] f4 r R2 R2 r8 ees8[ ees ees] aes4 r \clef tenor ees'4( f' \setTextCresc ges'\< f' ees' f')
 ...
 R2 \clef tenor c'2\p~ c'2~ c'8 des'8[ des' des'] c'2~ c'2~ c'2~ c'8 des'8[ des' des'] c'2~ c'2~ c'2~ c'2~ c'2~ \setTextCresc
 c'2\<( d'4 ees' f' fis') g'8\!\p[ g' g' f'!] ees'2 d'8[ g' g' f'] ees'2 d'8[ g' g' f']
 \setTextCresc ees'8\<[ ees' ees' d'] c'[ c' c' bes] a[ a a g] fis4\!\p r4
 ...
 \clef tenor f'4( g' \setTextCresc aes'!\< g' f' g') aes'( g' f' g') aes'4( g' f' g') aes'( g' fis' g')
