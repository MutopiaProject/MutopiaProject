\version "2.10.0"
 ...
 \times 2/3 { c8[ ees g] c'[ c c'] ees[ g c'] ees'[ ees ees'] } \clef treble
 \times 2/3 { aes[ c' ees'] aes'[ ees' c'] aes[ c' ees'] aes'[ aes aes'] } \clef bass
 \times 2/3 { f[ aes c'] f'[ f f'] aes[ c' f'] aes'[ aes aes'] } \clef treble
 \times 2/3 { des'[ f' aes'] des''[ aes' f'] des'[ f' aes'] des''[ des' des'']
 ...
 \set tupletSpannerDuration = #(ly:make-moment 1 4)
 \times 2/3 { g,,8[ b,, d,] g,[ b, d] } r4 r2 \clef treble <c' ees' g'>2. r4 R1 r2 r4
 \clef bass \set tupletSpannerDuration = #(ly:make-moment 1 4)
 \times 2/3 { bes,,8[ d, f,] bes,[ d f] } r4 r2 R1 R1 R1 R1 R1 R1 ces4 r r2 R1
 \set tupletSpannerDuration = #(ly:make-moment 1 4)
 \times 2/3 { bes,8[ d' bes] }
 \new Voice {
 ...
 \times 2/3 { f8[ f' bes] aes[ aes' bes] f[ f' bes] aes[ aes' bes]
 ...
 \set tupletSpannerDuration = #(ly:make-moment 1 4) \times 2/3 { aes,,8[ c, f,] aes,[ c f] } g,4\rest
 ...
 \clef bass
 \set tupletSpannerDuration = #(ly:make-moment 1 4)
 \times 2/3 { ges8[ bes des'] ges'[ des' bes] ces[ ees aes] ces'[ aes ees]
 ...
 \new Voice { \stemDown a,,4\sustainDown c,,16\rest a,,( c, ees, ges,4) r16 \slurUp a,( c ees
 ges a c' ees' ges' a c' ees' \clef treble ges' a' c'' ees'' ges'' ees'' c'' a'\sustainUp) }
 ...
 \set tupletSpannerDuration = #(ly:make-moment 1 4) \times 2/3 { r8 bes,,\staccato[ d,\staccato]
 ...
 \set tupletSpannerDuration = #(ly:make-moment 1 4)
 \times 2/3 { ges'8[ aes' bes'] aes'[ ges' f'] ees'[ f' ges'] f'[ ees' des']
 ...
 \clef bass
 \set tupletSpannerDuration = #(ly:make-moment 1 4)
 \times 2/3 { g,8\sustainDown[ b g] b,[ d' g] d[ f' g] b,[ d' g\sustainUp] c\sustainDown[ ees' g] ees[ ees' g] c[ ees' g] ees[ ees' g\sustainUp]
 d\sustainDown[ d' g] f[ f' g] d[ d' g] f[ f' g\sustainUp] ees\sustainDown[ ees' g] c[ c' g] ees[ ees' g] c[ c' g\sustainUp] }
 g,4 r r2 <c c'>4 r r2 <g g'>4 r r2 <c c'>4 r <c, c> r
 \set tupletSpannerDuration = #(ly:make-moment 1 4)
 \times 2/3 { g,8\sf\staccato[ g( fis)] g\staccato[ f\staccato d\staccato] c\sf\staccato[ g( fis)] g\staccato[ ees\staccato c\staccato]
 ...
 \new Voice { \stemDown \set tupletSpannerDuration = #(ly:make-moment 1 4) \times 2/3 { f,,8[ a,, d,] f,8 c,8\rest c,8\rest } c,4\rest }
 ...
 \clef bass \set tupletSpannerDuration = #(ly:make-moment 1 4)
 \times 2/3 { ees8[ g bes] ees'[ bes g] aes,[ c f] aes[ f c] bes,[ ees g] bes[ g ees] b,[ d f] b,[ d g]
 ...
 \clef bass \set tupletSpannerDuration = #(ly:make-moment 1 4)
 \times 2/3 { r8 g,,8\staccato[ b,,]\staccato d,\staccato[ g,\staccato b,\staccato] d\staccato[ g,\staccato b,\staccato]
 d\staccato[ g\staccato b\staccato] d'\staccato[ g\staccato b\staccato] \clef treble d'\staccato[ g'\staccato b'\staccato]
 d''\staccato[ b'\staccato g'\staccato] g''\staccato[ b'\staccato g'\staccato] } <g' b' g''>4\sustainDown r4 r2
 \clef bass r2 e,4\rest c,8\rest \set tupletSpannerDuration = #(ly:make-moment 1 4) \times 2/3 { \slurDown f,16([ e, d,]) } c,4 r r2
 R1 R1 R1 R1 R1 R1 R1 R1 R1 R1 R1 R1 r2^\fermata <g b f'>2^\fermata
 <g bes c' e'>4\p r4 r2 \clef treble bes'16\sustainDown des'' bes' g' e' bes' g' e' des' g' e' des' bes e' des' bes\sustainUp <a c' f'>4 r r2
 b'16\sustainDown d''! b' aes'! f' b' aes' f' d' aes' f' d' aes' f' d' b\sustainUp c'4 r \clef bass <g bes c' e'> r
 \clef treble bes'16\sustainDown des'' bes' g' e' bes' g' e' des' g' e' des' bes e' des' bes\sustainUp a4 r <a c' f'>4 r
 b'16\sustainDown d''! b' aes'! f' b' aes' f' d' aes' f' d' aes' f' d' b\sustainUp
 ...
 r4\sustainDown \clef treble ees'16 c'' g' ees' c' g' ees' c' \clef bass g ees' c' g
 ...
 c'16\staccato\sf \clef treble c'([ d' ees'] f' g' a' b') c''\sf\staccato c''( d'' ees'' f'' g'' a'' b''\sustainUp)
