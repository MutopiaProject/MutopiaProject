...
mutopiatitle = "An Sylvia";
mutopiacomposer = "F. Schubert (1797--1828)";
mutopiapoet="E. von Bauernfeld";
...
verseOne=\lyrics {
	Who2. is4 | Syl __ via, ""2 |
	What2. is4 | she,2 __ ""4 That4 |
	all our swains com- |
	mend2 her?4 " " |
	" "1 |
	Ho2. __ ly,4 |
...
verseTwo=\lyrics {
	...
	beau- ty lives with | kind2 __ ness4 "" | ""1 |
	To2. her4 |eyes2 ""4 doth | Love 2. re4 __ |
	pair,2 ""4 To | help him of his | blind-2 ness;4 "" |
	""1 |
	And2. be-8 ing | help'd2 __ ""4  in4 __ | ha-2. bits4 |
	there,2 ""4 And |
	be-2 ing | help'd in __ | ha2. __ bits4 | there.2 ""2 |
}

verseThree=\lyrics {
	Then2. to4 | Syl-4 via ""2 |
	let2. us4 | sing,2 ""4 That |
	Syl- via is ex __ | cell2 __ ing;4 "" | ""1 |
	She2. ex4 __ | cels2 ""4 each | mor2. __ tal4 |
	thing,2 ""4 Up- | on the dull earth | dwell-2 ing4
	"" | ""1 |
	To2. her4 | gar- lands ""2 | let2. us4 |
	bring,2 "" | To her | gar __ lands | let2. us4 |
	bring.2 "" |
}
...
origVerseTwo=\lyrics {
	Ist2. sie4 | sch\"on2 __ ""4 und4 |  gut2. da-4 | zu?2 ""4
...
origVerseThree=\lyrics {
	Dar2. __  um4 | Sil- via, ""2 | t\"on',2.  o4 |
	Sang,2 ""4
