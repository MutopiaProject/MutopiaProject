...
IMandII = \notes \relative c' {
  ...
  d16 fis a d d, fis a d <fis4 a,> d,16 e fis g |
  ...
  <{cis'8:16_#'(italic "simili") s d: s cis2: | cis: b:} \\ {a4:16 a: a2: | g: d:}>
  %18
  cis16 e d cis b a gis a a e a e gis e gis e |
  ...
  e b e b e b e b e b e b e b e b | <e4 cis a> r r8 fis, e b |
  ...
  e8 cis d b \grace {\noStroke b8} a4 e'16 cis e cis |
  %35
  e cis e cis d a d a cis a cis a cis a cis a |
  cis a cis a d a d a cis a cis a g' a, g' a, |
  fis' a, fis' a, e' a, e' a, <d4 d,> fis8 g | fis e d cis d4 a16 a a a |
  %39 page 6
  b b b b cis cis cis cis <d4 d,> d,16 d d d |
  d d d d cis cis cis cis d4 a'16 a a a |
  b b b b cis cis cis cis <d4 d,> d,16 d d d |
  %42 Note: 2nd half of this bar marked //, copied from mand 1
  b b b b cis cis cis cis d4 <fis'8 a, d,> a16 g |
  fis8 fis, g e d4 d'8 fis16 e | d8 fis, g a d,4 d'8 fis16 e |
  d8 fis, g e <a4 d,> d8 fis16 e | d8 fis, g a d,16 fis a d d, fis a d |
  b8 d cis e <d4 d,> d8 fis |
  %48
  <d8 d,> fis <d d,> fis <d4 d,> r_\fermata \bar "|."
}
