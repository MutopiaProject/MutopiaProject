...
IMand = \notes \relative c'' {
  ...
  \partial 8 a8 |
  %1 page 2
  <d4 fis,> a'16 b a g fis8 d a fis | <fis'4 a, d,> a16 b a g fis8 d a fis |
  %3
  <d'4 fis,> <d fis,> d8 e16 fis e8 fis16 g | 
  ...
  \grace d8 cis8. b16 a8 a d16 e fis g a fis e dis |
  %12
  ...
  <{a''4_#'(italic "Simile") d a b | a d c c | b bes a a | fis g e fis | fis g e fis |
   ...
   {d, d d d | d d d d | d d d d | d d a' a | a a a a | a a a a |
    a a a a | a a a a}> |
  %28
  <fis4 a, d,> a16 g fis e d cis b a g fis e d |
  <fis'4 a, d,> a16 g fis e d cis b a g fis e d |
  <g'4 b, d,> <e cis a> <fis a, d,> r8
  }
  ...
  d b gis b e, gis b d [cis8 \grace b' \times 2/3 {a16 gis a]}
    [a8 \grace b \times 2/3 {a16 gis a]} |
  %41 Note: First 3 graces are slashed twice. Pitches are very unclear.
  a8 b,16. fis'32 \grace fis8 e16. \grace fis8 d32 \grace e8 cis16. b32
    [cis8 \times 2/3 {a'16 gis a]} [a8 \grace b \times 2/3 {a16 gis! a]} |
  %42 Note: same as in 41
  a8 b,16. fis'32 \grace fis8 e16. d32 \grace e8 cis16. b32
  ...
  %46
  \times 4/6 {[e,16_#'(italic "Simile") d' b' b b b]} <{b4 a a | gis gis a a | b b a a}
  ...
  [e_#'(italic "Simili") cis' a' a a a]} <{a4 gis gis} {cis, b b} {e, e e}> |
  [a32 gis fis e d cis b a] [a' gis fis e d cis b a] e4 b'_\trill |
  %57 
  \time 2/4
  a4 r8 <{e' | \time 4/4 e4 e8 e e4 e | e e e} \\ {cis8 |
    b16 cis d cis cis8 a16 cis b cis d b a8. cis16 |
    b16 cis d cis cis8 a16 cis b cis d b}> a,8 a'16 fis |
  %60
  ...
  %65 Note: The graces in bars 65 and 66 are all slashed twice.
  \property Voice.tupletSpannerDuration = #(make-moment 1 8)
  e16 cis d b cis a a' fis e cis d b [a8 \grace b' \times 2/3 {a16 gis fis]} |
  \grace fis8 \times 2/3 {[e16 d cis]} \grace e8 \times 2/3 {[d16 cis b]}
    \grace d8 \times 2/3 {[cis16 b a]} \grace b'8 \times 2/3 {[a16 gis fis]}
    \grace fis8 \times 2/3 {[e16 d cis]} \grace e8 \times 2/3 {[d16 cis b]} [a8. b16] |
  a b a g fis g fis e <d'4 fis,> a'16 b a g |
  fis8 d a fis <d'4 fis,> a'16 b a g |
  fis8 d a fis <d'4 fis,> <d fis,> |
  %70
  ...
  <g'4 b, d,> <e cis \\ a> [d16 cis b a g fis e d] |
  %80
  <g'4 b, d,> <e cis \\ a> <fis a, d,> r^\fermata \bar "|."
  }
}
