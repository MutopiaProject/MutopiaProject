...
IIMand = \notes \relative c'' {
  ...
  [b16 g' fis32 e d c] <{b8 a} \\ {g fis}> <{[b16. \property Voice.stemLeftBeamCount = #2
    \property Voice.stemRightBeamCount = #3 g'32
    \property Voice.stemLeftBeamCount = #3 fis e d c]} \\ g16>
    <{b8 a} \\ {g fis}> |
  %9
  [g8 d'16 d,] [c' d, a'32 b c a] <{[b8 b16 d,]} \\ g8>
    [a'16 d, d'32 c b a] |
  [<g8 b,> d'16 d,] [c' d, a'32 b c a] <{[b8 b16 d,]} \\ g16>
    [a'16 d, d'32 c b a] |
  ...
  %18
  <{g8 d16 d} \\ {s8 b16 b}> <e c> <e c> <fis a,> <fis a,> <g8 b,>
    <d16 b> <d b> <e c> <e c> <fis a,> <fis a,> |
  g a b c d e fis g g, a b c d e fis g | 
  <d8 d,> b <d16 d,> c b a g fis e d c b a g |
  %21
  c8 e d fis' <g4 b, d, g,> r4^\fermata \bar "|."
}
