...
IIIMand = \notes \relative c''' {
  ...
  %23
  <d4.\f fis,> <{g,8 g g} \\ b,4.:8> | <{fis8 fis fis g g g} \\ {a,4.:8 b:}> |
  <{fis8 fis fis g g g} \\ {a,4.:8 b:}> | <{fis8 fis fis e e e} \\ {a,4.:8 cis:}> |
  %27
  ...
  %45
  \grace {\property Voice.Stem \set #'stroke-style = #'() f?8}
    e4. a8 cis e | e cis a e' cis g | fis4. r8 r a | d, fis a c b a |
  %49
  ...
  <g4. b,> <{b8 b b} \\ g4.:8> | <{a8 a a c c c} \\ {fis,4.:8 a:}> |
  <{b8 b b c c c} \\ {g4.:8 a:}> | <{b8 b b a a a} \\ {g4.:8 fis:}> |
  %63
