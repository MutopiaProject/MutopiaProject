...
exercise = "6"
tonality_deutsch = "A moll"
tonality_fr = "La mineur."
meter = { \tempo 4 = 135 }
...
\header {
  ...
  mutopiatitle        =       \markup { "50 Melodische Übungsstücke, No. 6" }

  opus                =       "Op. 840"
  piece               =       \markup { "Etüde" \number \tiny "6" }
  mutopiaopus         =       "Op. 840, No. 6"
