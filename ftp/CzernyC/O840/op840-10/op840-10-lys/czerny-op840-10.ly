...
exercise = "10"
tonality_deutsch = "E moll"
tonality_fr =  \markup { "Mi mineur." }
meter = { \tempo 4 = 121 }
...
\header {
  ...
  mutopiatitle        =       "50 Melodische Übungsstücke, No. 10"

  opus                =       "Op. 840"
  piece               =       \markup { "Etüde" \number \tiny "10" }
  mutopiaopus         =       "Op. 840, No. 10"
 ...
 footer = "Mutopia-2017/04/10-2177"
