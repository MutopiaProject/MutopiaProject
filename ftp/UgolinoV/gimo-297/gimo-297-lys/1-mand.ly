...
IMand = \notes \relative c'' {
  ...
  <d4 fis, d> r |
  %20
  \property Score.skipBars = ##t R2*9 |
  %29
  ...
  <d4 fis, d> <d fis, d> |
  %48
  <d8 fis, d> cis16 b a g fis e | <a4 fis d> <a e cis> | <a fis d> r |
  %51
  d16 e fis g a fis e d | b8 b' a16 g fis e  | <fis4 \\ d> <e \\ cis a> |
  <d fis, d> r |

  %55
  <d4 fis, d> <d fis, d> | <d fis, d> r8 <{fis16 g | a8 a a d | b a} \\
  ...
  %69
  <d'8 fis, d> cis16 b a g fis e | fis8 d r d'16 e | fis8 e16 d cis8 b |
  %72
  \grace {\noStroke b8} ais4 r8 fis |
  %73
  ...
  g,16 d' b d g d b d | g, d' b d g d b d |
   <{\property Voice.Stem \set #'stroke-style = #"grace" b8} \\ {g16 e' c e}> g'16 e c e |
  %99
  ...
  %107
  b,, g'' fis g a,, g'' fis g | <g4 b,> <g b,> | g8 fis16 e d c b a |
  %110
  <b8 d,> a16 g <a8 fis> g16 fis |
  <g4 b,> r8 <{a | b c4 a8 | b c4 a8 | b s} \\
  {fis8 | g a4 fis8 | g a4 fis8 | 
  % Note: Lilypond adds a tuplet bracket by default, which I don't want and hence must remove.
  \property Voice.TupletBracket \set #'bracket-visibility = ##f [g \times 2/3 {c16 b a]}}>
  %112
  g8 fis | g' fis16 e d c b a |
  %116
  g'8 fis16 e d c b a | <b8 \\ {g a16 g}> <a8 fis d> g16 fis |
  %118
  <g4 b,> d' | g16 b a g a8 c, | b16 b' a g a8 c, | [b8 g b d] |
  %122
