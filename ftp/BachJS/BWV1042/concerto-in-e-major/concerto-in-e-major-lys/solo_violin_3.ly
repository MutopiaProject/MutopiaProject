...
solo_violin_3_theme1 = \notes \relative c' { % without a "tutti" at the start
    e16( fis gis )b e8-. | \$solo_violin_3_theme_body
}

solo_violin_3_theme2 = \notes \relative c' { % with a "tutti" at the start
    e16-"Tutti"( fis gis )b e8-. | \$solo_violin_3_theme_body
}
...
solo_violin_3c_lower = \context Staff \notes \relative c' {
    gis'16-"Solo" b( e dis e )b | \stemdown gis8 fis gis |
    a fis gis | a gis a |
    fis s s | e e e |
    a a ais | \stemboth dis16 cis( b cis dis )e |
...
solo_violin_3c_upper = \context Staff \notes \relative c' {
...
solo_violin_3 = \notes {
    ...
    \$solo_violin_3b
    \$solo_violin_3_theme2
    < \$solo_violin_3c_lower \$solo_violin_3c_upper >
    \$solo_violin_3_theme2
    \$solo_violin_3d
    \$solo_violin_3_theme2
    \bar "|.";
