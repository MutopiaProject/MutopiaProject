...
solo_violin_2b_lower = \context Staff \notes \relative c' {
    ...
    \stemdown b4 ~ b16 gis'32( fis gis16 )b \stemboth b( )d cis( d32 )b |
    cis16( )a gis( )fis fis( a32 )fis e16( )d d( fis32 )d cis16-\trill( )bis |
    \stemdown bis4 \stemboth r8 fis' e16.-\trill dis32 cis16( dis32 )bis |
}

solo_violin_2b_upper = \context Staff \notes \relative c' {
    s2. |
...
solo_violin_2 = \notes {
    \$solo_violin_2a
    < \$solo_violin_2b_lower \$solo_violin_2b_upper >
    \$solo_violin_2c
}
