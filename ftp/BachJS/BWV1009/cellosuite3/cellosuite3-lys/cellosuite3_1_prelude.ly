...
prelude = {
    ...
    g b, e,( b, g) b, e,( b, g) f! e d c( g e') g c( g e') g c bes a g a c f,( c a) c f,( c a) g f e d( a f') a d( a f') a d a b c'
    ...
    \new Voice { \stemUp e,16[ \stemDown c'( b a)] } g f e d c g, e, g, <ees, g, g a>4 r r <d, g, f b>4 r r
