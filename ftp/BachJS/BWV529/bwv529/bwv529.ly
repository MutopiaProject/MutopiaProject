...
\book {
   \score {
      <<
         ...
         \context Staff = unten {
            \set Staff.instrument = \markup { \large "Pedal" \hspace #2 }
   ...
   \score {
      <<
         ...
         \context Staff = unten {
            \context Voice = pedalThreeThree \pedalThreeThree
         }
      >>
      \layout{
         indent = 1\cm
   ...
   \score {
      <<
         ...
         \new Staff {
            \set Staff.midiInstrument = "recorder"
            \transpose c c' \leftThree
         }
         \new Staff {
            \set Staff.midiInstrument = "recorder"
            \transpose c e'' \leftThree
         }
         \new Staff {
            \set Staff.midiInstrument = "flute"
            \pedalThreeThree
