...
melone = \notes \relative c'' {
  ...
  % bars 31-33
  \d fis g fis e d fis d cis b f' b, a! |
  \u gis fis! gis a b gis b c \d d gis, d' e |
  f b e, d c e c b a e' a, g! | 

  % bars 34-36
  \u fis!16 e fis g a fis a b c fis, c' d |
  \d ees a ees d c ees c bes \u a c a g |
...
meltwo = \notes \relative c' {
  ...
  g4 \rdwnfour r \rdft g' ~ |
  g16 g e d cis e cis b a e' a, g |

  % bars 22-24
  \sd \u fis4 \su \d r fis' ~ |
  fis8 e16 d cis e cis b a8 b  |
  cis8 a16 b cis8 e a, cis |

  % bars 25-27
  d \sd \u d,16 e fis d fis g a d, a' b  |
  cis a cis \su \d d e a, e' fis g a b g |
  a2. |

  % bars 28-30
  g2. ~ |
  g16 g fis e d fis d cis b4 ~ |
  b8 \rdwntwo r r4 \rdft \rdwnfour r \rdft |

  % bars 31-33
  \sd \u \tu \ruptwo r8 \rdft [fis b cis] d4 ~ |
  d8 b d c! b a |
  gis e a b c4 ~ |
...
melthree = \notes \relative c {
  ...
  \clef F \d cis b ais fis b a |
  g e fis4 \u fis, \d

  % bars 14-17
  b16 fis' b a! g b g fis e b' e, d |
  c g' e d \u c e c b a b c a \d |
  b g' fis e d! fis d cis \u b fis' b, a |
  g d' b a g b g fis e fis g e |

  % bars 18-21
  \d fis8 fis' ais b cis fis,  |
  b4 r8 \u [b, cis d] \d |
  e4 r8 [fis e d] |
  \u cis4 r8 [a b cis] \d |
  ...
  \u a e' cis b a cis a g fis cis' fis, e |

  % bars 25-27
  d8 r \rdwntwo r4 \rdft \rdwnfour r \rdft |
  \Rdwntwo R2. \Rdft |
  r8 [a'8 d e] \d fis4 ~ |

  % bars 28-30
  fis8 e g fis e d  |
  \u cis fis, b cis \d d4 ~ |
  \u d8 cis e d cis b \d |

  % bars 31-33
  ais4 b \rdwntwo r8 \rdft d |
  e d f e d c |
  b gis a4 \rdwnfour r8 \rdft c |
