...
sopran = {
   \new Voice \relative a' {
      ...
      a1~ a4 gis
      a2 r8 a d cis d2~ \break
      %% Takt 65 ==================================================
      d8 cis fis e \once\override Tie #'control-points = #'( ( 1.2 . 2.7 ) ( 4 . 5.2 ) ( 19 . 5.2 ) ( 23 . 2.6 ) ) fis1~
      fis4 s s1
      a1.
      r8 g, a e fis2~ fis
      ...
      %% Takt 115 =================================================
      \once\override Tie #'control-points = #'( ( 1.1 . 1.6 ) ( 6.1 . 3.5 ) ( 27.2 . 3.5 ) ( 31.2 . 1.6 ) ) d1.~
      \once\override Tie #'control-points = #'( ( 1.1 . 1.6 ) ( 6.1 . 4 ) ( 27 . 4 ) ( 30.7 . 1.5 ) ) d1.~
