...
allemande =  \relative f' {
	...
	\repeat volta 2 {
		...
		<<{gis 32 [( a b a gis fis e fis 64 d )]} \\ {e,16 s s8} \\ {d'16 s s8}>> cis16. \trill [( b32 a gis a cis)] 
		    <<{fis16. [( e32 d cis d fis)]} \\ {d,16 s s8} \\ {cis'16 s s8}>> b'32 [(gis a fis e cis d b)] \clef bass | % 6
		a32 [( fis gis b e16.) d,32] cis16. [ e'32 ( d cis b a)] d,32 [ fis' ( e d cis gis a d)] <<{b8. [a16]} \\ {e4}>> | % 7
		<<{a16 s s8} \\ {a16. [( b32 cis d e g)]}>> fis32 [( e d cis d b a' gis)] a16. [( e32 cis16 b32 a)] a,8.   \clef bass  % 8 	
	}
	\repeat volta 2 {
		e''16 | %0
		...
		a,8 [ gis16. \clef tenor fis''32] ( fis32 [ eis gis fis a gis b d,)] 
		    eis,16. [ cis'32 ( b' a b gis)] <<{a16. [ gis32 ( fis e d e64 cis)]} \\ {fis,16. s32 s8} \\ {cis'16. s32 s8}>> \clef bass | % 12
		...
		a32[ \clef tenor  fis'' (gis a) b, (a' gis b)] <<{fis8 [ eis16. fis32]} \\ {cis8 s}>> fis16. [(cis32 fis gis a gis)] a32 [( b c a dis, e dis e)] | % 14
		...
		\clef bass d16 [b,32 (cis d e fis d)] gis32 [( b e, fis gis a b cis)] d32 [( cis b cis d b cis a)] \clef tenor a'16. [g,32 ( a g fis g)] | % 16
