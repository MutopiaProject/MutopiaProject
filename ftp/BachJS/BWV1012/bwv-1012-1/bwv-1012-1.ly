prelude =  \relative d {
    ...
    cis8 [ e, (gis) ] a [ (cis d) ] e [ a, (cis) ] \clef tenor e [ (fis gis) ] | % 9
    ...
    g,8 [ (b e) ] b' [ (cis d) ] cis [ (ais b) ] \clef tenor eis [ (ais, b) ] | % 43
    ...
    gis8 [ (e fis) ] gis [  ( \clef tenor b cis) ] d [ (e fis) ] gis [ (a b) ] | % 67
    ...
    g8 [ (a cis) ] \clef tenor e [ (g a) ] cis4. ~ cis16 [b a (g fis e) ] | % 83
    ...
    f'16 [ (e d e f) d ] gis, [ d' (e f e d) ] b' [ d, (e f e d) ] d' [ d, (e f e d) ] \clef tenor | % 89
    <<{s8 a'8 s4 a8 s4 a8 s4 a8 s8} 
        \\ {a8[^( s) a] a[^( s) cis] a[^( s) e'] a,[^( s) a']}>>  | % 90
    <<{s8 a,8 s4 a8 s4 a8 s4 a8 s8} 
        \\ {a8[^( s) a] a[^( s) cis] a[^( s) e'] a,[^( s) a']}>> \clef bass | % 91
