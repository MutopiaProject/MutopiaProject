...
bourreeI = \relative c' {
	...
	% 11
	d bes g bes ees, c' f, a | bes4 f bes, \bar ":|:" bes16(c d ees |
	...
	ees4) ees,16(f g aes bes4) c | des16( c bes8 c4) bes16(aes bes aes g4) |
	aes16( g f8 g4) f16(ees f ees d4) |
	% 44
	ees8 bes g bes ees,4 bes'16(c d ees |
	f4) d16(ees f g aes4) bes,16(c d ees | f4) d16(ees f g aes4) g8 f |
	g bes ees g, f ees bes d' | <<<ees g,>2. \\ <bes, ees,>4>>
	\bar ":|"
}
