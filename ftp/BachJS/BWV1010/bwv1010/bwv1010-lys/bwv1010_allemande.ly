...
allemande = \relative c'' {
	...
	g[( f ees g]) f[ees d f] <ees bes ees,>4 ees16( f d ees) |
	% 7
	f16[(ees d) c] bes[ c d ees] f[(g) aes f] g[(f ees f)] |
	...
	ees8 c'' g, b' <c ees, g, c,>4~c8 c16(d) |
	% 23
	ees16[(d) ees d] c[(bes!) c bes] a[(bes) a bes] c[(d c d)] |
	ees[(d ees d] c[ bes a g)] fis[( g a c]) d8[c,] |
	% 25
	...
	g![( f) ees f] bes,8[d'] <ees g, bes, ees,>4 r8
	\bar ":|"
}
