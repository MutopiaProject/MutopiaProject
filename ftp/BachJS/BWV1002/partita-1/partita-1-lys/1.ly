...
iA =  {
  ...
  % 8
   cis''8.[  fis'32  gis'32] \stemNeutral \tuplet 3/2
  { ais'16[(  b'   cis'')]  d''[(  e''   fis'')]
   g''[(  fis''   e'')]  ais''[(  b''   cis''')]}
   fis''16.[  b'32  ais'!16. e''32]  |
  % 9
  \tuplet 3/2 { b16[(  e'16   g'16)]   ais'16[(  cis''16   e''16)]
  ...
  \tuplet 3/2 { b''16[(  cis'''16   ais''16)]   b''16[(  d'''16   cis'''16)]}  |
  % 11
  ...
  \stemUp
   ...
   gis''!8.[  fis''16]  |
  % 12, prima volta
   fis''8.[  e''32  d''32] \stemNeutral  \tuplet 3/2
    { e''16[(  d''  cis'')]   d''[( b'   eis')]   fis'[(  ais'   cis'')}
    fis''8] ~  fis''16.[ e'32  d'16.  cis'32]
  % 12, seconda volta
  \stemUp  fis''8.[  e''32  d''32]  \stemNeutral \tuplet 3/2
    { e''16[(  d''  cis'')]   d''[( b'   eis')]   fis'[(  ais'   cis'')}
    fis''8] ~  fis''8.[ cis''16]
  ...
  \stemUp
   ...
   ais'16.[  fis'32 e'16.\trill  d'64  e'64] \tuplet 3/2
  { d'16[(  fis'   b')]   d'[(  cis'  b)]}  ais16.[ cis''32 fis'16. e'32] |
  % 14
   d'16.[  b64(  cis'64   d'16.)  e'32]  \tuplet 3/2
  { fis'16[(  g'   a')]  b'[(  c''   a')]} \stemUp
   dis'8.[  fis'16] \stemNeutral  b'16.[  b'32 cis''16.  dis''32]  |
  % 15
  \stemUp
   e''16.[  g''64  fis''64  g''16.  b'32] \stemNeutral \tuplet 3/2
  ...
  % 19
   e'8.[  fis'16] \stemNeutral  \tuplet 3/2 { g'16[( a'  b')]  cis''[( d''  e'')]}
   cis'!16.[  e'32  a'16.  g'32]
   fis'16.[  a''32 e'16.  g''32]  |
  % 20
  \tuplet 3/2 { d'16[(  a'   g'')]   fis''[(  e''   ais'')]  b''[( fis''  e'')]
   d''[(  cis''   e'')]   ais'[( g'  fis')]  e'[( ais'  g'')] }
   fis''16.[ d'32 cis'16. e''32] |
  % 21
   b16[ ~ b64  e''64  d''64  cis''64  d''16.  e''32]
  \tuplet 3/2 { fis''16[  e''(  fis'']   g''[  a''!   b'')]}
  \stemUp  c''16.[  a''64(  g''64] \stemNeutral \tuplet 3/2
  { fis''16[  e''   d'')]  c''[( b'  c'')]}   a''16.[  c''32]  |
  % 22
  \tuplet 3/2 { dis'16[(  fis'   b')]   dis''[(  fis''   a'')]
   c'''[(  b''   a'')]   g''[(  a''   fis'')]} \stemUp
   g''16.[  fis''32  e''16.  d''32] \stemNeutral \tuplet 3/2
  { c''16[(  e''   d'')]  c''[(  ais'   b')]}  |
  % 23
  \tuplet 3/2 { ais'[(  cis''   g'')]   fis''[(  ais'   e')]}
   d'16.[  b''64  a''64  g''16.  fis''32]
  \tuplet 3/2 { eis''16[(  fis''  gis'')]} \stemUp  fis''16.[  b'32]
   d''8[(   cis''32)\trill  b'32  cis''16]  |
  % 24, prima volta
  \stemUp  b'8.[  d''32 cis''32] \stemNeutral \tuplet 3/2
    { d''16[(  b'   d'')]   fis''[(  b''  ais'')]}
...
iB =  {
  ...
  % 7
   gis'16.[  b'32  e''16.  d'32] \tuplet 3/2
