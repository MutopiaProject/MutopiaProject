...
courante = \context Staff \relative c'' {
	...
	% 4
	    ...
	    b(a b) g b( a b) g c,( b' a g) | fis a( d) d,( g8[) b,] d,[fis'] |
	% 8
	...
	% 15
	    ...
	    a( g) b( a g fis e d) a8 cis | d,2 r8 } \break \repeat volta 2 { a''8 |
	% 19
	    a fis d[e16(fis] g fis e d) | d'8 fis, c[b16(c] d c b a) |
	...
	% 39
	    ...
	    b( a b) g c, b'( a g) d8 fis | <g g,>2 r8
	}
}
