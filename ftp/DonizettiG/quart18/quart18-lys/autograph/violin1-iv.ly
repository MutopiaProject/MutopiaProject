violinIFourthMov = \notes \relative b'' {
    ...
    | [a8-. b,-.] \grace gis'( [)a-. b,-.] \grace gis'( [)a-. b,-.]
...
% 10
    ...
    | [bes8 c,] \grace a'( [)bes c,] \grace a'( [)bes c,]
    | [a'-. a->] ~ [a16. bes32 a16. gis32] [a16. f32 d16. f32]
    | [e8 a,] \grace dis( [)e a,] \grace dis( [)e a,]
    | [e'-. e->] ~ [e16. f32 e16. dis32] [e16. gis!32 a16. b32]

% 20
    | \repeat unfold 3 { \grace b8( [)c a] }
...
% 80
    ...
    | [)bes8 c,] \grace a'( [)bes8 c,] \grace a'( [)bes8 c,]
...
% 160
    | \repeat "percent" 2 { b4 ~ [b16( )ais ais( )b] [b( )ais ais( )b] }
      \property Score.currentBarNumber = #162
...
% 200
    ...
    | [d8 gis,] \grace cis( [)d gis,] \grace cis( [)d gis,]
    | \repeat unfold 3
