...
% 70
      % [R] In the autograph the first Cis is a quarter note. We
      %     fake the score by using two voices here.
    | <  { \oneVoice \blankNotes cis,8 \visibleNotes r32 [cis'( bis )cis] } 
      \\ { \oneVoice cis,4 } >
      [cis,8 ~ cis32 cis'( b )cis]
...
% 80
    ...
    | [g,16( b!32 )d] g8 [g,16( c32 )es] g8 % [R] In the autograph, g4

% 90
    | \repeat unfold 2 { [g,16 g'32 fis g16 g] }
    | g,8 r r4
      % [R] There is a mistake here!
    | \cadenzaOn [d'32( cis d )e] [d16 d] g,4 s2 \cadenzaOff \bar "|"
      \property Score.currentBarNumber = #93
    | \repeat "percent" 2 { [c8( e! )g] r }
...
% 110
    ...
    | c8 r r4
    | r f4
    | \repeat "percent" 2 { \repeat unfold 2 { [c32( b c )d] [c16-. c-.] } }
