...
violinIFourthMov =  \relative b'' {
    ...
    |  a8[-. b,-.] \acciaccatura gis' a[-. b,-.] \acciaccatura gis' a[-. b,-.]
...
% 10
    ...
    |  bes8[ c,] \acciaccatura a' bes[ c,] \acciaccatura a' bes[ c,]
    |  a'[-. a->] ~  a16.[ bes32 a16. gis32]  a16.[ f32 d16. f32]
    |  e8[ a,] \acciaccatura dis e[ a,] \acciaccatura dis e[ a,]
    |  e'[-. e->] ~  e16.[ f32 e16. dis32]  e16.[ gis!32 a16. b32]

% 20
    | \repeat unfold 3 { \acciaccatura b8 c[ a] }
    |  e[-. e] ~  e16.[ fis!32 e16. dis!32]  e16.[ g32 fis16. e32]
    |  b'8.[ b16] <b, b' >2-> ~
    | <b b'>8.[ <b b'>16-\cresc]  b'16.[ b32 b16. b32] b16.[ b32 b16. b32]
    |  b8[-.\f b->\p] ~  b16.[ cis32 b16. ais32]  b16.[ gis32 a16. b32]
    |  a8[ b,] \acciaccatura gis' a[ b,] \acciaccatura gis' a[ b,]
    |  gis'[ gis->] ~  gis16.[ a32 gis16. fisis32]  gis16.[ e32 cis16. e32]
    |  dis8[ gis,]  dis'[ gis,]  dis'[ gis,]
...
\tag #'edited {
       gis16.[ e!32 % [E] Added a natural
}
       fis16. gis32]  fis16.[ dis32 eis16. fis32]
    |  e16.[ fis32 dis16. e32]  cis16.[ dis32 b16. cis32] 
       ais16.[ b32 gis16. eis32]
\tag #'autograph {
    |  fis16.[ b,32 cis16. dis32]  e16.[ fis32 gis16. ais32] b4 % [R] A ~ ?
}
\tag #'edited {
...
% 80
    ...
    |   bes8)[ c,] \acciaccatura a' bes8[ c,] \acciaccatura a' bes8[ c,]
...
% 129
\tag #'autograph {
    | \repeat unfold 3 { r2. } % [R] Better: R2.*3
}
\tag #'edited {
    | R2.*3 % [E]
}
    ...
    |  e8[ a,] \acciaccatura dis e[ a,] \acciaccatura dis e[ a,]
    |  e'[ e] ~  e16.[ f32 e16. dis32]  e16.[ gis!32 a16. b32]
    | \repeat unfold 3 { \acciaccatura d8 c[ a] }
    |  e[ e] ~  e16.[ fis!32 e16. dis32]  e16.[ g32 fis16. e32]
    | b'4 r  c8.[(  c16)]
...
% 140
    ...
    | b8 r r4  a8.[(  a16)]
\tag #'autograph {
    | gis4..(-> s8 s32 % [R] The number of beats is wrong!
       gis32[ a!16.  a32)]
}
\tag #'edited {
    | gis2(-> ~ % [E]
       gis16.[ gis32 a!16.  a32)]
}
...
% 160
\tag #'autograph {
    | \repeat "percent" 2 { b4 ~  b16[(  ais) ais(  b)]  b[(  ais) ais(  b)] }
}
\tag #'edited {
...
\tag #'autograph {
    | \cadenzaOn % [R] To match the mistake of the viola
       cis[(  b) dis(  cis)]  cis[(  b) b(  a)]  a[(  gis) gis(  fis)] s8
      \bar "|"
      \cadenzaOff
}
\tag #'edited {
    |  cis'16[(  b) dis(  cis)]  cis[(  b) b(  a)]  a[(  gis) gis(  fis)]
}
...
\tag #'autograph {
    |  cis16.[ dis32 cis16. bis32]  cis16.[ ais32 % [R] a32 ?
}
\tag #'edited {
...
% 200
    ...
    |  d8[ gis,] \acciaccatura cis d[ gis,] \acciaccatura cis d[ gis,]
    | \repeat unfold 3
...
\tag #'autograph {
    | \repeat unfold 2
          {  e16.[ cis'32 b16. ais32]  e16.[ % [R] Strange! Perhaps b16.
             cis'32 b16. ais32]  b16.[ a32 gis16. fis32] }
    | \repeat unfold 6 {  dis16.[ % [R] e16. ?
                          b'32 a16. fis32] }
}
\tag #'edited {
    | \repeat unfold 2
