...
% 10
	| e ~ \times 2/3 { [e8 dis-. e-.] [fis-. g-. a-.] }
	| \times 2/3 { [b-. cis-. dis-.] [e-. fis-. g-.] } \tupletNum
          a-.-\p r g-. r
	...
	| b'' r \times 2/3 { \lowerDynamics [ dis,,-\p dis dis]
                             [dis dis dis] [dis dis dis] } \tupletNum
        | <e2-\f e'-> > <e e'-> >
...
% 90
	...
	| a1-\trill
	| a1-\trill
	| g2->-\f e,4.(-> )fis8 % [E] To match bar 106 and 109 (Violin II)
	| g2.-> [a8.(-\p )b16]
	| c8 r c r c r c r
...
% 120
    ...
    | f-\f r \times 2/3 { [f,8-\p f f] [f f f] [f f f] }
...
% 210
    ...
    | b4(-- b-- b-- )b--
    | \repeat unfold 2 { <b2 b'-> > dis4..-\trill \( [cis32( \) )dis] }
...
% 240
    | a8 r a r a r a r
    | gis2 < { \raiseSlur cis4..( \blankNotes [bis32 )cis] \visibleNotes }
             \context Voice=x { s4.. [bis32( )cis] } >
    | fis,2-\cresc < { \raiseSlur b4..( \blankNotes [ais32 )b] \visibleNotes }
                       \context Voice=x { s4.. [ais32( )b] } >
    ...
    | \times 2/3 { [e8-\cresc e e] [g g g] [c c c] [e e e] } \noTupletNum
