...
\header {
  ...
  mutopiacomposer = "Georg Muffat (1653-1704)"
  mutopiaopus = " "
...
upOne = \context Voice=one \notes \relative c' {
  ...
  d1-\fermata |						   %10
  \stemDown r16^"Allegro" [a' b cis] [d e f cis] [d a bes a] \stemUp [g a cis, e] |
  ...
  g2 r8 [g a bes] |					   %25
  fis2 g~ |
  [g8. g16 f8-\prall e~] \stemDown \tieDown [e8. e16 d8-\prall c] |
  d4 f e2 |
  e1~ |
  e2 f |						   %30
  e1 |
...
upTwo = \context Voice=two \notes \relative c' {
  ...
  a2 g~ |						   %50
  [g8. g16 f8.-\prall e16] \translator Staff = bass \stemUp a,2 |
  \translator Staff = treble \stemDown e' d |
  d cis~ |
  ...
  a1~ |							   %65
  a2. g4 |
  \translator Staff = bass \stemUp fis2 \translator Staff = treble \stemDown d'~ |
  d d4. cis8 |
  <d1 fis> |
}

downOne = \context Voice=three \notes \relative c' {
  \clef bass
  \stemUp
  \tieUp
  \slurUp
  ...
  d |
  d2 d4 c |
  bes2 r16 \stemUp \tieUp [b a b] [b8.-\prall b16] |	   %15
  b4 b'~ b2 |
  a1 |
  ...
  f2 r32 [d e f] g8 r32 [a g f] e8 |			   %35
  ...
  d e4 a~ |
  a2 a |
  \translator Staff = treble \stemDown \tieDown c d~ |	   %55
  d f |
  g1 |
  g2~ g |
  s2 s4 [g8 f] |
  \translator Staff = bass \stemUp \tieUp c2~ c4. bes8 |   %60
  a2 a |
  bes e,4 [f8 g] |
  [a b] cis2 r4 |
  s1 |
...
downTwo = \context Voice=four \notes \relative c {
  ...
  d2.-\mordent e4 |
  f [e8-\prall d] \stemUp \tieUp bes'2 |
  a2. g4 ~|
  g fis b cis |
  ...
  s |
  s |
  \stemDown \tieDown d2~ [d8. d16 c8-\prall b] |
  [c8. c16 b8 a] e'2~ |
  e d |							   %30
  e1 |
  s |
  s |
  \clef treble s |
  r32 [a bes c d16 c] [bes a d c] bes8 r32 [g a bes] c8 r32 [d c bes] |	%35
  ...
  g,1 |
  r32 \stemUp [g, a bes c d e f] [g16 a g bes] e,2 |
  f2. [bes8 a] |
  g4 f g r |						   %60
  s1 |
  s |
