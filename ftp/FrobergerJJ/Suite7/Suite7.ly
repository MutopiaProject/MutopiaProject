...
\header { % {{{
   ...
   composer = \markup{\smallCaps "Johann Jakob Froberger (1616 -- 1667)"}
   % Mutopia Stuff
   date = "1656"
...
% Note:
% The barNumberChecks track the original score breaks
...
sop =  \relative do'' { % {{{
  ...
  re8 mi do4 si16 si[_( do re)] mi8 fad |
  \barNumberCheck #5
  sol4. la8 si2 ~ |
  si4 la sol2 |
  ...
  \barNumberCheck #17
  <<
    { <si sol>4~ si16 si[_( la sol)] la4~ la8 la~ |
      la si16 do sold8. sold16 la4. sol8}
    \\
    { \voiceThree \shiftOnn s4 s2 re'4 |
      \stemDown <si, la'>4 s2.}
  >>
  fad'2 ~ fad16 fad mi8 fa4 ~ |
  fa8. fa16 mi4 re ~ re |
  \barNumberCheck #21
  mi2 fad4 sol |
...
alt =  \relative do' { % {{{
  ...
  \barNumberCheck #27
  \Down dod8 s8 r16 re8. re8 ~ re32[ si^( do re)] s4 |
...
ten =  \relative do { % {{{
  ...
  \barNumberCheck #24
  \gomd \Down r16 re mi fa sol4 ~ sol16 sol fa mi fa8. re16 |
  mi4 ~ mi8 mi ~ mi mi re mi16 si |
  do4 ~ do do ~ do16 si8. |
  \barNumberCheck #27
  \gomg \Up la8 s8 s4 s r8 si |
...
\score { % {{{
  ...
  >>
  \header {
    piece = \markup{\smallCaps "allemande"}
  }
  \layout { }
  \midi { \tempo 4 = 60 }
} % }}}
...
sop = \relative do' { % {{{
  ...
  \barNumberCheck #5
  fad4 ~ fad8 re16 sol mi8 fad16 sol la8 ~ la32[_( sol fad mi]) |
...
\score { % {{{
  ...
  >>
  \header {
    piece = \markup{\smallCaps "courante"}
  }
  \layout { }
  \midi { \tempo 4 = 80 }
} %}}}
...
alt =  \relative do'' { % {{{
  ...
  mi2 mi2. mi4 |
  r red s1 |
  \once\shiftOn si2 \once\shiftOn si1 |
  s2 do1 |
  \barNumberCheck #21
  si2 s1 |
...
ten =  \relative do { % {{{
  ...
  si2 dod2. dod4 |
  red2 mi ~ \stemUp mi8[_( re do si)] |
  s2 la'1 |
  sol2 <fad la>1 |
  mi1. |
  mi1. |
  \stemNeutral si2 dod2. dod4 |
  red2 mi ~ \stemUp mi8[( re do si)] |
  s2 la'1 |
  sol2 <fad la>1 |
  mi1. |
} % }}}
...
\score { % {{{
  ...
  >> >>
  \header {
    piece = \markup{\smallCaps "sarabande"}
  }
  \layout { }
  \midi { \tempo 4 = 88 }
} %}}}
