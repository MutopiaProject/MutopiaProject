\header {
  ...
  mutopiacomposer = "Mauro Giuliani (1781- 1829)"
  mutopiaopus = "O 127"
  ...
  meter		= "Maestoso"
  subtitle = 	"1. Maestoso"
  source =	"Tecla facsimile of 1827 Ricordi (Milano) edition"
...
\score {
   \notes {
    ...
    %6
      a4. d8 cis e fis g |
      fis4 a4.() g8 b,8. e16 |
      e4 d2 cis4^\trill \bar "" \grace {[b16 cis]} \bar "|"
      d4-\f r8 d^\turn e fis g gis |
      b4() a8. fis16-. a4() g8. e16-.|
    %11
      g4() fis8 d^\turn e fis g \modernAccidentals gis|
      a16() g fis-. g-. a() b \noResetKey cis-. d-. d() cis b-. a-. a() g fis-. e-.|
      d4 d' d,,8 r8 e'8.-\mf d16|
      c4 \modernAccidentals d8. c16 b4 c8.b16|
      a2 r8 a^\turn d c|
    %16
      b() c cis-. d-. dis fis16( e d c b )a |
      g2() fis8 r8 g'8.-\mf a16|
      b4. b8 ais b \grace {d} c8. b16|
      b2 \times 2/3 {r8 a b} \times 2/3 {c e, a}|
      a() g fis-. g-.  b() a d-. c-.|
    %21
      ais2() b8 r \defaultAccidentals g,8. a16|
      ais8() b \grace {d} c b \stemDown b ais16-. b-. \stemBoth \modernAccidentals \noResetKey cis-. dis-. e-. fis-.|
      g2 fis16() g c-. \modernAccidentals b-. a-. g-. fis-. e-.|
      e() d c-. b-. d() c b-. a-. \stemDown c() b a-. g-. \stemBoth b() a g-. fis-.|
    ...
    %26
      ...
      \defaultAccidentals d8 fis4-.-\sf e16 d cis8 e4-.-\sf d16 cis|
      b4 r r8 fis'16() g fis8 d'|
    %31
      \modernAccidentals cis8. ais16() b4 r8 fis16() g fis8 d'|
      cis8.-\sf ais16\>\! b4 r8 b16() cis d8 cis16() b16|
      a8 cis4-\sf b16 a gis8 b4-\sf a16 gis|
      fis4 r r8 a,8-\mf a a|
      \stemDown [a16. b32-. \stemBoth cis16. d32] e4 r8 a,8 a a|
    %36
    ...
    %41
      ...
      g8 d'16( cis e d b )g \stemDown fis8 c'16( b d c a )fis \stemBoth|
    %46
      g4 r r d'8.-\mf d16|
      d4 d8. d16 d8 cis16-. d-. e-. fis-. g-. a-.|
      b2() g8 r d8. d16|
    ...
    %51
      ...
      c4() a' r8 e8(\>) d \!c-.|
    %56
      c() b a-. b-. \stemDown d() c e,-. a-. \stemBoth|
      a4 g2 b16( a gis) a|
      ais4 b r8 e^\turn fis gis|
      \grace {b} a16( gis a )b c4 r8 d,^\turn e fis|
