...
IMandII = \notes \relative c'' {
  ...
  fis8 \times 2/3 {[g'16 fis e]} \times 4/6 {fis e d e d cis}
    d8 <a16 d,> <a d,> b b cis cis |
  <d8 d,> \times 2/3 {[b'16 a g]} \times 4/6 {a g fis g fis e}
    fis8 \times 2/3 {fis,16 fis a} \times 4/6 {fis fis a fis fis a} |
  <fis8 a,> <fis16. a,> <fis32 a,> <fis16. a,> <fis32 a,>
    <fis16. a,> <fis32 a,> <fis4. a,>
  }

  \repeat "volta" 2 {
  <fis'8 a,> |
  %17
  <fis8 a, d,> g16. fis32 e8 d cis d r gis, |
  a cis16 d \times 4/6 {e d cis g' fis e} \times 2/3 {d a g} fis8 r <a' a,> |
  <a a, d,> b16. a32 <g8 a,> <fis a,> <e a,> d r d |
  ...
  <b8 d, g,> c16. b32 <a8 fis> g fis g r <g cis,> |
  %27 page 3
  ...
  <{a8 a a a} \\ {fis fis fis fis}> g8 a64 b c16. b16 a g fis |
  g8 b, c d g, g' a b |
  c \times 2/3 {e16 d c} \times 4/6 {b a g a g fis} g8 \times 2/3 {b,16 b d}
    \times 4/6 {b b d b b d} |
  b8 <d16. b> <d32 b> <d16. b> <d32 b> <d16. b> <d32 b>
    <b'4 g g,> r4^\fermata \bar "|."
  }
}
