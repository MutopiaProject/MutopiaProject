...
IIMandI = \notes \relative c'' {
  ...
  \repeat "volta" 2 {
  %1 page 4
  <a2 e cis> b8.^\trill a32( )b |
  <cis2 e, a,> d8.^\trill cis32( )d |
  e4 a8-.( gis-. fis-. )e-. |
  \grace e8 d2 cis4 |
  <{\times 2/3 {b8 cis d} d2} \\ e,2.> |
  <{\times 2/3 {cis8 d e} e2} \\ e,2.> |
  %7
  a8-. gis-. fis-. e-. d-. cis-. |
  <{e4. d16( )cis b8 r} \\ e,2> | 
  <{e4 e e} \\ {e e e}>
  ...
  <a,2. \\ a> |
  gis4( b )e |
  cis8( )fis \grace e dis2^\trill |
  <{e4 gis8( )a b b} \\ b,4> |
  <{b4( )a8 fis16 gis a8 a} \\ {b,4. ~ b}> |
  <{a4( )gis8 gis16 a b8 b} \\ {b,4. ~ b}> |
  ...
  \repeat "volta" 2 {
  %23
  <e'2 b e,> fis8.^\trill e32()fis |
  %24 page 5  
  <gis2 b, e,> a8.^\trill gis32( )a |
  b4 a8 gis fis e |
  ...
  %38
  fis8( )eis fis( d cis )b |
  cis32 b a8. b2^\trill |
  a4. <{cis16 d e8 e} \\ e,4> |
  <{e4( )d8 b16( cis d8 )d} \\ e,2.> |
  d4 cis8 a'16( )gis a8-.( )a-. |
  fis d cis b a gis |
  a4. <{cis16( )d e8 e} \\ e,4.> |
  <{e4( )d8 b16( cis d8 )d} \\ e,2.> |
  <{d4 cis8} \\ e,4.> a'16 gis a8-.( )a-. |
  fis d cis b a gis |
  %48
  a4 a,2
  }
