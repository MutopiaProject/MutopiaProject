...
%\property Score.BarNumber \set #'extra-offset = #'(0 . 1)
  ...
  <{a16( )e e4 a8 gis16( )fis fis4 a8} \\ {a,2 a}> |
  %4 Note: cis4( )d8 was cis4 d8 in [17]
  <{b,8 cis4( )d8 d8.( )bis16 cis8 r} \\ {fis,2 fis4 s8 r}> |
  <{ais'16( )e e4 ais8 ais16( )fis fis4 ais8} \\ {a,2 a}> |
  <{b,8( )cis4 d8 cis32( )b a8. r8 a'} \\ e,2> |
  %7
  a16 gis fis e d cis b a <e'4. b \\ gis!> gis!16( )b |
  ...
  <{cis8. dis32 e dis8( )cis cis8. cisis16 dis!8 r} \\ {fis,2 fis4. r8}> |
  %11
  ...
  <e4 cis> fis8.^\trill gis32( )a \times 4/6 {gis16 fis e a gis fis} fis4^\trill |
  e8 b'16( )gis a fis b, a' gis e b gis' fis e dis fis |
  e b b' gis a fis b, a' gis e b gis' fis e dis fis |
  e8 <{b16. b32 b8 b} {e,16. e32 e8 e}> <e4 b e,> <r8 \\ r> r16
  }
  ...
  %24 page 3
  <{fis,8 gis!4( )a8} \\ d,2> gis32 fis e8. r8 b'' |
  ...
  <{eis4( )fis8 [a]} \\ {a,4. r8}> dis,4( )eis8 [a] |
  ...
  <{b8( )cis4 d8 cis( )e4 cis8} \\ {e,2 e}> |
  <{b8 c4 d8} \\ {e,4}> cis8 b r4 |
  <fis'8. a, d,> gis16 a8 a a8.( gis32 )fis e8 d |
  \times 4/6 {cis16 b a d cis b} b4^\trill a8 a, r4 |
  %41 Note: the trill is not present in [16]
  <fis''8. a, d,> gis16 a8 a a8.^\trill gis32 fis e8 d |
  ...
  a,8 <e a,> <e a,> <e a,> <a4 e a,> r4^\fermata \bar "|."
  }
}
