...
IMandII = \notes \relative c' {
  ...
  gis8 <{e16. e32 e8 e e4} {gis,16. gis32 gis8 gis gis4}> r8 s16
  }
  ...
  <{eis4( )fis8 a8} \\ {a,4. r8}> dis,4 eis8 a8 |
  \times 4/6 {fis16 e d cis d b} b4^\trill a8 a, r4 |
  gis'8 a4( )b8 a( )cis4 a8 |
  gis8 a4( )b8 a cis4( )a8 |
  gis8 a4( )b8 a gis r4 |
  <d'8. fis, a,> e16 fis8 fis fis8.^\trill e32( )d cis8 b |
  a fis d e d a r4 |
  <d'8. fis, a,> e16 fis8 fis fis8.^\trill e32 d cis8 b |
  a fis d e a fis d e |
  [a, d] [e e] <a e a,> <a e a,> <a e a,> <a e a,> |
  %44
  a16-. cis-. e-. a-. a,-. cis-. e-. a-. <a,4 e a,> r4^\fermata \bar "|."
  }
}
