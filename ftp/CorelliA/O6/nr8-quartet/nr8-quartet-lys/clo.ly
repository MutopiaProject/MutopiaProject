...
cloIb = \notes {
    \time 4/4
    \relative g, {
        g4\p-"espress." g'2 fs4 | g bf ef,2 | d ef4 e |
...
cloIIa = \notes {
    ...
    \relative g {
        ...
        ef\cr( )c d f, bf( )c d bf | c( )d ef c a( )f bf d, |
        ef\rc f g ef f\f f g d | ef( )f g d ef( )c f f, |
        bf d'\mf\cr bf g c( )a d d, | g( )a bf g ef( )c f f, |
        bf\rc\f c d e f g a fs | g a bf c d d, f! d |
...
cloIIIan = \notes {
    \relative ef {
        ...
        ef16\cr( )f g( )ef af( )bf c( )af
            bf8\rc-"allarg."( )ef, bf'\decr bf,\rced |
    }
}
...
cloIIIb = \notes {
    \relative ef {
        ...
        e-. e-. e-. e-. f!-. f-. f-. f-. |
        d-. d-. d-. d-. ef!-. ef-. ef-. ef-. |
        \cresc g,-. g-. g-. g-. af-. af-. af-. af-. |
        a-. a-. a-. a-. bf-. bf-. bf-. bf-. |
        g-. g-. g-. g-. af!-. af-. af-. af-. |
        bf-. bf-. bf-. bf-. ef-. ef-. ef-. ef-. |
        g,-.\p g-. g-. g-. af-. af-. af-. af-. |
        bf-. bf-. bf-. bf-. ef4 \endcresc r |
...
cloVa = \notes {
    ...
    \relative g {
        ...
        g'\f b | c f, g g, | c2
        c'4-.\p\cr b-. | c->( )g c-. b-.\rc | c->( )g
        d'-. cs-. | d->\cr( )a d-. cs-.\rc | d->( )a
...
cloVI = \notes {
    ...
    \relative g {
        ...
        \bar ""
        < g4.\p g'2. > g'2. | g c,4.( )d | g, r d'2.\p | d d | g,4.( )a d, r |
        ...
        cs'8 | d4( )d,8-- r4 ds'8 e4( )e,8-- r4 fs'8\rc | g4.
        r4. r2. | r2. r4. r4
        ...
        r2. r4. r4
        a'8\mf |
        \cresc gs4( )e8 a,4( )a'8-. gs4( )e8 r4
        b'8 | as4( )fs8 b,4( )b'8-. as4( )fs8 \endcresc r4
        fs8\p | gs4. as b d, |
        e4. e'2. d4( )e8 | fs4( )e8 fs4( )fs,8-.\cr b4. a |
        g fs e\rc d | e r4
        e8 fs4. b, | fs' fs, b2. |
        %
