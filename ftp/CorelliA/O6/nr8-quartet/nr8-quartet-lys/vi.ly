...
viIb = \notes {
    \time 4/4
    \relative d'' {
        R1 | R1 | r4 d2\p-"espress." cs4 | d a'2 g4 |
...
viIIa = \notes {
    ...
    \relative g'' {
        ...
        g4.( )a8 fs d g4 ~ | g fs g
            bf,->\mf\cr ~ | bf a d2 ~ | d4 c f2 ~ |
        f4\rc ef2\f d4 | g,8 a bf2 a4 | bf g'2->\mf\cr fs4 | bf2. a4 |
        d2->\rc\f c-> | bf-> a-> | g-> f-> | ef-> fs,4 g-> ~ |
...
viIIIan = \notes {
    \relative g' {
        ...
        ef8\cr bf'4 < af { s8 s8-"allarg." } >
            g8\rc < f4 { s8\decr s8\rced } > |
    }
}
...
viIIIb = \notes {
    \relative ef' {
        ...
        \cresc ef, bf' \repeat unfold 3 { ef, bf' } \repeat unfold 4 { ef, c' } |
        ...
        bf'\p ef \repeat unfold 3 { bf ef } \repeat unfold 4 { c ef } |
        \repeat unfold 4 { f, bf } g4 \endcresc r4 |
...
viIIId = \notes {
    \relative ef'' {
        ef16\p\cr-"a tempo"( bf g )ef ef'4 ef16( bf g )ef ef'4\rc |
...
viVa = \notes {
    ...
    \relative g'' {
        ...
        ef8\p\cr( )g d g | ef( )g d g ef( )g d g\rc | ef4->( )d
        f8( )a e a | f8\cr( )a e a f8( )a e a\rc | f4->( )e
        bf'-|\f a-| | bf->( )a g-| f-| | g->( )f
        e-| d-| | cs d2->( )cs4 | d2
...
viVb = \notes {
    \relative a'' {
        ...
        b4\f c2->( )b4 |
        \cresc
        c8\p( )d c d ef( )d ef d |
        cs8( )d cs d e( )d e d |
        \endcresc
        cs4\f d2->( )cs4 | d2
        g4-|\f fs-| | g->( )d bf'-| a-| | bf2
        d,4-| d-| | d->( )fs, g2 | fs
        fs'4-.\p\cr fs-. | g-. g-. a-. a-.\rc | a->( )d,
        g-|\f f!-| | ef( )d c-| bf-| | a
...
viVI = \notes {
    ...
    \time 12/8
    \relative b' {
        % leave space for faked tie from last mvmt
        \partial 4 s4 \bar ""
        ...
        e8\mf\cr a4. | r4 fs8 b4. r4 g8 c4.\rc | r4
        ...
        \cresc b4. c b r4 d8 | cs4. d cs \endcresc r4
        fs8\p | fs4( )e8 e4( )e8-- e4( )d8 r4
        d8 | d4( )c!8 c4( )b8 as4( )fs8 b4. ~ |
        b as b4\cr( )fs'8-. b4.( ~ | b4 )fs8-. b4.( ~ b4\rc )fs8-. b4.( ~ |
        ...
        fs8\f b,( cs )d a( d )cs |
        %
        d1.\decr ~ | d\rced ~ | d2.( ~ d8 c )b c4.( ~ |
        c8 b )a b4.( ~ b4 )e,8 a4.( ~ | a4 )d,8 g2. fs4. |
        < \repeat unfold 6 < g2. g, > { s2. s\f } > |
