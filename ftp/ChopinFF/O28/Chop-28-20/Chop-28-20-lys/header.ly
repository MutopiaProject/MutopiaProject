\header {
    ...
    %footer = "0.06 (20 Sep 2004)" 
    %%    tagline = "Tagline"

                                % MUTOPIA HEADERS
    mutopiatitle = "Prelude Op. 28, No. 20 ('Funeral March')"
...
*	group:     sources/lily/chopin_prelude_op28_no20
