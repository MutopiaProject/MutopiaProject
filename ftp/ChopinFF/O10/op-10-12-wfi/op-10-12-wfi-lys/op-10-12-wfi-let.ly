...
\paper{                               % letter
  ...
  printfirst-page-number = ##t        % letter
...
#'((fixed-alignment-extra-space . -5) (Y-offset . 51)) % mit Zeilen-Korrektur
%#'((fixed-alignment-extra-space . -5))                 % ohne Zeilen-Korrektur
  ...
  %%%%%%%%%%%%% ----------------------------------------------- ---------
\break\overrideProperty #"Score.NonMusicalPaperColumn" #'line-break-system-details
#'((fixed-alignment-extra-space . 1.5) (Y-offset . 80)) % mit Zeilen-Korrektur
...
%%    f16_> \> d \unten b g f^>  es\! c f,                        % Takt 27
  ...
  %%%%%%%%%%%%% ----------------------------------------------- ---------
\break\overrideProperty #"Score.NonMusicalPaperColumn" #'line-break-system-details
#'((fixed-alignment-extra-space . -5) (Y-offset . 49.3)) % mit Zeilen-Korrektur
%#'((fixed-alignment-extra-space . -5))                 % ohne Zeilen-Korrektur
  \NormalerBogen
  ...
  %%%%%%%%%%%%% ----------------------------------------------- ---------
\break\overrideProperty #"Score.NonMusicalPaperColumn" #'line-break-system-details
#'((fixed-alignment-extra-space . -5) (Y-offset . 70.6)) % mit Zeilen-Korrektur
%#'((fixed-alignment-extra-space . -5))                 % ohne Zeilen-Korrektur
  ...
  %%%%%%%%%%%%% ----------------------------------------------- ---------
\break\overrideProperty #"Score.NonMusicalPaperColumn" #'line-break-system-details
#'((fixed-alignment-extra-space . -5) (Y-offset . 95.5)) % mit Zeilen-Korrektur
%#'((fixed-alignment-extra-space . -5))                 % ohne Zeilen-Korrektur
