...
IMand = \notes \relative c'' {
  ...
  %6 page 3
  \ISharedC
  e''8_#'(italic "Solo") a32( gis fis e d cis b )a a'( gis fis e d cis b )a |
  %14 page 4
  ...
  %33 page 8
  e'8_#'(italic "Solo") b gis fis16 e cis'8 b r e |
  ...
  <e2_#'(italic Siegue) \\ s \\ cis \\ a> <fis \\ s \\ d \\ s \\ fis,> |
  %37 4 bars of shifted stemUp chords
  <{fis gis | a fis | g c, | cis d} \\ s \\ {dis b | cis a | b e, | e fis} \\
    s \\ {fis e | e d | d gis, | a a}>
  <e \\ s \\ b \\ gis> a,16 a' gis fis e d cis b |
  %42 page 10
