%{
  ...
  * Ver 1.0 : 01/11/2013                                                *
  *                                                                     *
  * Symphonie n°7 : parties séparées : Basson 2                         *
  *                                                                     *
  * ******************************                                      *
  * *   Fichier principal        *                                      *
  * ******************************                                      *
...
staffSgMaFagottoII = \new Staff \with {\consists "Page_turn_engraver"}{\voiceSgMaFagottoII}
...
staffSgMbFagottoII = \new Staff \with {\consists "Page_turn_engraver"}{\voiceSgMbFagottoII}
...
staffSgMcFagottoII = \new Staff \with {\consists "Page_turn_engraver"}{\voiceSgMcFagottoII}
...
\addQuote scoreSgMdCornoI { \keepWithTag #'quoteFagottoII \quoteScoreSgMdCornoI }

staffSgMdFagottoII = \new Staff \with {\consists "Page_turn_engraver"}{\voiceSgMdFagottoII}
