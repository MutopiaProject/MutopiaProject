%{
  ...
  * Ver 1.0 : 01/11/2013                                                *
  *                                                                     *
  * Symphonie n°7 : parties séparées : Alti                             *
  *                                                                     *
  * ******************************                                      *
  * *   Fichier principal        *                                      *
  * ******************************                                      *
...
staffSgMaViola = \new Staff \with {\consists "Page_turn_engraver"}{\voiceSgMaViola}
...
staffSgMbViola = \new Staff \with {\consists "Page_turn_engraver"}{\voiceSgMbViola}
...
staffSgMcViola = \new Staff \with {\consists "Page_turn_engraver"}{\voiceSgMcViola}
...
staffSgMdViola = \new Staff \with {\consists "Page_turn_engraver"}{\voiceSgMdViola}
