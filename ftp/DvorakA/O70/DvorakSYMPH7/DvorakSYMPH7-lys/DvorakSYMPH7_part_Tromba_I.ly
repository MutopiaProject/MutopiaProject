%{
  ...
  * Ver 1.0 : 01/11/2013                                                *
  *                                                                     *
  * Symphonie n°7 : parties séparées : Tompette 1                       *
  *                                                                     *
  * ******************************                                      *
  * *   Fichier principal        *                                      *
  * ******************************                                      *
...
\addQuote scoreSgMaCornoIII { \keepWithTag #'quoteTrombaI \quoteScoreSgMaCornoIII }
\addQuote scoreSgMaTromboneI { \keepWithTag #'quoteTrombaI \quoteScoreSgMaTromboneI }
\addQuote scoreSgMaTrombaII { \keepWithTag #'quoteTrombaI \quoteScoreSgMaTrombaII }
\addQuote scoreSgMaViolinoI { \keepWithTag #'quoteTrombaI \quoteScoreSgMaViolinoI }

staffSgMaTrombaI = \new Staff \with {\consists "Page_turn_engraver"}{\voiceSgMaTrombaI}
...
\addQuote scoreSgMbCornoI { \keepWithTag #'quoteTrombaI \quoteScoreSgMbCornoI }
\addQuote scoreSgMbCornoII { \keepWithTag #'quoteTrombaI \quoteScoreSgMbCornoII }
\addQuote scoreSgMbViolinoI { \keepWithTag #'quoteTrombaI \quoteScoreSgMbViolinoI }
\addQuote scoreSgMbViola { \keepWithTag #'quoteTrombaI \quoteScoreSgMbViola }

staffSgMbTrombaI = \new Staff \with {\consists "Page_turn_engraver"}{\voiceSgMbTrombaI}
...
staffSgMcTrombaI = \new Staff \with {\consists "Page_turn_engraver"}{\voiceSgMcTrombaI}
...
staffSgMdTrombaI = \new Staff \with {\consists "Page_turn_engraver"}{\voiceSgMdTrombaI}
