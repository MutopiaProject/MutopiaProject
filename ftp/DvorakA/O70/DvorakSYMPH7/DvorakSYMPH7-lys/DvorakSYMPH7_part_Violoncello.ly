%{
  ...
  * Ver 1.0 : 01/11/2013                                                *
  *                                                                     *
  * Symphonie n°7 : parties séparées : Violoncelle                      *
  *                                                                     *
  * ******************************                                      *
  * *   Fichier principal        *                                      *
  * ******************************                                      *
...
staffSgMaVioloncello = \new Staff \with {\consists "Page_turn_engraver"}{\voiceSgMaVioloncello}
...
staffSgMbVioloncello = \new Staff \with {\consists "Page_turn_engraver"}{\voiceSgMbVioloncello}
...
staffSgMcVioloncello = \new GrandStaff \with {\consists "Page_turn_engraver"} <<
  \new Staff {\voiceSgMcVioloncelloI}
...
staffSgMdVioloncello = \new Staff \with {\consists "Page_turn_engraver"}{\voiceSgMdVioloncello}
...
\book {
  ...
  \score {
    \keepWithTag #'partScore
    \new GrandStaff \staffSgMcVioloncello
    \layout {
      \context {
        \Score
        \override RehearsalMark #'after-line-breaking =
