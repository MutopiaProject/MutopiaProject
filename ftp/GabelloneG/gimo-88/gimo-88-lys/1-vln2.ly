...
IVlnII = \notes \relative c'' {
  ...
  \ISharedE
  %22 page 4
  f8 \times 2/3 {f16 g a} f8 \times 2/3 {f16 g a}
    f8 <f c f,> <f c f,> <f c f,> |
  %23 page 5
  <f4 c f,> r4 r8 a,8 a4 | [a8 a a a] a2:8 |
  ...
  g g g, g c4 r8 f | g g g, g <c'4 e, g,> <c e, g,> |
  \ISharedG r4 |
  %51 page 9
  ...
  f8 \times 2/3 {f16 g a} f8 \times 2/3 {f16 g a} |
  %90 page 16
  f8 <f c f,> <f c f,> <f c f,> <f4 c f,> r^\fermata \bar "|."
} 
