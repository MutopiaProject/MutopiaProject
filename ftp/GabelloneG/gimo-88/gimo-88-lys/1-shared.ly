...
ISharedA = \notes \relative c'' {
  \partial 8 c8 |
  %1 page 2
  <f4 c f,> <f c f,> <f8 c f,> f,16 f a a c c |
  <f4 c f,> <f c f,> <f8 c f,> f,16 f a a c c |
...
ISharedG = \notes \relative c'' {
  %41 page 7
  <c8 e, g,> c,16 c e e g g <c4 e, g,> <c e, g,> |
  <c8 e, g,> c,16 c e e g g c8 c, r4 |
  %43 page 8
  ...
  g,8 c16. d32 d4^\trill [c8 \times 2/3 {e16 f g]}
    [e8 \times 2/3 {e16 f g]} |
  %Note: The <e4 c g> chord is left out in mand 1, making the bar a quarter too short. My interpretation: The chord should be there just as in violin 1+2.
  e8 <e8 c g> <e c g> <e c g> <e4 c g>
}
%1+2
ISharedH = \notes \relative c' {
  %53 page 9
...
ISharedM = \notes \relative c'' {
  ...
  %90
  [a8 <f c f,> <f c f,> <f c f,>] <f4 c f,> r4^\fermata \bar "|."
}
