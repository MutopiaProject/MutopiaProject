...
IIISharedD = \notes \relative c''' {
  ...
  \grace {\noStroke f} e4. | \times 2/3 {d!16 c d} f8 b, |
  \grace {\noStroke b?} c4. | \times 2/3 {f16 g a g f e d c b} | c8 c, r |
  %20 page 34
  \times 2/3 {f'16 e f} a8 dis, | \grace {\noStroke dis?} e4. |
  \times 2/3 {d!16 c d} f8 b, | \grace {\noStroke b?} c4. |
...
IIISharedF = \notes \relative c''' {
  ...
  \times 2/3 {bes'16 a bes} d8 gis, | \grace {\noStroke gis?} a4. |
  \times 2/3 {g!16 f g} bes8 e, | \grace {\noStroke e} f4. |
  \times 2/3 {bes16 c d c bes a g f e} | f8 f, r |
  \times 2/3 {bes'16 a bes} d8 gis, |
  %40 page 36
  \grace {\noStroke gis?} a4. | \times 2/3 {g!16 f g} bes8 e, | 
  \grace {\noStroke e} f4. |
...
IIISharedP = \notes \relative c''' {
  ...
  %173 page 53
  \grace {\noStroke e8} f4. | \times 2/3 {bes16 c d c bes a g f e} |
}
%m+1+2
IIISharedQ = \notes \relative c'' {
  %175
  ...
  %181 page 54
  f \times 2/3 {f'16 g a f g a} | <f8 c f,> <f c f,> <f c f,> |
  <f4 c f,> r8^\fermata \bar "|." |
}
