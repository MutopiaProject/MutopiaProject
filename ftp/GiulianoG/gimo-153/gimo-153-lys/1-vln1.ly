...
IVlnI = \notes \relative c'' {
  ...
  %page 12
  \partial 8 f8 | <bes4 d, f,> r8 d,16 es [f8 \times 2/3 {bes16 a g]}
  ...
  %10
  f8 a r c r es \grace {\noStroke f8} [es d16 c] | bes8 d r f r bes bes16 f d bes |
  f8 a r c r \grace {\noStroke f8} es [es d16 c] |
  %13
  ...
  a d c bes <a4 \\ f> r | f8 d c c <f4 a,> r |
  %34
  f8 d c c <f'4 c f,> r8 a,16 bes |
  ...
  f8 <bes16 d, f,> <bes d, f,> <bes8 d, f,> <bes d, f,> <bes4 d, f,> r^\fermata \bar "|."
}
