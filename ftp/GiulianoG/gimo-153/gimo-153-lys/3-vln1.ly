...
IIIVlnI = \notes \relative c'' {
  ...
  %120
  \grace {\noStroke f8} \times 2/3 {[es16 d c]} [bes8 a] | g8 f16 es d c |
  %122
  d8 d d | a' a, bes | d d d | a' a ais? | \times 2/3 {[bes16 a bes} bes8] r |
  %127
  r bes a | g r r | r g f | es r r | r g f | es r r | r es d | c r r |
  %135
  d4 r8 | d4 r8 | a'4 r8 | <f4 d> r8 | a4 r8 | a4 r8 |
  %141
  bes8 c, d | es es es | <d4 bes> r8 | <d4 bes> r8 |
  %145 page 11
  ...
  <{[bes8 d,16 d d d]} \\ {s8 f,16 f f f}> | <d4 f,> r8^\fermata \bar "|."
}
