...
IVlnII = \notes \relative c'' {
  ...
  %page 16
  \partial 8 f8 | <bes4 d, f,> r8 d,16 es [d8 \times 2/3 {g16 f es]}
  ...
  [bes8 <d16 bes> <d bes>] <d8 bes> <d bes> <d4 bes> r4 |
  %18
  ...
  %33
  f8 bes, c c <f4 a,> r | f8 bes, c c % Note: Here the bars get out of sync
    <f'4 c f,> r8 <{a,16 bes} \\ {f g}> |
  %35
  [a8 \times 2/3 {d16 c bes]} [a8 \times 2/3 {d16 c bes]} a8 a r4 |
  e8 e e e f4 r |
  e8 e e e [f8 \times 2/3 {f'16 g a]} \times 4/6 {[a a a a a a]} |
  %38
  [a8 r16 c,] [<c8.\trill a> <bes32 g> f] [e8 \times 2/3 {es'16 f g]}
    \times 4/6 {[g g g g g g]} |
  g8. g,16 g8. f32 e [f8 r16 c'] f c c a |
  f' c c a a' f f a, \grace {\noStroke a8} bes4. bes'8 |
  %41
  ...
  d8 d d d g4 r | d8 d d d [g16_"tutti" g' g g g g g g] |
  %56
  ...
  f8 [<d16 f, bes,> <d f, bes,>] [<d8 f, bes,> <d f, bes,>] <d4 f, bes,> r^\fermata \bar "|."
}
