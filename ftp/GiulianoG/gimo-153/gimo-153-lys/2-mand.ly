...
IIMand = \notes \relative c'' {
  ...
  \notes { \property Voice.tupletSpannerDuration = #(make-moment 1 2) }
  ...
  f4 \times 2/3 {[f8 es f]} \times 4/6 {\grace {\noStroke a8}
    [g f es \grace {\noStroke g} f es d]} |
  %17
  ...
  \times 2/3 {[f e d]} \times 2/3 {[bes' a g]} f4 \times 2/3 {\grace {\noStroke f8}[e8 d e]} |
  d8. c16 bes8. a16 gis4 a | c8. bes16 a8. g16 fis4 g |
  %35
  \times 4/6 {[e'8 f g g f e] [f e d bes' a g]} |
  f4 \times 2/3 {\grace {\noStroke f8}[e8 d e]} d4 d16 cis d cis |
