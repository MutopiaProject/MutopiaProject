...
\header {
	...
	meter = ""
% MUTOPIA
 mutopiatitle = "Nº. 17. Polish Hymn."
 ...
 footer = "Mutopia-2007/11/10-1107"
...
upper = \relative c''{
	...
	{\smaller\bold "Nº. 17  " \smaller\smaller\italic "ANDANTE " 
	\tiny\smaller\italic "RELIGIOSO. "}}
	\repeat volta 2 {
		\partial 4*1 <g f>8 <g f> |
		c4 c b8 c |
		d4 d <e c>8 <f b,> |
		<g c, g>4 <f d a> <e c>8 <d b> |
		c2
	}
	e8. d16 |
	c8 b a4 d8. c16 |
...
lower = \relative c' { 
	...
	\repeat volta 2 {
		\partial 4*1 b8 g |
		<e' c>4 <e c> <f d>8 <g e> |
		b,4 g <g' c,>8 <g d>16 g, |
		e4 f <g' g,>8 <f g,> |
		<e c>2
	}
	<gs e>4_\dol |
	<a a,>8 <gs e> f4_> <fs d> |
	<g! g,!>8 d e4_> <e c>8 <f d> |
	<g e>4 e <a d,>8. <a e>16 |
	<a f>8 fs g4 c,8 d |
	e c <a' f> d, g <f g,> |
	<e c>2 
}
