...
% MUTOPIA
 ...
 footer = "Mutopia-2007/11/10-1122"
...
upper = \relative c''{
	...
	{\smaller\bold "Nº. 32  " \smaller\smaller\italic "MODERATO. " 
	}}
	\repeat volta 2 {
		\partial 8*1 <fs d>8 |
		<a fs>8. <g e>16 <fs d>8 <a fs> |
		<g e>8. <fs d>16 <e cs>8 <g e> |
		<fs d>[ <d a> b <e g,>] |
		<<{d4}\\{\override Beam #'positions = #'(-3.2 . -3.3)fs,8 f}>>
			cs' <fs d> |
%% segno
		<a fs>8. <g e>16 <fs d>8 <a fs> |
		<g e>8. <fs d>16 <e cs>8 <g e> |
