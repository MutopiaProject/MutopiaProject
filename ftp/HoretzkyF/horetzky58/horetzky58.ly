...
\header {
	title = "Nº. 58. Sul Margine D'un Rio."
	subtitle = ""
	...
	meter = ""
% MUTOPIA
 mutopiatitle = "Nº. 58. Sul Margine D'un Rio."
 ...
 footer = "Mutopia-2007/11/14-1155"
...
upper = \relative c''{
	...
	{\smaller\bold "Nº. 58.  " \smaller\smaller\italic "ANDANTINO.  " 
	}}
	\repeat volta 2 {
		\partial 8*1 g8 |
		c8 e16 d c8 e |
		g8. f16 d8. f16 |
		<e g,> <g bf,> <f a,> <d f,> d c c b |
		<d f,>4 c8
	}
	g8 | 
	d'8.[ e32 d] b8 g |
