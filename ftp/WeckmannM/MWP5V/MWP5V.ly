...
upTwo = \context Voice=two \notes \relative c''' {
  ...
  f g e f |
  d2 c4 b |
  c d2 \translator Staff = bass \stemUp c4~ |
  c b a b~ |
  [b8 g] c4 d \translator Staff = treble \stemDown c~ |	   %45
  c [b8 c] d4 [c8 b] |
  s4 d4 e f |
  g4. g8 f4. [g16 f] |
  e2 g |
...
downOne = \context Voice=three \notes \relative c' {
  ...
  [e f g a] [b g a b] [c d e f] \translator Staff = treble [g a b c] |
  [d8 d,~] [d16 e f d] [g e f g] [a g f e] |
  [d8 g16 f] [e d c b ] \translator Staff = bass \stemUp [a g f e] [d c] b8 |
  d4 d r8 g fis8. g16 |
  [d e f g] [a8 e] [f e16 d] [c d e f] |		   %20
  [g a b c] \translator Staff = treble \stemDown [d e] f8 e4 fis |
  \translator  Staff = bass \stemUp r8 d cis8. d16 [a b c d] [e8 b] |
  c [b16 a] [g g' f g] [e d c b] [a b c a] |
  [b c d e] [f g8.] s2 |
  s1 |							   %25
  s |
  s |
  r2 r8 \translator Staff = treble \stemDown b a8. a16 |
  [g8 g] fis8. g16 [d8 f] a8. a16 |
  a8 r8 r4 r8 e8 e8. e16 |				   %30
  e8 s8 s4 s8 a g8. f16 |
  [e8 e] e8. e16 [e8 e] e8. e16 |
  [d8 d] d8. d16 d4 r |
  \translator  Staff = bass \stemUp r g a2 |
  g1 |					   %35
  r |
  r |
  r |
  ...
  g4. g8 f2 |
  e4 c d e |
  \translator Staff = treble \stemDown f e d [c8 b] |
  a4 b c f~ |						   %60
  f e d4. [e16 d]  |
  c4. b8 \translator Staff = bass \stemUp a4 [g8 f]  |
  g4 c d e |
  f4. f8 e2 |
  r4 d e f |						   %65
  g4. f8 e4 d |
  ...
  b2. b4 a b |
  g2 a b |
  \translator Staff = treble \stemDown c d e |
  f2. f4 e f |						   %85
  d2 e f |
  g1 f2 |
  f \translator Staff = bass \stemUp d1 |
  d1. |
  s |							   %90
  s |
  s |
  \translator Staff = treble \stemDown d2 e fis |
  g2. g4 fis e |
  fis2. fis4 e fis |					   %95
  g2. g4 f g |
  e d c b a2 |
  ...
  e4 \translator Staff = bass \stemUp r r r16 [g, b c] |   %105
  d2 a4 b |
  r2 g'4 r |
  r d r2 |
  d4 r r8 d e4 |
...
downTwo = \context Voice=four \notes \relative c {
  ...
  g4 r8 \stemUp r16 g [a b c d] [e f g f] |
