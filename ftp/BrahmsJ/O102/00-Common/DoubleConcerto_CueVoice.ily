...
cueVoiceKlarIMvtIII = \relative c' {
	\transposition a
...
cueVoiceKlarIIMvtII = \relative c' {
	\transposition a
	c4( -\tweak X-offset #-4 _\markup {Hr.II} f2_\fermata)
	R2.*23
	% bar 25
...
cueVoiceKlarIIMvtIII = \relative c' {
	\transposition a
	c8( -\tweak X-offset #-3.5 ^\markup {\column {\lower #1.5 \line {Solo-} \line {Vlc.}}} g'16-.) g-. fis8( f16-.) f-.
	e8( d16-.) d-. c8( g16-.) g-.
	R2*22
...
cueVoiceFagIIMvtIII = \relative c {
...
cueVoiceHrnIIMvtIII = \relative c {
	\transposition e
	f'8(^\markup {Solo-Vlc.} c'16-.) c-. b8( bes16-.) bes-.
	aes8( g16-.) g-. f8( c16-.) c-.
	R2*18
...
cueVoiceHrnIIIMvtII = \relative c {
	\transposition f
...
cueVoiceHrnIIIMvtIII = \relative c {
	\transposition d
...
cueVoiceHrnIVMvtIII = \relative c {
	\transposition d
	g''8(^\markup {Solo-Vlc.} d'16-.) d-. cis8( c16-.) c-.
	bes8( a16-.) a-. g8( d16-.) d-.
	R2*18
...
cueVoiceTptIMvtI = \relative c {
	...
	R1*54
	% bar 143
	f4.(-\tweak X-offset #2 ^\markup {Ob.I} ees8 c2)
	r4 r8 f( ees4. c8
	f4. ees8 c2)
	R1*31
	% bar 177
	...
	R1*43
	% bar 242
	e,2(-\tweak X-offset #1.5 ^\markup {Klar.I} d
...
cueVoiceTptIIMvtI = \relative c {
	...
	R1*11
	% bar 196
	e'4\rest^\markup {Viol.I} e8\rest \ottava #1 b'^( c d ees d)
	c8 c4 c c c8^(
	c4.) a8^( bes fis g bes) \ottava #0
	R1*43
	% bar 242
	...
	R1*16
	% bar 366
	r4 r8 gis'(-\tweak X-offset #-5 ^\markup  {Viol.I} a b c b)
	a8 a4 a a a8~
	a4~ \tuplet 3/2 4 {a8 fis-. g-. dis-. e-. b-. g-. b-. e-.}
	R1*51
	% bar 420
...
cueVoiceTptIIMvtIII = \relative c {
	\transposition d
	g'8_(^\markup {Solo-Vlc.} d'16-.) d-. cis8_( c16-.) c-.
	bes8_( a16-.) a-. g8_( d16-.) d-.
	R2*18
	...
	bes'8->^\markup {Ob.I} a16-. bes-. a8-> bes16-. a-.
	bes8-> a16-. bes-. a( g') f-. e-.
	d'8->-\tweak X-offset #-3.2 ^\markup {Fl.I} c16-. d-. c8-> d16-. c-.
	d8-> c16-. d-. c( ees) c-. a-.
	R2*7
	% bar 118
	r4-\tweak X-offset #-1.5 ^\markup {Solo-Viol.} r8. g16-.
...
%#                           S O L O - V I O L I N                             #
%###############################################################################
cueVoiceSoloVlnMvtI = \relative c {
...
cueVoiceSoloVlnMvtII = \relative c {
...
cueVoiceSoloVlnMvtIII = \relative c {
	R2*6
	% bar 7
...
%#                             S O L O - C E L L O                             #
%###############################################################################
cueVoiceSoloVlcMvtI = \relative c {
...
cueVoiceSoloVlcMvtII = \relative c {
...
cueVoiceSoloVlcMvtIII = \relative c {
	R2*45
	% bar 46
