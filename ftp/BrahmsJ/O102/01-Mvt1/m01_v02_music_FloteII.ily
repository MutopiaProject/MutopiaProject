...
% Bars 21 to 25
	...
	\mmrPos #4 R
% Bars 26 to 30
	<< \mmrPos #-7 R {s2^\tutti s4 \clef treble s } >>
	\mmrPos #4 R1 \no 
	\voiceOne r2 r4 \oneVoice a,(_\pdolce
	fis2 f)
	e4( cis2) r4
% Bars 31 to 35
...
% Bars 91 to 95
	g2 c,4) a'4(
	g8) r a4( e8) r \shape #'((0 . -1.5)(0 . 0.3)(0 . 0.3)(0 . -0.7)) Slur f4(\<
	f'2\> c4)\! d(
...
% Bars 161 to 165
	...
	\mmrPos #4 R \no 
% Bars 166 to 170
	\voiceOne r2 \oneVoice r4 c~_\pdolce
	c8 r c4~ c8 r c4(\<
	aes4\> g8\!) r8 r4 c~
	c8 r c4~ c8 r c4~\<
	c1\dimD\>~
...
% Bars 231 to 235
	...
	\mmrPos #-4 R1
	\mmrPos #-8 R1 \no
	\voiceTwo r2 r8 \oneVoice b(\p a g)
	R1*7
% Bars 236 to 240
...
% Bars 251 to 255
	\ni R1
	<< \mmrPos #-4 R {s4 s8 \clef bass s s2 }>> \clef treble \no
	\voiceOne r2 f'4\rest r8 \oneVoice cis'\f-.
	d-. e-. f-. r r4 r8 b,-.
	c!-. d-. ees-. r r2
	R1*3
% Bars 256 to 260
...
% Bars 261 to 265
	...
	aes4. g8 c,4 r
	\tuplet 3/2 2 {d!4-.^\tutti e-. f-. e-. f-. g-.
	f-. g-. aes-. bes-. c-. des~}
% Bars 266 to 270
	des ees,-. c'-. aes-.
...
% Bars 301 to 305
	...
	\mmrPos #-4 R \no
% Bars 306 to 310
	\voiceOne r4 \oneVoice fis-.\< gis-.\sf r
	R1
	r4 c,-.\< fis-.\sf r
	R1
	r4 ees-.\< e-.\sf r
...
% Bars 376 to 380
	b8) r cis4( gis8) r a4(
	b2 e,4) cis'(
	b8) r cis4( gis8) r \shape #'((0 . -1.5)(0 . 0.3)(0 . 0.3)(0 . -0.7)) Slur a4(
	a'2 e4) a,(
	cis-.) b2-> b4~
% Bars 381 to 385
	b b2 b4~(
