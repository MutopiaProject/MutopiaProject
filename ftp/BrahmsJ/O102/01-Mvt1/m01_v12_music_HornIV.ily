...
% Bars 21 to 25
	...
	\mmrPos #4 R \no
% Bars 26 to 30
	\voiceOne r2 \oneVoice \clef treble r4 g_\pdolce(^\tutti
	c2 b)
	a2. g4~
	g1~
	g2. r4
...
% Bars 161 to 165
	...
	\mmrPos #-4 R \no
% Bars 166 to 170
	\voiceTwo r2 \oneVoice r4 bes_\pdolce~
	bes8 r bes4~ bes8 r bes4(~\<
	bes\> a8\!) r r4 bes~
	bes8 r bes4~ bes8 r bes4~\<
	bes2.\> r4\!
...
% Bars 311 to 315
	...
	c'1\pp~
	<<c~ {s4 s s s\<}>>
	<<c1 {\hairpinShorten #'(0 . -2) s4\> s s\! s}>>
% Bars 316 to 320
	R1_\gp
	g,1\pp~
	g2(\< g')~\!
...
% Bars 331 to 335
	...
	\mmrPos #-4 R \no
% Bars 336 to 340
	\voiceTwo r2 \oneVoice r4 g'(_\pdolce 
	c8) r g4( c8) r g4(
	g,) r r g'(
	c8) r g4( c8) r g4(
	g,) r4 r2
