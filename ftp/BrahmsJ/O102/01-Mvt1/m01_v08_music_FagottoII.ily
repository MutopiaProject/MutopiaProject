...
% Bars 21 to 25
	...
	\mmrPos #4 R
% Bars 26 to 30
	<<\mmrPos #8 R1 {s2 s4 \clef treble s^\tutti }>>
	<<\mmrPos #4 R1 {s2 s4 \clef bass s}>>  \no
	r4 b'(-\offset X-offset -1 \p\<_\dolce d\> cis)\!
	a1~
	a2. r4^\solo
% Bars 31 to 35
...
% Bars 86 to 90
	...
	a4-! a-! r bes-!
	r c-! r2
	c,2(-\offset X-offset -1.5 \f c,4) f'( \markWhiteout \mark \default
	b!8) r8 f4( bes8) r a4(
% Bars 91 to 95
	g2 e4) f(
	b!8) r f4( bes8) r f4(
...
% Bars 176 to 180
	...
	f \clef bass d2\>( g,4)\!
	R1
	r2 r4 d'4-\offset X-offset 1.5 \pp(~
	d1~
% Bars 181 to 185
	d2 g,4) r
	R1
...
% Bars 336 to 340
	\ni \mmrPos #-4 R1
	\mmrPos #-4 R 
	<< \mmrPos #-7 R {s2. \clef treble s4 } >>
	\mmrPos #-4 R1
	\mmrPos #-4 R
% Bars 341 to 345
	\mmrPos #-4 R \no \mark \default
	\voiceTwo r2 r4 \oneVoice \clef bass a\f(
	ais-.) b2( fis4)
	r2 r4 d'(
...
% Bars 351 to 355
	...
	r2 \shape #'((0 . 1.5)(0 . -0.5)(0 . -0.5)(0 . 0)) Slur a,-\offset X-offset -0.5 \pp(
	dis,1
	eis
% Bars 356 to 360
	g2 fis
