...
% Bars 31 to 35
	a'2\> e4)\! <fis, a>(\<
	a'2\> e4)\! <f,! a>\<(
	\tuplet 3/2 2 {\tupletOffset #3 a'4 d,) <e, a>( \tupletOffset #3 a' cis,) <dis, a'>(\!}
	c''!2~_\piuf \tuplet 3/2 2 {c4 a) fis
	\once \tupletDown c( a fis c) b a}
% Bars 36 to 40
...
% Bars 41 to 45
	...
	<bes' d>2 \tuplet 3/2 {<a cis>4) r <a d>(}
	\tuplet 3/2 2 {<b! a'>2 gis'4) <c, b'>2( a'4)}
	<d, c'>4.( b'8) <e, d'>4.(\< c'8)
...
% Bars 126 to 130
	...
	>> \oneVoice
	<d, d'>2-> <dis dis'>->
	<< { s16\< s s s  s s\> s s\! \hairpinShorten #'(0.6 . 0) s\< s s s  s s\> s s\! } { <e e'>4.^( \grace g'8 f8) <a,, e''>4.^( \grace a''8 f) } >> 
% Bars 131 to 135
	\shape #'((0 . 0)(0 . 0)(0 . -1)(0 . -2)) Slur e2.\!( gis,,,4)
	\tuplet 3/2 4 {a8\f\< c f\! e\> c gis\! a\< c g'!\! f\> c gis!\!
	a\< c g'! fis a c\! gis'\> d b gis d b\!}
	a4 r r2
	R1
% Bars 136 to 140
	\tuplet 3/2 4 {e'8\mf\< g! c\! b\> g dis\!} e8 r r4
	\tuplet 3/2 4 {e8\< g d'! cis e g\!} g'\f r r4
	\tuplet 3/2 {c,,!8(\p a eis} fis) r \tuplet 3/2 {ees'( c gis} a) r
	\tuplet 3/2 {g'( ees c} a) r \tuplet 3/2 {fis'( c a} d,) r
	\tuplet 3/2 4 {c''_\piup( a a, a' a, a') ees'( c a, c' a, c')
% Bars 141 to 145
	g'( ees a,,\> g'' ees a,, g'' ees a,, g'' ees a,,)
	fis''( c a, fis'' c a, fis'' c a, fis'' c a,)\! \mark \default
	g''(_\pdolce f! d g, f d) g( f d g, f d)}
	g, r r4 r \tuplet 3/2 4 {g'8( d' f
	g\> f d g, d' f) g( f d g, d' f)\!}
% Bars 146 to 150
	R1_\gp
	\ni \clef bass \mmrPos #-4 R1 \clef treble \no
	\tuplet 3/2 4 {c,8( g' bes c g' bes) c( bes g c, g' bes)
	c( a fis c fis gis) a( fis c a c fis)
	g( f! d g, a d) g( f d b g) r}
% Bars 151 to 155
	R1*10
% Bars 156 to 160
...
% Bars 161 to 165
	...
	\mmrPos #4 R \no
% Bars 166 to 170
	\voiceOne r2 \oneVoice r4 e'(_\pdolce
	d8) r e4( b8) r c4(\<
	d2\> g,4)\! e'(
	d8) r e4( b8) r c4(\<
	c'1\dimD\>
% Bars 171 to 175
	g2.)\! \set doubleSlurs = ##t <a, a'>4-\tweak X-offset #-2.5 _\fmarc( \markWhiteout \mark \default
	<ais ais'>-.) \set doubleSlurs = ##f <b b'>(~ q16 a' g fis) a( g fis e)
	g( e a, g) fis( a d e fis8) r <d d'>4(
	<dis dis'>-.) <e e'>(~ q16 d' c b) d( c b a)
	c( a d, c) b( d g a b8) r b,,16-\offset X-offset #-1.5 \mf( c d e
% Bars 176 to 180
...
% Bars 186 to 190
	...
	a8 r r4 r <g'' g'>8-.->_\fbenmarc <c e!>-.
	<e, c'>-.-> <c' e>-. <e, c'>-.-> <c e>-. \beamOffset #'(0.3 . 0.3) <e g>-.-> <c e>-. <e, c'>-.-> <c' e>-.
% Bars 191 to 195
	<e, c'>8-.-> <c e>-. << % bar 191
	...
	d'1(~-\tweak extra-offset #'(0 . -0.7) \startTrillSpan
% Bars 196 to 200
...
% Bars 216 to 220
	...
	r2 \tuplet 3/2 {g,2 c4\<}
% Bars 221 to 225
	\tuplet 3/2 {e g c} e8 g c e\!
	r2 \tuplet 3/2 {b,,2 d4}
	\tuplet 3/2 {g\< \once \stemUp b d} g8 b d g\!
	R1
	r2 \tuplet 3/2 {\acciaccatura e,8 e'4-. \acciaccatura fis,8 fis'4-. \acciaccatura g,8 g'4~}
% Bars 226 to 230
	g8 e b g e b g e
	cis4 r \tuplet 3/2 {\acciaccatura cis'8 cis'4-. \acciaccatura d,8 d'4-. \acciaccatura e,8 e'4~}
	e8 cis ais e cis ais e cis
	r2 r4 \tuplet 3/2 {d8\p( e fis)}
	r2 r4 \tuplet 3/2 {b8( cis d)}
% Bars 231 to 235
	r2 r4 \tuplet 3/2 4 {g8( a b
	e, fis g cis, d e ais, b cis} e,4-.)
	\tuplet 3/2 4 {d8( cis b e d cis fis e d)} r4
	\tuplet 3/2 4 {\once \tupletDown b'8( a g cis b ais d cis b)} r4
	\tuplet 3/2 4 {g'8( fis e a g fis b a g)} r4
% Bars 236 to 240
	\tuplet 3/2 4 {gis8(_\piup fis eis ais gis fis b ais gis)} r4
	\tuplet 3/2 {cis8(_\dimmarkup b ais)} r4 \tuplet 3/2 {dis8( cis b)} r4
...
% Bars 281 to 285
	e dis4 c! a fis8
	e2-\offset X-offset -1 _\pcrescmolto r16 e,( fis gis a b cis d)
...
% Bars 301 to 305
	...
	\tuplet 3/2 4 {a8\f c f e c gis a c g'! f c gis!}
% Bars 306 to 310
	\tuplet 3/2 4 {a\< c g'! fis a c\! gis'\> d b gis d b\!}
	a4 r \tuplet 3/2 4 {a8\< c g'!\! f\> c g\!}
	aes4 r \tuplet 3/2 4 {a''!8\rf\> fis c a fis c\!}
	bes4 r \tuplet 3/2 4 {g'8 bes f'! ees bes f}
	ges4 r \tuplet 3/2 4 {g''!8\rf\> e! bes g e bes\!}
% Bars 311 to 315
	a!4 r \tuplet 3/2 4 {a''8\rf\> fis dis a fis dis\!}
	\tuplet 3/2 {a'_\dimmarkup fis dis} a8 r \tuplet 3/2 {a fis dis} a r \bar "||" \key a \major \mark \default
	\tuplet 3/2 4 {e'''8(_\pdolce d! b e, d b) e( d b e, d b)}
	r2 r4 \tuplet 3/2 4 {e8( b' d
	e d b e, b' d e\> d b e, b' d)\!}
% Bars 316 to 320
	R1_\gp
	r2 \tuplet 3/2 4 {a,8( e' g! a e' g!)
	a( g e a, e' g a g e a, e' g)
	a( fis! dis a dis eis fis dis a fis a dis)
	e(_\dimmarkup d! b e, fis b e d b gis fis e)}
% Bars 321 to 325
	R1
	r2 r4 cis''_\dolce(
	b8) r cis4( gis8) r a4(\<
...
% Bars 331 to 335
	...
	b) r r cis(
% Bars 336 to 340
	b) r4 \tuplet 3/2 4 {r8^\legg e,,_\dolce( a  e' a cis
	d a f) e( a cis b f d) cis( e a
	fis! dis a) d( f a d, b gis) e'( a cis
	d a f) e( a cis b f d) cis(\< e a)\!
	fis!\>( dis c\! a c dis fis_\dimmarkup a c dis fis a)}
% Bars 341 to 345
	cis!2.\pp \set doubleSlurs = ##t <fis,, fis'>4\f( \mark \default
	<fisis fisis'>-.) \set doubleSlurs = ##f <gis gis'>(~ q16 fis' e dis) fis( e dis cis)
...
% Bars 406 to 410
	...
	<d' a'>8:16 a'': <d,, a'>: <f, d'>: <<{ s4. d16 d } \\ {<d d''>8:16[ d''': <d,, d'>: d,16 d] }>>
...
% Bars 416 to 420
	a'8) a4 a8( g) g4 g8(
	f4)~ \tuplet 3/2 4 {f8 e b'! a d c f e a}
	g,4~ \tuplet 3/2 4 {g8\< f c' b e d g f b\!}
	\tuplet 3/2 4 {f' e d c b a f e d c b a}
	c,16( e a c) e,( a c e) a,( c e a) \tuplet 3/2 4 {e,8-.\f dis-. e-.
% Bars 421 to 425
	f8-. e-. f-. e-. dis-. e-. f8-. e-. f-. e-. dis-. e-.}
	d!16( f a d) dis( fis a dis) e8-. r \tuplet 3/2 4 {e,,8-. dis-. e-.
	f8-. e-. f-. e-. dis-. e-. f8-. e-. f-. e-. dis-. e-.}
