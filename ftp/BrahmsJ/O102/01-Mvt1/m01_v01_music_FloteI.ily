...
% Bars 21 to 25
	...
	\ni \clef bass \mmrPos #8 R1
	\mmrPos #4 R
	\mmrPos #4 R
% Bars 26 to 30
	<< \mmrPos #-8 R {s2 s4 \clef treble s} >>
	\mmrPos #4 R1 \no
	\voiceOne r2 r4 \oneVoice cis(_\pdolce
	b) cis( gis) \shape #'((0 . -1.5)(0 . 0.5)(0 . 0.5)(0 . -0.5)) Slur a\<(
	a'2\> e4)\! r
% Bars 31 to 35
...
% Bars 166 to 170
	...
	d4.\> r8\! r4 e~
	e8 r e4~ e8 r e4~\<
	\hairpinShorten #'(-0.5 . -0.5) e1\dimD\>~
% Bars 171 to 175
...
% Bars 191 to 195
	...
	b8\f-. b4 b8( a) a4 \hairpinShorten #'(-1 . -0.5) a8\<(
% Bars 196 to 200
	aes2\>)( g4)\! r
...
% Bars 206 to 210
	d8) r e4( b8) r c4(
	d2 g,4) e'(
	d8) r e4( b8) r \shape #'((0 . -1.5)(0 . 0.5)(0 . 0.5)(0 . -0.5)) Slur c4(
	c'2 g4) e(
	g-.) f2-> f4~
% Bars 211 to 215
	f f2 f4(~
...
% Bars 231 to 235
	...
	\mmrPos #-4 R
	\mmrPos #-8 R \no
	\voiceTwo r2 r8 \oneVoice d(\p cis b)
	R1
% Bars 236 to 240
...
% Bars 276 to 280
	...
	\mmrPos #-4 R
	\mmrPos #-4 R \no 
	\voiceTwo r4 r8 \oneVoice cis'8\p\<( d e\> fis)\! r
	r cis(-\offset X-offset -1 _\dimmarkup e) r r b( d) r
% Bars 281 to 285
...
% Bars 301 to 305
	...
	\ni \mmrPos #4 R1
	\mmrPos #4 R \no 
	\voiceOne r4 \oneVoice e,-.\p r f-.
% Bars 306 to 310
	r \hairpinShorten #'(0 . -0.7) fis-.\< gis-.\sf r
	r e-.\p r f-.
	r \hairpinShorten #'(0 . -0.7) f-.\< a-.\sf r
	r d,-.\p r ees-.
	r \hairpinShorten #'(0 . -0.7) ees-.\< bes'-.\sf r
% Bars 311 to 315
	r a-. dis2\fp\>~
...
% Bars 376 to 380
	b8) r cis4( gis8) r a4(
	b2 e,4) cis'(
	b8) r cis4( gis8) r \shape #'((0 . -1.5)(0 . 0.5)(0 . 0.5)(0 . -0.5)) Slur a4(
	a'2 e4) cis(
	e-.) d2-> d4~
% Bars 381 to 385
	d d2 d4~(
