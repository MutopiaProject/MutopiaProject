...
% Bars 1 to 5
	...
	bes-. r c-. r
	g-. g-. g'-. g-.
	\textLengthOn <>_\markup {(in modo d'un recit.)} R1*18^\markup {Solo-Viol.} \textLengthOff
% Bars 6 to 10
...
% Bars 191 to 195
	...
	ees8-.\f ees4 ees8~ ees ees4 ees8(\<
% Bars 196 to 200
	c2.)\> r4\!
	ees8^\tutti ees4 ees ees ees8(
	d4-.) d-. r2
...
% Bars 241 to 245
	\cueDuring #"cueVoiceHrnIIImI" #UP { \once \override MultiMeasureRest.staff-position = #6 R1 \mark \default }
	bes,1\pp~
	bes2. r4
	R1*10
% Bars 246 to 250
...
% Bars 286 to 290
	...
	g4.\ff-\tweak X-offset #1 ^\tutti f8 f4 r
% Bars 291 to 295
	ees4. d8 bes4 r
	ees4-. ees-. ees4.-> g8
	f4. f8 f4. g8
