...
% Fichier :      m01_v19_music_ViolinII.ly
...
% Bars 1 to 5
	...
	\tupletUp \times 2/3 {a-. b-. c-.} \times 2/3 {d-. e-. f-.} \tupletNeutral
	R1\fermataMarkup
% Bars 6 to 10
	R1*51
% Bars 11 to 15
...
% Bars 56 to 60
	\mark \default
	<c a'>4.-\tweak X-offset #-2 \ff <d g>8 <c e>4 r
	<a f'>4. <gis e'>8 a4 r
	\tupletUp \times 2/3 {b4-. c-. d-.} c4.-> a8
	g4. f8 e4. c'8
% Bars 61 to 65
	b2-> <a c>-> 
...
% Bars 66 to 70
	\times 2/3 { \stemDown b( a) r} \times 2/3 {b( a)\! r} \tupletNeutral
...
% Bars 91 to 95
	d! e8 f c) r f4(
	d16 b! g d) f'4( des16 bes g des) c'4(
	<g f'>8) q4 q8( <a f'>) q4 q8(
	<a a'>4-!) <bes g'>2\sf q4~
	q <bes d>2 bes,16( d g a
% Bars 96 to 100
	bes g d c) bes( d g a bes g d bes) a( bes c d
...
% Bars 101 to 105
	...
	g': c,: f: b,: e: a,: e': gis,:
% Bars 106 to 110
	dis2\sf r8 e:16 gis: a:
	gis2\sf r8 a:16 cis: d:
	c!8( d) d( e) d( f) e-. e,-.
	r4 d'8( f) e-. e,-. r4
	d'8( f) r4 dis8( fis) r4
% Bars 111 to 115
	e4-. r e,-. r \mark \default
	a,8-\tweak X-offset #0.2 \fp-. a-. a-. g-. c-. c-. c-. aes->-. 
	c-. c-. c-. aes->-. c-. c-. c-. b-. 
	a!4 r r d8-. d-.
	c-. c-. a-. a-. b-. b-. gis-. gis-. 
% Bars 116 to 120
...
% Bars 126 to 130
	<c e a e'>8-.\f-\tweak X-offset #-6 ^\pizz r r4 r r8 a\mf
	b4 r c r
...
% Bars 136 to 140
	...
	d4\p fis r a
	r c r a
	r fis_\dimmarkup r a
% Bars 141 to 145
	r2 c4 r
	r2 a4 r \mark \default
	d, r r2
	R1*2
...
% Bars 166 to 170
	...
	c4-\tweak X-offset #-0.5 \p r c r
	c b r2
	c4 r c r
	c_\dimmarkup r c r
% Bars 171 to 175
	R1 \mark \default
	r4 dis-.-\tweak X-offset #0.5 \mf-\tweak X-offset #-4.5 ^\arco r e-.
	r fis-. r a-.
	r gis-. r a-.
	r b-. r2
% Bars 176 to 180
...
% Bars 196 to 200
	r4 r8 cis-\tweak X-offset #-6 ^\arco(\f d e f e)
	f16( d f d b d f d) f( d f d a d f d)
...
% Bars 206 to 210
	...
	<fis, d'>8) q4 q8( <f d'>4) g'(
	fis16 d a fis) g'4( f16 d aes f) e'4(
	fis g8 a) g4 a(
	ais-!) b4\sf(~ b16 a g f!) a4(~
% Bars 211 to 215
	a16 g f e) f4(~ f16 e d cis) f4(~
	f8 e) f4.( a,8) <bes d>4(~
	q16 c bes a) <g bes>4(~ q16 a g fis) <g e'>4~
	q q~ q8-. r r4
	r q2 q4~
% Bars 216 to 220
	q8-. r r4 r2
...
% Bars 221 to 225
	...
	cis,,4-\tweak X-offset #-1 \f-\tweak X-offset #1.0 ^\pizz r dis r
	e r g, r
% Bars 226 to 230
	R1
	cis4 r cis r
...
% Bars 241 to 245
	...
	c2.\> r4\!
	r2 r4 a8-.-\tweak X-offset #-3.5 \pp r
	c-. r bes-. r a-. r a'-. r
% Bars 246 to 250
	d8_\pdolce d4 d8( c) c4\< c8(~
	c2\> b!4)\! r
	r2 r4 b,8-.-\tweak X-offset #-3.5 \pp r
	d-. r c-. r c-. r bes-. r
...
% Bars 366 to 370
	r4 r8 ais(\f-\tweak X-offset #-6 ^\arco b cis d cis) \mark \default
...
% Bars 376 to 380
	...
	dis\< e8\> fis) e4\! fis(
	fisis-!) gis2-\tweak X-offset #-1.5 \sf gis,,16( a b cis
% Bars 381 to 385
