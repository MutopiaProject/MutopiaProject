...
% Bars 26 to 30
		r2 \cueClef "treble" r
		R1
		r2 r4 \cueClefUnset } cis(_\pdolce
	b) cis( gis) a(\<
	a'2\> e4\!) r
% Bars 31 to 35
...
% Bars 241 to 245
	\mark \default
	\cueDuring #"cueVoiceOboeImI" #UP { R1
...
% Bars 311 to 315
	R
	r2. \cueClef "bass" r4 \cueClefUnset } \mark \default \bar "||" \key a \major
	e'4.\espressivo_\pdolce( d8 b2)
	r4 r8 e( d4. b8\<
	e4.\> d8\! b2)
% Bars 316 to 320
	R1^\gp
