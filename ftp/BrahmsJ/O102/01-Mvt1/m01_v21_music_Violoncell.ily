...
%###############################################################################
musicVioloncellMvtI = \relative c' {
	\clef bass
	\key a \minor
%	\transposition a
% Bars 1 to 5
	e4._\fmarc-\offset X-offset -7 ^\tutti d8 b4 r
	c4. b8 e,4 r
	a-. r b-. r
	c-. a-. f'-. d-. 
...
% Bars 21 to 25
	...
	\mmrPos #4 R
% Bars 26 to 30
	<<\mmrPos #-7 R1 {s2 \clef treble s-\offset X-offset -3 ^\tutti }>> 
	\mmrPos #-4 R1
	\mmrPos #-6 R
	\mmrPos #-4 R
	\mmrPos #-4 R \no \clef bass
...
% Bars 51 to 55
	...
	\mmrPos #-4 << R {s2. \clef bass s4 } >>
% Bars 56 to 60
	\mmrPos #-4 \mmrEO #'(-1.5 . 0) R1 \mark \default \no
	a,4.\ff^\tutti b8 c4 r
	d4. e8 f4 r
	g2 a4. f8
	b4. g8 c4. a8
...
% Bars 76 to 80
	f,-. r f,-. r
	c''8-.\sf c4 c8~ c-.\sf c4 c8(
	bes)-.\sf bes4 bes8( g-.)\sf g4 g8 \mark \default
	c,2\f g'
	c4-! c-! r2
% Bars 81 to 85
	c,2 e 
...
% Bars 86 to 90
	...
	bes4-! bes,-! r2
	c4-! r r2
	r r4 f16(\f\> a c f\! \markWhiteout \mark \default
	f,8) r f16( a c f f,8) r f16( a c f)
% Bars 91 to 95
	f,4 e8 d e c f16( a c f
	f,8) r f16( a c f f,8) r f16( a c f)
	d,4 c8 b! c f, f'4(
	f,)-! c'2\sf e16( f g a
	bes a g fis) g( a bes c d c bes a) bes4(
% Bars 96 to 100
	c,) c2 f,4~
	f f'2 f4~
	f f~ f8-. r r4
...
% Bars 121 to 125
	...
	e' r e, r
	e'2^\arco-\offset X-offset 1 \pcrescD\< a,
	a d,\!
% Bars 126 to 130
...
% Bars 156 to 160
	...
	r d,(-. r f-.\<
	r fis-. r d)-.\!
	r f!2.-\offset X-offset -1 \sf-\tweak extra-offset #'(0 . 0.5) \>
% Bars 161 to 165
	e1(-\offset X-offset -1.5 -\tweak extra-offset #'(0 . 1) \p -\offset X-offset 1 -\tweak extra-offset #'(-1.3 . 0.8) _\dimmarkup
	d2 g)
	c,( c')
	f,1\pp\>
	f(
...
% Bars 186 to 190
	...
	gis a e f
% Bars 191 to 195
	fis g!8 gis a e\< f! fis
	g! gis a e f! fis\! r4 \mark \default
	g4\f r r2
	R1*3
...
% Bars 201 to 205
	...
	f4-! f,-! r2
	g4-! r r2
	r r4 c16(-\offset X-offset -3 _\fbenmarc e g c
% Bars 206 to 210
	c,8-.) r c16( e g c c,8-.) r c16( e g c)
	c4 b8 a b g c,16( e g c
	c,8) r c16( e g c c,8) r c16( e g c)
	a4 g8 fis g c, c'4(
	c,-!) g2\sf b16( c d e
% Bars 211 to 215
...
% Bars 236 to 240
		b
		cis
		gis'4(-\tweak X-offset #-2.5 ^\pp cis, fis b,
		eis ais, dis gis,
		cis)
	} \\ {
		g2(\fp fis
...
% Bars 251 to 255
	...
	bes4-!) a-! r2
	aes4-! g-! r2
	ges4_\crescmarkup ges'2 f4
% Bars 256 to 260
	ees, ees'2 des4
	ces\ff ces'2 ces,4
	ees,1\sf
	ees2\sf~ ees8\noBeam ees''\ff-.^\tutti des-. c-.
	bes4 ges2 bes4
% Bars 261 to 265
	ges ees2 ges4
	bes,4-!\sf r^\solo r2
...
% Bars 301 to 305
	e e
	fis gis
	a( \hairpinShorten #'(2 . 0) dis,)\<
	<< e1 {\hairpinShorten #'(0 . -1) s4\> s s s\!}>>
...
% Bars 426 to 430
	d, r b r
	c r e r
	a4-.^\arco r8 e-. a4-. r8 e-.
	a4-. r f-. d-.
	a-. r a-. r
% Bar 431
	a1-\offset Y-offset 3 \fermata \bar "|."
}
