...
% Bars 91 to 95
	...
	r4 \hairpinShorten #'(-0.3 . 0) c8(-\offset X-offset -1 \p\< d\!
	f\> e)\! r4
% Bars 96 to 100
	r c8(^\dolce\< d\!
	f\> e)\! r4
...
% Bars 276 to 280
	...
	\ni \clef tenor \mmrPos #-4 R2
	<< \mmrPos #-8 R {s4 \clef treble s} >>
	<< \mmrPos #-6 R2 {s4 s8 \clef tenor s} >>
% Bars 281 to 285
	\mmrPos #-6 R2 \no
	r4 \clef bass e,,\mf\<(
	g) fis(\!
