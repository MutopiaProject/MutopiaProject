...
% Bars 61 to 65
	...
	\mmrPos #-11 R
	\mmrPos #-11 R \no
	\voiceTwo r4 r8. \oneVoice g16\f-\tweak X-offset #-3 ^\arco(
...
% Bars 86 to 90
	\mmrPos #-4 R \bar "||" \no
	\time 4/4 \voiceOne r2 r4 r8 \oneVoice d'''\f\<(
	f e f e) e4.( d8)\! \bar "||"
...
% Bars 136 to 140
	a8-.[ r16 a-.] a8-.[ r16 a-.]\!
	\tuplet 3/2 4 {a4(\ff^\tutti g8) f( g a)
	a4( g8) f( g a)}
	a4 e
	r^\solo a,^\pizz\p
% Bars 141 to 145
...
% Bars 176 to 180
	...
	\mmrPos #-9 R
	\mmrPos #-7 R \no \mark \default
	\voiceOne r4 \oneVoice a'(\pp^\arco
% Bars 181 to 185
	fis') eis(
	fis) a,(
	fis') eis(
...
% Bars 256 to 260
	...
	a8->\ff-\offset X-offset 3 _\tutti e'16-. e-. dis8-> d16-. d-.
	c8-> b16-. b-. a8-> e16-. e-.
	f8 e16 e a8 e16 e
% Bars 261 to 265
	f8 e16 e a c e c
...
% Bars 271 to 275
	b( gis) gis( e)
	e( d4 b8)\!
	R2-\offset X-offset 4 ^\solo \bar "||" \key a \major
	R2*14
% Bars 276 to 280
...
% Bars 286 to 290
	...
	\mmrPos #-4 R \bar "||" \no
% Bars 291 to 295
	\time 4/4 a''2\rest a4\rest a8\rest b(\f
