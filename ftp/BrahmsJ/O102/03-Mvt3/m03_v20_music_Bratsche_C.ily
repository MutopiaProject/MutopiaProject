...
%###############################################################################
musicBratscheMvtIII = \relative c {
	\clef alto
	\key a \minor
%	\transposition a
% Bars 1 to 5
...
% Bars 36 to 40
	...
	\tuplet 6/4 4 {<e b'>16-.-\tweak X-offset #-5.5 ^\arco-\offset X-offset -2.5 \ff e'-. <e, b'>-. e'-. <e, b'>-. e'-. <e, b'>-. e'-. <e, b'>-. e'-. <e, b'>-. e'-. }
	<c e>16_\benmarc-. q-. <c a'>8-. q16-. q-. <f a>8-.
% Bars 41 to 45
	<d gis>16-. q-. <d b'>8-. <c e>16-. q-. <c a'>8-.
	<a c>16 q <c a'>8 <a c>16 q <c a'>8
	<a c>16 q <c a'>8 q16 q <a' c>8
	<c, e>16 q <e c'>8 <c e>16 q <e c'>8
	<c e>16 q <e c'>8 q16 q <c' e>8
% Bars 46 to 50
	g16 g <e c'>8 e16 e <c a'>8
	c16 c <a f'>8 a16 a <a f'>8
	<a e'>8-. <c a'>-. <b a'>-. <b gis'>-.
	<c a'>-. r r4
	R2*3
% Bars 51 to 55
...
% Bars 206 to 210
	...
	e)\sf e( b) b( e)\sf e( b) b(
	e8-.) r r8. <a, a'>16
	q8\sf( g'16) g( f) f( e) e(
% Bars 211 to 215
	f8)(\sf e16) e( d) d( c) c(
	b)\sf b( fis) fis( b)\sf b( fis) fis(
	b8-.) r r4
	e,8^\pizz r r4
	R2*3
% Bars 216 to 220
...
% Bars 241 to 245
	...
	a4 r
	R2
	<aes f'>4(^\div-\offset X-offset #0.8 _\pdolce <c ees>
	<bes ges'> <aes f'>)
% Bars 246 to 250
	<f' aes>2(
	<ces f>)(
...
% Bars 261 to 265
	<a c>16 q <c a'>8 q16 q <a' c>8
	<c, e>16 q <e c'>8 <c e>16 q <e c'>8 
	<c e>16 q <e c'>8 <e c'>16 q <c' e>8
	g16 g <e c'>8 e16 e <c a'>8
	c16 c <a f'>8 a16 a <f d'>8
% Bars 266 to 270
	<a e'>8-.[ <c a'>-.] <b a'>-.-\offset X-offset #-2.5 \sf <b g'>-.
	<c g'>[-\offset X-offset #-2.5 \sf-. <c f>-.] \beamOffset #'(0.5 . 0.5) <g f'>-.-\offset X-offset #-2.5 \sf <g e'>-.
	<f a>-. r r4
	R2
	e'4_\mfdimD-\tweak rotation #'(1.5 -1 0) -\tweak extra-offset #'(0.5 . 0.5) \> e8( d)
% Bars 271 to 275
	d( b) b( gis)
	gis4 gis\!
	R2 \bar "||" \key a \major
...
% Bars 321 to 325
	...
	R2*2
	\bar "||"
	<cis, a'>4-.-\tweak X-offset #-3 \f <fis a>-.
	R2
% Bars 326 to 330
	r8 <a a'>8-! q-! q-!
	q-. r <d e>-. r
...
% Bars 331 to 335
	a-. gis-. a-. <e d'>-.
	<e cis'>-. e4\p <d e>8\<~
	q <cis e>4\! <e gis>8_\cresc~
	q <e a>4 <gis b>8~
	q <a cis>4 <gis e'>8-.
% Bars 336 to 340
	<a e'>8-.-\tweak X-offset #-1.5 \f r r4
	R2
	<a, e' cis'>8-. r r4
	q8-. r r4
	<e cis'>2\fermata \bar "|."
