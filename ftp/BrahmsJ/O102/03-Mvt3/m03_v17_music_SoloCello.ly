...
% Fichier :      m03_v17_music_SoloCello.ly
...
% Bars 26 to 30
	...
	\clef treble \tempo "poco rit." a'8(\pp gis16 a) a,4
	c8(_\dimmarkup b16 c) c'4~
% Bars 31 to 35
	c8( b16 c) f,,4
	a8( gis16 a) a'4
	\tempo "in tempo" c8(\p a4 f8)
	d( b f d) \clef tenor
...
% Bars 121 to 125
	...
	\tuplet 3/2 4 {q4( <c e>8) <a c>( <b! d> <c e>)} \clef bass
% Bars 126 to 130
	<fis, a>4 g8. <g, g''>16
	q2
	<<{ 
...
% Bars 216 to 220
		R
		R \bar "||" \mark \default \key a \minor \clef bass \no
	}
...
% Bars 241 to 245
	d8 r r4
	r4 \clef tenor \tuplet 6/4 4 {r16 f,(^\moltoleggieroedolce g a bes c)}
...
% Bars 246 to 250
	...
	\tempo "in tempo" gis8-._\marcecrescmolto \tuplet 3/2 8 {fisis16([ gis fisis]} gis8-.) \tuplet 3/2 8 {fisis16([ gis fisis]}
% Bars 251 to 255
