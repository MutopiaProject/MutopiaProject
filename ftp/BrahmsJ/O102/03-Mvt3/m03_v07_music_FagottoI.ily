...
% Bars 91 to 95
	...
	r4 \hairpinShorten #'(-0.3 . 0) e8(-\offset X-offset -1 \p\< g\!
	a\> g)\! r4
% Bars 96 to 100
	r e8(^\dolce\< g\!
	a\> g)\! r4
...
% Bars 111 to 115
	...
	r4 \hairpinShorten #'(-0.3 . 0) a16(-\offset X-offset -1 \p\> e')\! r8
	R2
	r8. f16(_\dimmarkup e8) r
% Bars 116 to 120
	r8.^\tutti f16( e8) r
	R2
	\ni \clef treble \mmrPos #-4 R2 \bar "||" \key d \minor
	\mmrPos #-4 R
	\mmrPos #-4 R
% Bars 121 to 125
	\mmrPos #-4 R \no
...
% Bars 276 to 280
	...
	\ni << \mmrPos #-4 R2 {s4 \clef tenor s } >>
	<<\mmrPos #-7 R2 {s4 \clef treble s } >>
	<<\mmrPos #-4 R2 {s4 s8 \clef tenor s }>>
% Bars 281 to 285
	\mmrPos #-4 R2 \no
	r4 \clef bass e,\mf\<(
	g) fis(\!
...
% Bars 316 to 320
	...
	R2 \clef bass
	eis4\f fis
	\hairpinShorten #'(-0.3 . -0.3) a2-\offset X-offset -1.5 \sf\> 
% Bars 321 to 325
	a4\p r
	\hairpinShorten #'(-0.3 . -0.3) a4.-\offset X-offset -1.5 \pp\> r8\! 
	a4.\> r8\! \bar "||" 
	r4 r8 c(\f
	a fis dis c)
% Bars 326 to 330
