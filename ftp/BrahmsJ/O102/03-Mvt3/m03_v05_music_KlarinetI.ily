...
% Bars 86 to 90
	\mmrPos #-4 R2. \bar "||" \no
	\time 4/4 \voiceTwo r4 \oneVoice g(\mfcrescD aes a
	bes\< c cis d)\! \bar "||" 
...
% Bars 111 to 115
	...
	\ni \mmrPos #-4 R2 \no
	r4 \hairpinShorten #'(-0.3 . 0) c16-\offset X-offset -1 \p\>( g')\! r8
	R2*2
...
% Bars 251 to 255
	...
	g,,,2-\offset X-offset -2 _\mfcresc(
% Bars 256 to 260
	\shape #'((0 . 2)(0 . 2)(0 . 1)(0 . 0)) Slur aes!)(
	aes''!)
	g8-.\ff^\tutti ees-. r c-.
	r b-. r c-.
	r c-. r c-.
...
% Bars 316 to 320
	b\> a f g)
	g( -\tweak X-offset #0 \pcrescD\< gis) a4(~
	a8 ais) b4\!~
	b8 r r c,(
	b'4\sf\> a)
% Bars 321 to 325
