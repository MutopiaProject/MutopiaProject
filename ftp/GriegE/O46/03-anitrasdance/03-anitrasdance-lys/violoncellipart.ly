...
% 4
	...
	f2\decr ( )e4\rced
	f2\decr( )e4\rced
	f2\decr^"poco rit."( )e4\rced
	f2\decr( )e4\rced
	r^"a tempo" r e\p
	\grace {a16( b} )a8 gis\cr a b c d\rc
	e\decr ( a e4 )d\rced
% 5
	c8( e )c2
	f2^\accent( )e4
	...
	e-. cis-. a-.\cr e'-. c-. gis-.\rc
	e'-.\decr b-. g-. e'-.\rced ais,-. fis-.
	e'-. a,-. f-. e'-. gis,-. e-.
	\grace {a16( b} )a4-. r r
	r2.
	r4 r e'4^\accent\f^"pizz." }
\alternative {
{a4^\accent r r } {a4^\accent r e,\pp a, r r r2.^\fermata r2. \bar "||"}
}
}
...
% 5
	...
	r4 r e\f^\accent }
\alternative {
{a4^\accent r r } {a4^\accent r e\pp a, r r r2.^\fermata r }
}
}
