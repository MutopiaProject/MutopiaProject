...
violinioneI =  \relative c''' {
  ...
  \repeat volta 2 {
    ...
    % 5
    a2) r4
    a8\downbow^\accent\crM( c a4\tenuto g16 a g  a)
    fis8\( (  c')  fis,2\)\tenuto
    f8^\accent\diM\( (  c') f,4\tenuto( e16 f e  f)\)
    dis8\( (  b')  dis,2\)\tenuto
    d8^\accent\crM\( (  f) d4\tenuto( c16 d c  d)\)
    b8\( (  f')  b,2\)\tenuto
...
violinioneII =  \relative c''' {
  ...
  \repeat volta 2 {
    ...
    a8\<^"pizz."b c d\! e4\f^\accent }
  \alternative {
    {a4^\accent r r} {a4^\accent r r R2. c,2. ~ c4 r r }
  }
}
