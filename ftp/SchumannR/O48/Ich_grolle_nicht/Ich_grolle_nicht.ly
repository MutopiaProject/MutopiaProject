...
chant = \notes \relative do' \context Voice = chant {
    \global
    \autoBeamOff
    \dynamicUp
    ...
    la4 la r8 la-\cr la la la la la la mi'4. mi8-\rc re4 re r8 re re re re^\markup { \italic "cresc." }
    re re re
      <
      {
      \autoBeamOff
      ...
      \property Voice.TextSpanner \set #'edge-text = #'( "ritard." . "") % FIXME : italic
...
md = \notes \relative do' \context Voice = md { % Par carrures de 4 mesures  1 mesure par ligne
    \global
...
<<fa si re>>-> <<fa si re>> <<fa si re>> <<fa si re>> <<re fad do'>>-> <<re fad do'>>  <<re fad do'>>  <<re fad do'>>
    ...
    <<si re fa sol>> <<si re fa sol>> <<si re fa sol>> <<si re fa sol>> <<do fa sol>>-\cr <<do fa sol>> <<do fa sol>> <<do fa sol>> 
    <<sol dod mi sol>> <<sol dod mi sol>> <<sol dod mi sol>> <<sol dod mi sol>> <<sol re' fa sol>>-\rc <<sol re' fa sol>> <<sol re' fa sol>> <<sol re' fa sol>>

     % Deuxieme page
    <<sol do mi>>8->-\f <<sol do mi>> <<sol do mi>> <<sol do mi>> <<sol do mi>> <<sol do mi>> <<sol do mi>> <<sol do mi>>
    <<fa do' fa>> <<fa do' fa>> <<fa do' fa>> <<fa do' fa>> <<la do fa>> <<la do fa>> <<la do fa>> <<la do fa>> 
    <<lab do fa>> <<lab do fa>> <<lab do fa>> <<lab do fa>> <<sol si re fa>> <<sol si re fa>> <<sol si re fa>> <<sol si re fa>> 
    <<sol do mi>>-\decr <<sol do mi>> <<sol do mi>> <<sol do mi>> <<sold do mi>> <<sold do mi>> <<sold do mi>> <<sold do mi>>-\rced
    <<la do mi>>-\p <<la do mi>> <<la do mi>> <<la do mi>> <<do mi si'>> <<do mi si'>> <<do mi si'>> <<do mi si'>>
    <<do mi la>> <<do mi la>> <<do mi la>> <<do mi la>> <<do sol' la>> <<do sol' la>> <<do sol' la>> <<do sol' la>>
    <<do fa la>>-\cr <<do fa la>> <<do fa la>> <<do fa la>> <<fa la mi'>> <<fa la mi'>> <<fa la mi'>><<fa la mi'>>-\rc
    <<fa la re>> <<fa la re>> <<fa la re>> <<fa la re>> <<fa do' re>> <<fa do' re>> <<fa do' re>> <<fa do' re>> 
    ...
    <<la do>>-> <<do sol'>>-\cr <<do sol'>> <<do sol'>> <<do sol'>> <<do do'>> <<do do'>> <<do do'>>-\rc
...
mg = \notes \relative do, \simultaneous { % 1 mesure par ligne
\clef "bass"
    {
      \global
    r2 <<do do'>>
    ...
    <<fa fa'>> <<mi mi'>>
    <<re re'>> <<do do'>>
    <<si' si'>> <<la la'>> <<sol sol'>> <<fa fa'>> <<mi mi'>> <<la la'>> <<re re'>> <<sol sol'>> <<do, do'>> <<mi mi'>> <<fa fa'>> <<sol sol'>>
    % coda
    do,1 ~ <<do fa do'>>8 s4. s2 s8 \stemDown sol'4. ~ sol2 ~ sol <<sol do>>8 r <<sol si>> r
    <<do, sol' do>> r s2.
    \bar "|."
...
\relative do {
    s1*31
    \dynamicUp
    \stemUp r8 <<mi, do'>> <<mi do'>> <<mi do'>> <<mi do'>> <<fa do'>> <<fa do'>> <<fa do'>>
